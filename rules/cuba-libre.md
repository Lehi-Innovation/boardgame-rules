...
---
<!-- verification:begin -->
> ❗ **Known errors** — an audit found inaccuracies in this summary that could mislead players: Faction victory conditions wrong (Govt, Syndicate, DR all misstated) plus invented ops/SAs and omitted real ones (Garrison, Construct, Transport, Reprisal, Subvert, Profit, Muscle). Until it is re-written, prefer the full rulebook text linked below.
>
> 📄 [Full rulebook text](https://jonnyallred.github.io/boardgame-rules/extracted/cuba-libre-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Cuba%20Libre&game=cuba-libre)
<!-- verification:end -->
