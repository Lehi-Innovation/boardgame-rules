...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Egghead&game=egghead)
<!-- verification:end -->
...
- Card holders or headbands (to display cards on players' heads)
...
- You may never look at your own card until you make a guess.
- Answers must be truthful based on what you can see.
- The game works best with larger groups as more information is available from the answers.
- Multiple rounds ensure everyone gets fair chances to deduce.
