...
---
<!-- verification:begin -->
> ❗ **Known errors** — an audit found inaccuracies in this summary that could mislead players: Wrong step counts (German armor has 3), retreat is exactly 2 hexes not 1-2, invented "disrupted cannot attack", ZOC cost on leaving not entering, chit effects misdescribed. Until it is re-written, prefer the full rulebook text linked below.
>
...
- **Zones of Control (ZOC):** Units exert ZOC into adjacent hexes. Entering an enemy ZOC costs extra movement points. ZOC does not block supply.
- **Stacking:** Limits apply; excess units eliminated.
- **Tactical Chits:** Combat (+1 die roll modifier), Extra Move (activate 1 unit for movement only), Replacement (rebuild eliminated step), Air (modifier in combat), Sandstorm (affects movement and combat), Anti-Tank (Axis only, +2 vs. armor), Withdraw/Attack (Allied only, voluntary withdrawal or mandatory attack).
- **May 27 Restrictions:** 15th and 21st Panzer may only activate once. Several Allied and Axis formations cannot be activated at all on May 27.
