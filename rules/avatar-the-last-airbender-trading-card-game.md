---
title: "Avatar: The Last Airbender Trading Card Game"
bgg_id: 22469
player_count: "2"
play_time: "20-40 min"
designer: "uncredited (Upper Deck)"
source_pdf: ""
...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Avatar%3A%20The%20Last%20Airbender%20Trading%20Card%20Game&game=avatar-the-last-airbender-trading-card-game)
<!-- verification:end -->
...
1. Each player builds or selects a deck of cards.
2. Set up the play area with zone markers. Each player has a series of zones from green (safe) through yellow to red (danger).
3. Players start in their green zone.
...
2. **Action Phase:** Play character cards, strike cards, and action cards.
3. **Strike Phase:** Attack your opponent, attempting to push them back into their red zone.
4. **Resolution Phase:** Resolve the effects of strikes and actions.
