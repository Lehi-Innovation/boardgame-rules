...
player_count: "2"
play_time: "20-40 min"
source_pdf: "gothic-checkers-rules.pdf"
...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Gothic%20Checkers&game=gothic-checkers)
<!-- verification:end -->
...
- 16 white pieces (pawns)
- 16 black pieces (pawns)
...
- Move one of their pieces, or
- Make a capture (captures are mandatory if available).
...
- **Blocking** all of the opponent's pieces so they have no legal moves.

Draws are possible but relatively rare (approximately 7.7% of games).

## Special Rules & Edge Cases

- **Mandatory capture:** If a capture is available, the player must take it. If multiple captures are available, the player may choose which one to make.
- **Short king:** Kings move only one square at a time (unlike "flying kings" in some checkers variants). This is a distinctive feature of Gothic Checkers.
- **Both colors of squares:** Unlike standard checkers where play occurs only on dark squares, Gothic Checkers uses both dark and light squares.
- **Orthogonal influence:** The inclusion of sideways movement and capture reflects the influence of Turkish checkers on this German variant.
- **Historical context:** Gothic Checkers is a medieval German game that bridges the gap between standard Western checkers and Turkish draughts traditions.
