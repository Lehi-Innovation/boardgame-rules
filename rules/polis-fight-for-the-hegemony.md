...
bgg_id: 69779
player_count: "2"
play_time: "150 minutes"
designer: "Fran Diaz"
source_pdf: "polis-fight-for-the-hegemony-rules.pdf"
...
1. Place the game board centrally with Event, Polis, Project, and Combat card decks arranged.
2. Each player takes their color's cubes, discs, ships, pawn, and player board.
3. Set initial polis affiliations per scenario.
4. Place starting population cubes on affiliated poleis.
5. Set market values for goods to starting positions.
6. Place round marker on round 1.
...
1. **Military victory:** Control enough poleis to dominate Greece.
2. **Prestige victory:** Accumulate enough prestige through projects, military victories, and diplomatic achievements.
3. **After the final round:** The player with the most prestige wins.
...
| Action | Description |
|--------|-------------|
| Diplomacy | Influence neutral poleis to join your league |
| Move Army | Move hoplites between territories |
| Move Navy | Move galleys along sea routes |
| Battle | Resolve combat with Combat cards |
| Siege | Attempt to capture fortified polis (die roll) |
| Trade | Buy/sell goods; send merchants |
| Project | Undertake cultural work for prestige |
| Recruit | Convert population to military units |
| Grow | Increase population in your poleis |
| Fortify | Build walls for defense |
