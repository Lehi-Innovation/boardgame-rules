---
title: "Resan genom Sagoland"
bgg_id: 93006
player_count: "1-4"
play_time: "20-30 min"
designer: "Unknown"
source_pdf: "resan-genom-sagoland-rules.pdf"
...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Resan%20genom%20Sagoland&game=resan-genom-sagoland)
<!-- verification:end -->
...
3. Set up the spinner (or use a die as substitute).
...
1. **Spin/Roll:** Use the spinner (or roll the die) to determine how many spaces to move.
2. **Move:** Advance your pawn along the path by the number indicated.
3. **Resolve Space:** If you land on a special space, follow its instructions (encounter a fairytale character, gain a bonus, lose a turn, etc.).
4. **Pass Turn:** The next player takes their turn.
...
| Step | Action |
|---|---|
| 1 | Spin the spinner (or roll die) |
| 2 | Move pawn forward that many spaces |
| 3 | Resolve any special space effects |
| 4 | Next player's turn |

**Win:** First to reach the end of the fairytale path
