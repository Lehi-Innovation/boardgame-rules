...
source_pdf: "power-barons-rules.pdf"
...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/power-barons-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Power%20Barons&game=power-barons)
<!-- verification:end -->
...
1. Each player chooses a territory and takes the colored land tabs matching their territory.
2. Place Power Base markers nearby.
3. Deal cards as instructed.
4. Each player places their Reference Card face-up in front of them.
...
| Turn Step | Action |
|-----------|--------|
| 1. Draw & Bank | Draw 1 card, bank 1 card |
| 2. Roll & Move | Move pawn, follow board space directions |
| 3. Challenge | Challenge an opponent in chosen suit |
| 4. Buy Power Base | Spend credits to build Power Base in opponent's territory |

| Players | Win Condition |
|---------|--------------|
| 3 | 4 different Power Bases in each of 2 opponents' territories |
| 4 | 3 different Power Bases in each of 3 opponents' territories |
