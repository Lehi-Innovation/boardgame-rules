...
>
> 📄 [Full rulebook text](https://jonnyallred.github.io/boardgame-rules/extracted/mindtrap-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20MindTrap&game=mindtrap)
<!-- verification:end -->
...
1. Each team or player chooses one of the two center "hollow" squares on the scorecard, which determines their path (light or dark).
2. Shuffle the MindTrap cards and place them in a stack.
3. Determine which team or player goes first.

## Turn Structure

On your turn:
1. The opposing team or player draws a card and reads the puzzle aloud.
2. You have a reasonable amount of time to discuss and provide an answer.
3. If correct, advance one space on the scorecard track.
4. Play passes to the next team/player.
