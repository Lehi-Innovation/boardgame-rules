...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Quebec%201759&game=quebec-1759)
<!-- verification:end -->
...
1. Both players secretly write movement orders simultaneously.
2. Reveal orders and execute movement.
3. Resolve battles at contested locations.
...
- Fog of war is inherent: block faces are hidden from opponents.
- Siege rules apply for attacking fortified Quebec.
- Naval control of the St. Lawrence River is crucial.
- The game can be played in about an hour, making it accessible for a wargame.
