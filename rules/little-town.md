...
source_pdf: "little-town-rules.pdf"
...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/little-town-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Little%20Town&game=little-town)
<!-- verification:end -->
...
### End of Round
1. Execute end-of-round building effects.
2. **Feed workers:** Pay 1 food (wheat or fish) per worker used. Each missing food = **-3 VP**.
3. Return all workers to players.
