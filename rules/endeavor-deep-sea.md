...
source_pdf: "endeavor-deep-sea-rules.pdf"
...
---
<!-- verification:begin -->
> ❗ **Known errors** — an audit found inaccuracies in this summary that could mislead players: Dive token exhaustion inverted: summary says unavailable, source says shuffle discards into new supply; tiebreaker invented. Until it is re-written, prefer the full rulebook text linked below.
>
> 📄 [Full rulebook text](https://jonnyallred.github.io/boardgame-rules/extracted/endeavor-deep-sea-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Endeavor%3A%20Deep%20Sea&game=endeavor-deep-sea)
<!-- verification:end -->
...
- 4 Player Mats (with attribute tracks, staging area, research track)
- 46 Specialist Tiles (Junior/Senior sides, Tiers 1-5)
- 4 Team Leader Tiles
- 32 Ocean Boards (5 different depths)
- 30 Dive Tokens
- 23 Journals + 7 Anchor Journals
- 120 Discs (30 per player), 20 Track Cubes (5 per player)
- 80 Impact Markers (20 per player), 12 Vessels (3 per player)
- 1 Wave Marker, 4 Double-Sided Scenario Sheets
- 6 Co-op Goal Cards, 1 Score Pad
...
- **Discover:** Draw 2 Ocean boards from allowed depth stacks, choose 1 to place, return the other. Gain the new zone's Discovery bonus. Place Dive tokens if the zone has a Dive site.
...
Points come from:
- **Attribute tracks:** Each attribute track has scoring brackets worth VP.
- **Impact Board:** VP based on Impact marker placement on the scenario-specific Impact board.
- **Scoring Goals:** Each scenario has unique goals worth VP.
- **Specialists:** Senior Specialists may provide VP.
- **Journals:** Published Journals may provide VP.
...
- Discs in your supply are NOT available; they must enter play via the Effort step before you can use them.
- Specialists always enter play on their Junior (blue) side.
- You may recruit duplicate Specialists.
- If you reach the end of an attribute track's Impact symbol, gain 1 Impact. If you advance beyond, retreat to the Impact symbol and gain it again.
- The Ingenuity track unlocks additional Vessels when you reach Vessel icons.
- Some Specialists offer a choice of actions (marked with "/"); others let you perform multiple actions in any order.
- You may activate a Specialist and choose not to perform its action(s).
- Dive tokens and Ocean boards are limited; when stacks run out, those actions become unavailable at those depths.
- At end of round: pass the Wave marker clockwise. All players gain any End-of-Round benefits.
