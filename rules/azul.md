...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/azul-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Azul&game=azul)
<!-- verification:end -->
...
- **Adjacent tiles exist:** Score in two checks:
  1. Count all tiles in the **horizontal** line connected to the newly placed tile (including itself). Score that many points.
  2. Count all tiles in the **vertical** line connected to the newly placed tile (including itself). Score that many points.
