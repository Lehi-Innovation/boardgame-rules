...
bgg_id: 352567
player_count: "2-4"
play_time: "90 min per session"
designer: "Prospero Hall"
source_pdf: "jurassic-world-legacy-of-isla-nublar-rules.pdf"
...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Jurassic%20World%3A%20The%20Legacy%20of%20Isla%20Nublar&game=jurassic-world-the-legacy-of-isla-nublar)
<!-- verification:end -->
...
1. Open only the Adventure Guide for the current session (do not open future guides).
2. Set up the board according to the Adventure Guide's instructions.
3. Each player selects a character and takes their character mat, abilities, and starting equipment.
4. Place dinosaur miniatures and tokens as directed.
5. Apply any permanent modifications (stickers, scratch-offs) from previous sessions.

## Turn Structure

Each adventure session consists of **5 rounds**. Within each round:
1. **Player Turns:** Players take turns performing actions (turns can be asynchronous).
2. **Event Phase:** Resolve dice rolls and card draws for objective progression, weather events, and dinosaur movement.
3. **Dinosaur Phase:** Dinosaurs roam the map according to specific movement rules, creating threats.
...
| Dr. Ian Malcolm | Mathematics/Chaos theory |
| John Hammond | Park management |
| Dr. Henry Wu | Genetics |
| Robert Muldoon | Security |

| Key Numbers | Value |
|-------------|-------|
| Total adventures | 12 |
| Rounds per adventure | 5 |
| Players | 2-4 |
| Time per session | ~90 min |
| Dinosaur miniatures | 12 |
| Films covered | 5 |
