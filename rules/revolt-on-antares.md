---
title: "Revolt On Antares"
bgg_id: 2213
player_count: "2-4"
play_time: "60-90 min"
designer: "Tom Moldvay"
source_pdf: "revolt-on-antares-rules.pdf"
...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Revolt%20On%20Antares&game=revolt-on-antares)
<!-- verification:end -->
...
1. Place the hex map in the center of the table.
2. Select a scenario (Revolt Against Terra, Silakka Invasion, or Power Politics).
3. Each player chooses a faction and takes their corresponding counters.
4. Place units in their starting hexes as specified by the scenario.
5. Place leader counters with their forces.
...
1. **Alliance Phase:** Players may attempt to forge alliances with minor houses or other factions.
2. **Reinforcement Phase:** Recruit new units based on controlled territories.
3. **Movement Phase:** Move units between hexes, respecting terrain and stacking limits.
4. **Combat Phase:** Resolve battles when opposing forces occupy the same hex.
5. **Special Powers Phase:** Use any special abilities from leaders or unique units.
6. **Victory Check:** At the end of the final turn, count victory points.
...
| Phase | Action |
|---|---|
| Alliance | Attempt diplomatic alliances |
| Reinforcement | Recruit new units |
| Movement | Move units between hexes |
| Combat | Resolve battles |
| Special Powers | Use leader/unit abilities |
| Victory Check | Count points (final turn) |
