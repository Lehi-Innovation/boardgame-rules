...
Each round, players take turns performing actions using cards from their hand. After all players have acted, enemies activate according to their behavior patterns.

## Actions

### Player Actions
- **Move**: Navigate between spaces on the Adventure Book map
- **Attack**: Use action cards to fight enemies
- **Forage/Search**: Discover items and supplies
- **Use Items**: Activate equipment abilities
- **Rest**: Recover from wounds
- **Interact**: Trigger Adventure Book entries

### Resolution Dice
Skill tests and combat use the 2 resolution dice. Players roll and compare results to difficulty thresholds, with attribute bonuses from their character card.
...
Complete the mission objectives as described in the Adventure Book scenario. The campaign progresses through connected missions. Players win by surviving and accomplishing objectives; they lose if all characters are defeated or mission-specific failure conditions are met.
...
- Each character has a personal goal that provides bonus rewards when completed.
- Enemy behavior is deterministic based on enemy cards.
