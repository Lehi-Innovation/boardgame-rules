...
bgg_id: 475
player_count: "3-5"
play_time: "75-100 min"
designer: "Reiner Knizia"
source_pdf: "taj-mahal-rules.pdf"
...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Taj%20Mahal&game=taj-mahal)
<!-- verification:end -->
...
2. Each player takes their 30 bidding cards and shuffles them into a personal deck.
3. Place province tiles on their corresponding provinces (numbered 1-12).
4. Each player draws a starting hand from their deck.
5. Place scoring markers on the VP track at zero.
6. Arrange bonus tiles on the board as indicated.
7. Determine starting player randomly.
...
| Prize Category | Symbol | Reward |
|---|---|---|
| Elephant | Elephant icon | Place palace in province |
| Tiger | Tiger icon | Take bonus tile |
| Princess | 2 Princess icons | Claim Princess card |
| Yellow Advisor | Yellow star | Place connection marker |
| White Advisor | White star | Place connection marker |
| Taj Mahal | Taj symbol | Province-specific reward |
