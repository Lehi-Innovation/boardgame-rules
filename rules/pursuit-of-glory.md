...
source_pdf: "pursuit-of-glory-rules.pdf"
extracted_date: "2026-03-22"
summarized_date: "2026-03-22"
rulebook_version: "GMT Games (Living Rules, 2010)"
...
- **Operations (OPS):** Move and/or attack with units; the card's OPS value determines how many activations.
- **Strategic Redeployment (SR):** Move units long distances via rail/sea.
- **Event:** Play the card's event text for its historical effect.
- **Replacement Points:** Convert the card to replacement points to rebuild depleted units.
...
- Gallipoli and the Dardanelles have special amphibious assault rules.
- Russian Revolution events can remove Russia from the war.
- Jihad markers spread revolt in Allied-controlled Muslim territories.
- The Suez Canal is a critical strategic objective.
- Arab Revolt provides the Allies with irregular forces.
- Limited War vs. Total War status affects card availability and operations.
