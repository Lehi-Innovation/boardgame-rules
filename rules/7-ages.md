...
---
<!-- verification:begin -->
> ❗ **Known errors** — an audit found inaccuracies in this summary that could mislead players: Turn Structure invents/misorders phases, omits face-down action-marker system and empire limits, invents die rolls in combat (game uses drawn cards, no dice). Until it is re-written, prefer the full rulebook text linked below.
>
> 📄 [Full rulebook text](https://jonnyallred.github.io/boardgame-rules/extracted/7-ages-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%207%20Ages&game=7-ages)
<!-- verification:end -->
...
### Action Sequence
1. **Start Empires** -- Play cards to create new empires on the map.
2. **Discard/Draw** -- Manage hand; draw new cards.
3. **Progress** -- Advance empires along the progress track (technology, culture).
4. **Trade** -- Generate income from trade.
5. **Civil Wars & Revolts** -- Internal conflicts may split empires.
6. **Maneuver** -- Move military units.
7. **Combat** -- Resolve battles between adjacent enemy forces.
8. **Production** -- Empires produce resources and units.
9. **Glory** -- Score glory points based on empire achievements.
...
| End trigger | Empire exceeds 49th progress or acquires internet |
| Progress levels | 49 |
