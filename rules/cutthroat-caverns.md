...
source_pdf: "cutthroat-caverns-rules.pdf"
...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/cutthroat-caverns-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Cutthroat%20Caverns&game=cutthroat-caverns)
<!-- verification:end -->
...
1. Shuffle Initiative cards equal to the number of players (remove highest-numbered cards first) and fan them face down on the table.
2. Shuffle the remaining cards (Attack, Action, Item) and place them face down as the draw deck.
3. Each player draws 7 cards as their starting hand.
4. Shuffle the Encounter cards and deal 9 face down to form the Encounter deck.
5. Each player takes a Character Sheet and places a green bead on 100 Life Points.
6. Place the Monster Life Tracker on the table with yellow beads for creature LP and encounter number.

## Turn Structure

Each encounter follows this sequence:

1. **Begin a New Encounter** -- Reveal the top Encounter card, read it aloud, set creature LP on the Monster Life Tracker based on player count. Players may use Potions. Draw Initiative cards.
2. **Combat Round** -- Set Attack cards, resolve Player Turns, Total Attack Damage, Creature Attacks, Draw Initiative for next round, Draw a card.
3. **End of Encounter** -- Award Prestige Points, discard/draw cards, advance to next encounter.
...
| Phase | Action |
|-------|--------|
| Begin Encounter | Reveal card, set creature LP, take Potions, draw Initiative |
| Set Attack | Place 1 Attack card face down |
| Player Turns | Flip and resolve in Initiative order |
| Total Damage | Sum damage, adjust creature LP |
| Creature Attacks | Specific first, then random (after new Initiative draw) |
| End of Encounter | Award Prestige, discard/draw to 7, advance encounter |
