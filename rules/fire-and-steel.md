...
source_pdf: "fire-and-steel-rules.pdf"
...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Fire%20and%20Steel&game=fire-and-steel)
<!-- verification:end -->
...
- Formation changes (line, column, square) cost movement.

### 2. Fire Combat Phase
- Units within range may fire at enemy units.
