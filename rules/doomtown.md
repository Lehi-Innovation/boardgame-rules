...
---
<!-- verification:begin -->
> ❗ **Known errors** — an audit found inaccuracies in this summary that could mislead players: Stud/draw bullets reversed: source studs increase draw hand size and draw dudes redraw, summary says opposite; cheatin' defined as duplicate values vs source same suit AND value; unboot and hand refill put in Upkeep vs source Sundown. Until it is re-written, prefer the full rulebook text linked below.
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/doomtown-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Doomtown&game=doomtown)
<!-- verification:end -->
...
1. Each player selects an outfit card and places it as their home location.
2. Choose starting dudes whose combined cost does not exceed the outfit's starting stash.
3. Place starting dudes at home (booted or unbooted as specified).
4. Shuffle remaining cards into your draw deck.
5. Draw a starting hand of 5 cards.
6. The town square is the unmarked location between each player's street.
...
1. **Form posses** at the location.
2. **Resolution:** Each player draws 5 cards from deck, uses their dudes' bullets to determine hand rank.
3. Compare poker hands. Loser takes casualties equal to the hand rank difference.
4. Repeat rounds until one side is eliminated or flees.
...
| Phase Order | Gamblin' > Upkeep > High Noon > Nightfall |
|---|---|
| Win Condition | Control Points > Opponent's Influence at Sundown |
| Starting Hand | 5 cards |
| Hand Size | 5 cards (refill at Nightfall) |
