...
source_pdf: "quarto-rules.pdf"
extracted_date: "2026-03-22"
summarized_date: "2026-03-22"
rulebook_version: "Gigamic (1991)"
...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/quarto-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Quarto&game=quarto)
<!-- verification:end -->
...
- The hollow pieces should be placed right-side up so the hollow top is visible.
- A winning line can be based on any single shared attribute -- the 4 pieces do not need to match on all attributes, just at least one.
- **Simple play variant (for younger players):** Limit the winning features to fewer than all 4 (e.g., only color, or only color and height).
