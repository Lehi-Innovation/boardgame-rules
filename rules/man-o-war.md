...
designer: "Uncredited (Games Workshop)"
source_pdf: "man-o-war-rules.pdf"
...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/man-o-war-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Man%20O%27%20War&game=man-o-war)
<!-- verification:end -->
...
- Ship models (plastic/metal miniatures)
- Ship cards (tracking damage and stats for each vessel)
- Battle magic cards
- Wind gauge
- Templates (turning, shooting arcs)
- Dice (d6)
- Counters and tokens
...
- **Wind changes:** The wind direction may shift during the game, affecting all ship movement.
- **Critical hits:** Some hits cause fires, flooding, or crew casualties beyond normal damage.
- **Ramming:** Ships may ram enemies, dealing damage based on ship size and speed.
- **Each faction** has unique ships and special rules (e.g., Dwarf ironclads, Skaven ratships, Chaos daemon ships).
- **Crew quality** varies; elite crews fight better in boarding actions.
- Sinking ships may create debris that affects nearby vessels.
