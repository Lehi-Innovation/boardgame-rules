...
designer: "Jogos Almirante"
source_pdf: "almirante-rules.pdf"
...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Almirante&game=almirante)
<!-- verification:end -->
...
1. Place the ocean board in the center.
2. Each player receives their fleet of fishing boats and galleons.
3. Each player receives starting winds and coins.
4. Each player receives 3 god cards.
5. Place resource and position markers as specified.
...
1. **Receive winds and coins:** Each player starts their turn by receiving 6 wind tokens and a variable amount of coins.
2. **Move vessels:** Spend wind tokens to move ships across the ocean (1 wind per fishing boat move, 2 winds per galleon move).
3. **Actions:** Engage in trade, combat, or use god cards.
4. **God cards:** Each player has three opportunities during the game to play a god card for a special effect.
...
| Ship Type | Wind Cost | Role |
|-----------|-----------|------|
| Fishing boat | 1 wind | Resource gathering |
| Galleon | 2 winds | Combat and transport |
