...
designer: "Paul Morin, Jordan Sampson"
source_pdf: "gridiron-master-rules.pdf"
...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20GridIron%20Master&game=gridiron-master)
<!-- verification:end -->
...
2. Each player sets up their football team in their starting formation.
3. Football positions are assigned chess piece movement rules (e.g., quarterback may move like a queen, linemen like pawns, etc.).
4. Determine which team starts on offense and which on defense.
5. Set the score to 0-0.
...
1. **Formation selection:** The offensive player selects a play/formation; the defensive player selects a defensive formation.
2. **Chess resolution:** The play is resolved as a miniature chess game, with football positions moving according to their assigned chess piece movement rules.
3. **Result determination:** The outcome of the chess interaction determines the football result (gain/loss of yards, touchdown, turnover, etc.).
4. **Reset:** Pieces are reset for the next play.
