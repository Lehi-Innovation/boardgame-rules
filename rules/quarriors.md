...
source_pdf: "quarriors-rules.pdf"
extracted_date: "2026-03-22"
summarized_date: "2026-03-22"
rulebook_version: "WizKids (Ultimate Rules, 2018)"
...
- **Quiddity:** The currency of the game. Dice showing Quiddity symbols provide spending power.
- **Burst effects:** Some dice faces show burst symbols that trigger special abilities listed on the Power Card.
- **Split faces:** Faces showing two symbols separated by a line require you to choose one. Without a line, use both.
- **Portal dice:** Cost 0 Quiddity to capture. Provide Quiddity or draw-and-roll effects.
- **Re-roll:** Dice showing the re-roll symbol may be re-rolled immediately (even multiple times per turn).
- When your bag is empty, move your Used Pile into the bag and shuffle.
