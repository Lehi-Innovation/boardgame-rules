...
source_pdf: "primordial-soup-rules.pdf"
...
---
<!-- verification:begin -->
> ❗ **Known errors** — an audit found inaccuracies in this summary that could mislead players: Phase order scrambled: Buy Genes (source Phase 3) swapped with Deaths (source Phase 5). Eating wrong: summary says 2 cubes eaten and 1 excreted; source says 3 eaten and 2 excreted. Game-end condition wrong: primary trigger is Finish Zone on Scoring Ladder, not set number of rounds. Scoring advance table entirely absent. Until it is re-written, prefer the full rulebook text linked below.
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/primordial-soup-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Primordial%20Soup&game=primordial-soup)
<!-- verification:end -->
...
1. Place game board centrally. Each player takes their color amoebas, reference booklet, and 4 BP.
2. Place 2 foodstuff cubes of each color on every board space. Set aside unused colors.
3. With 3 players, use only Gene Cards marked "3."
4. Shuffle Environment Cards; place one face-up on the Compass.
5. Roll dice for play order; place score markers on spaces 1-4.
6. In ascending order, each player places 1 amoeba on an empty space (with 1 DP for 4-player games). Then in descending order, place a second amoeba (no DP). No space may have more than 1 amoeba.
...
| Phase | Action |
|-------|--------|
| 1. Movement/Eating | Move (1 BP/space), eat 2 cubes, excrete 1 cube |
| 2. Environment | New Environment Card; check gene defects |
| 3. Death | Remove amoebas with 2+ Damage Points |
| 4. Division | Spend BP to reproduce |
| 5. Buy Genes | Spend BP for permanent abilities |
| 6. Scoring | Score based on amoebas and genes |
