...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/barrage-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Barrage&game=barrage)
<!-- verification:end -->
...
1. Assign company boards and executive officers to players.
2. Each player receives: 6 Credits, 6 Excavators, 4 Concrete Mixers.
3. Place 4 neutral dams (one each at Mountains level 1, Hills level 2, Plains level 3).
4. Distribute headstream tiles, bonus tiles, objective tiles, and contracts.
5. Position turn order markers and scoring markers.
6. Place water drops as indicated for the first round.
...
| Structure Number | Engineers Required |
|------------------|--------------------|
| 1st | 1 engineer |
| 2nd | 2 engineers |
| 3rd-4th | 3 engineers |
| 4th+ | 3 engineers + 3 Credits |
...
| Structure | Plains Cost | Hills Cost | Mountains Cost |
|-----------|------------|------------|----------------|
| Base (Dam) | 3 Excavators | 4 Excavators | 5 Excavators |
| Elevation | 2 Concrete | 3 Concrete | 4 Concrete |
| Conduit | 2x value Excavators | 2x value Excavators | 2x value Excavators |
| Powerhouse | 2 Concrete (+1 per existing) | 2 Concrete (+1 per existing) | 2 Concrete (+1 per existing) |
...
### Round Structure
1. Income & Headstreams
2. Actions (place engineers)
3. Water Flow
4. Scoring
5. End of Round
