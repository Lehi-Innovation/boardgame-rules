...
source_pdf: "broom-service-rules.pdf"
...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/broom-service-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Broom%20Service&game=broom-service)
<!-- verification:end -->
...
1. Place the game board front-side up (castles with reddish banners) in the center.
...
3. Place remaining potions and wands in a general supply.
4. Display the game summary between players.
5. Shuffle 24 heavy clouds and place one face-up on each cloud space on the board.
6. Shuffle 10 event cards; place 7 face-down as a stack, return 3 to box unseen. Flip top event card face-up.
7. **Fewer than 5 players:** Shuffle 10 role cards of an unused color as a draw pile. Reveal "bewitched" role cards: 2 players = 3 cards, 3 players = 2 cards, 4 players = 1 card.
...
| Role | Brave Action | Cowardly Action |
|------|-------------|-----------------|
| Gatherer (x3) | Take 3 matching resources | Take 1 matching resource |
| Witch (x3) | Move + deliver potion (score VP) | Move only (no delivery) |
| Druid (x3) | Deliver potion + 3 bonus VP | Deliver potion (no bonus) |
| Weather Fairy | Charm cloud + 3 bonus VP | Charm cloud (no bonus) |
