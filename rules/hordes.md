...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Hordes&game=hordes)
<!-- verification:end -->
...
- Miniature figures (Warlocks, Warbeasts, units, solos)
- Stat cards for each model
- Measuring tape or ruler
- 6-sided dice (multiple)
- Tokens (Fury, damage, effect markers)
- Terrain pieces
- Rules book (Hordes: Primal)
