...
source_pdf: "all-star-baseball-rules.pdf"
...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20All-Star%20Baseball&game=all-star-baseball)
<!-- verification:end -->
...
- Game board depicting a baseball diamond with baserunner peg holes
- 2 spinners (one for batting, one for baserunning)
- Circular player cards (each representing a real MLB player)
- Baserunner pegs
- Score sheet or scoreboard
...
- Advance the expected number of bases
- Advance an extra base
- Are held at their current base
- Are thrown out attempting to advance

### Standard Baseball Rules

All other rules follow standard baseball:
- 3 outs end a half-inning
- Runners advance on hits, walks, and certain outs
- Force plays and tag-ups apply
- The game lasts 9 innings with extra innings if tied
...
- Advanced rules incorporate stolen bases, sacrifice bunts, and intentional walks.
- Defensive ratings may be used in advanced variants.
- Player cards from different eras and editions span decades of MLB history.
- Some editions include special "All-Time All-Star" cards for legendary players.
- The game is aimed at a younger audience compared to more simulation-heavy baseball games.
- Various editions were produced from 1941 through the 1990s with updated player rosters.
