...
source_pdf: "rhino-hero-rules.pdf"
...
>
> 📄 [Full rulebook text](https://jonnyallred.github.io/boardgame-rules/extracted/rhino-hero-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Rhino%20Hero&game=rhino-hero)
<!-- verification:end -->
...
- **Front:** Easy variation (simpler wall placement marks)
- **Back:** Expert variation (more challenging wall placement marks)
...
4. Place remaining roof cards face down as a **provision pile** (draw pile), set away from the foundation.
5. Place the **walls** and **Rhino Hero** figure within reach of all players.
...
- The second roof card placed **may not** be another Double Roof card.
- If the player has no eligible (non-Double Roof) cards to place as the second card, they must **ask their neighbor to the left** to pass them one of their roof cards to use. This helps the neighbor get rid of a card.
- **Strategic tip:** Ideally, play the Double Roof as your second-to-last card so your last card serves as the required second placement. If the Double Roof is your very last card, you still win, but you must take a card from your left neighbor to place on top, which helps that neighbor.
...
- Players **may use both hands** when stacking walls and roof cards.
- Players **may only touch** the wall or roof card they are currently placing -- do not touch previously placed pieces.
- Walls must be positioned **as exactly as possible** on the marks indicated by the roof card below.
- Roof cards must be **oriented the same way** as the foundation card (same alignment/rotation).
...
- **Front side** = easier game (simpler wall configurations)
- **Back side** = expert/harder game (more complex wall configurations)
...
- Total roof cards: 31
- Total walls: 28
- Hand size: 5 cards (3-5 players) / 7 cards (2 players)
- Player count: 2-5
- Play time: approximately 5-15 minutes
- Collapse tiebreaker: fewest cards, then most special symbols, then shared victory
