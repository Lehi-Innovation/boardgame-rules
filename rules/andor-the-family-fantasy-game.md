...
---
<!-- verification:begin -->
> ❗ **Known errors** — an audit found inaccuracies in this summary that could mislead players: Invented sun-marker/day-track loss condition (actual: dragon reaching Rietburg), wrong combat model, invented modular board and archer ranged ability; dragon/Gor night system omitted. Until it is re-written, prefer the full rulebook text linked below.
>
> 📄 [Full rulebook text](https://jonnyallred.github.io/boardgame-rules/extracted/andor-the-family-fantasy-game-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Andor%3A%20The%20Family%20Fantasy%20Game&game=andor-the-family-fantasy-game)
<!-- verification:end -->
...
- Game board tiles (modular, double-sided)
- 4 Hero figures (Magician, Warrior, Archer, Dwarf)
- Hero cards with special abilities
- Wolf cub tokens
- Monster tokens
- Bridge tokens
- Fog tokens
- Task cards
- Sun marker and day tracker
- Dice
...
- **Warrior:** Stronger in combat
- **Archer:** Can attack from distance
- **Magician:** Can use magic spells
- **Dwarf:** Better at mining and finding items
...
- The game includes multiple adventures of increasing difficulty.
- Rules are taught progressively through "letter" cards that introduce new mechanics during play.
- Each adventure has specific setup and victory conditions.
- The modular board means different layouts each game.
