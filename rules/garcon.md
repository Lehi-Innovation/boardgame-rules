...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Garcon&game=garcon)
<!-- verification:end -->
...
- Order cards (depicting various menu items)
- Event cards (special action cards)
- Tip tokens (scoring currency)
- Timer or time track
- Player boards or screens
...
- Force opponents to swap or forget orders
- Allow you to peek at hidden order information
- Provide time bonuses
- Block opponents' Event Cards
