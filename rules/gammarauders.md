...
play_time: "90 min"
designer: "Jeff Grubb"
source_pdf: "gammarauders-rules.pdf"
...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Gammarauders&game=gammarauders)
<!-- verification:end -->
...
- 12 bioborg cards (each with unique abilities and equipment slots)
- Modular hex map tiles (assembled differently each game)
- 200 counters (soldiers, hovertanks, gammajets, fortresses, energy pods, ruined cities)
- 108 playing cards (weapons, army reinforcements, special abilities)
- Turn order cards (numbered 1-6)
- 12 pages of rules

## Setup

1. Assemble the modular hex map tiles to create the game world.
2. Each player selects a bioborg card (e.g., Elvin the Tyrexian, Kizaro the Chimpanzero).
3. Each player places their base on the map at a designated starting location.
4. Place energy pods, ruined cities, and other terrain features on the map.
5. Distribute starting units (soldiers, hovertanks, gammajets) to each player.
6. Shuffle the card deck and deal starting hands.
...
- **Bioborgs:** Move up to 6 hexes
- **Infantry/soldiers:** Move up to 3 hexes
- **Hovertanks:** Move up to 5 hexes
- **Gammajets:** Unlimited movement
- Only bioborgs can pick up energy pods.
...
| Unit | Speed | Role |
|------|-------|------|
| Bioborg | 6 hexes | Main combat unit; picks up pods |
| Infantry | 3 hexes | Basic ground force |
| Hovertanks | 5 hexes | Armored mobile units |
| Gammajets | Unlimited | Air support |
| Fortresses | Stationary | Base defense |
...
### Unique Bioborg Abilities
Each of the 12 bioborgs has a unique special ability:
- Some have enhanced movement
- Some have extra equipment slots
- Some have defensive abilities
- Some have special attack powers
