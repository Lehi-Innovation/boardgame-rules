...
source_pdf: "habana-taxi-rules.pdf"
...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Habana%20Taxi&game=habana-taxi)
<!-- verification:end -->
...
1. Place the game board showing the map of Havana in the center of the table.
2. Each player takes a player piece and starting money/budget.
3. Place monument markers at their designated locations on the board.
4. Prepare the taxi cards or tokens.
...
1. **Choose a taxi:** Select a taxi to ride based on its destination, type, and cost.
2. **Pay the fare:** Deduct the cost from your budget (fare splits if sharing with other players).
3. **Travel:** Move your piece to the taxi's destination.
4. **Visit monuments:** If you arrive at a location with a monument, score points for visiting it.
5. **Plan ahead:** Consider upcoming destinations and taxi availability for future turns.
