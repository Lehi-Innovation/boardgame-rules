...
source_pdf: "ready-set-bet-rules.pdf"
extracted_date: "2026-03-03"
summarized_date: "2026-03-03"
rulebook_version: "Alderac Entertainment Group (2022)"
...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/ready-set-bet-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Ready%20Set%20Bet&game=ready-set-bet)
<!-- verification:end -->
...
- 32 VIP Cards
- 6 Win, Place, and Show Tokens
- 40 Player Bet Tokens (5 per player in 8 player colors: values 2, 3, 3, 4, 5)
- 12 Bonus Bet Tokens (black and white)
- 6 House Bet Tokens
- Money Chips: 55 x $1, 48 x $5, 32 x $25, 8 x $100
...
- The **2/3** and **11/12** horses trigger a Bonus Move when **either** of their component numbers is rolled back-to-back (e.g., rolling a 3 then a 2 triggers the 2/3 horse's bonus).
- A Bonus Move is **NOT** triggered on a **third** consecutive roll of the same number. The horse moves only the normal 1 space.
- However, a **fourth** consecutive roll **does** trigger a new Bonus Move (the 3rd and 4th rolls form a new back-to-back pair).

**House Responsibilities:**
- Call out **"Snake Eyes!"** for rolls of 2 and **"Boxcars!"** for rolls of 12 (relevant for certain VIP Cards).
- Announce each time a horse crosses the **red line** on the Race Track Board.
- When the **3rd horse** crosses the red line, shout **"No more bets!"** — players may not place any further Bet Tokens after this announcement.
...
- There is **no turn order**; bets are placed **simultaneously** and are **first come, first served**.
- Players may place tokens as quickly or slowly as they like.
- A player may **not** place a Bet Token on a spot where **another** Bet Token is already placed.
- Once placed, a Bet Token may **not** be moved or removed.
- Players may place tokens on any combination of Win/Place/Show bets, Color Bets, Prop Bets, and Exotic Finish bets.
...
- The **1st-place** horse pays out for all Win, Place, **and** Show bets.
- All horses that finish or tie for **2nd** pay out for Place **and** Show bets.
- All horses that finish or tie for **3rd** pay out for Show bets.

**Tiebreaking for placement:**
- If 2+ horses tie for **2nd place**, they are all considered to finish in both 2nd and 3rd. Any horses behind them do **not** Show.
- If there is no tie for 2nd, all horses that finish or tie for **3rd** are considered to Show.

*Within the Show, Place, and Win columns, spots to the RIGHT have better payouts and/or fewer losses.*

### Color Bets

- **3 Color Bet Spots** pay out if any horse of the corresponding color (Blue, Orange, Red) finishes in **1st place**.
- **1 additional spot** pays out if the **7 horse** finishes in **5th place or worse** (i.e., 4 or more horses finish ahead of it).
...
- **Winning bets:** The token's large number works like a Player Bet Token value (payout = multiplier x token value).
- **Losing bets:** The player pays **both** the Bet Spot's red circle penalty **and** the Bonus Bet Token's red circle penalty.
- **Value-2 Bonus Tokens** with a special shield symbol **negate** the losing value of any Bet Spot they are placed on — the player pays nothing to the supply for a losing bet with this token.
...
- **Winning bets:** Token value x Bet Spot multiplier
- **Losing bets:** Pay the red circle penalty on the Bet Spot (and Bonus Token red circle, if applicable)
- **VIP Card effects** (e.g., Snake Eyes & Boxcars, Complimentary Chips, Risky Gambler)
...
- Only **1 Bet Token** per Bet Spot (exception: Piggyback Bet VIP Card).
- A player may not place **more than 1** of their tokens on a single Exotic Finish Card.
- Once placed, tokens **cannot** be moved or removed.

### Tie Rules for Horse Placement

- **Clear 1st, 2nd, 3rd (no ties):** Win = 1st only; Place = 1st and 2nd; Show = 1st, 2nd, and 3rd.
- **Tie for 2nd:** All horses tied for 2nd are considered to Place AND Show. Horses behind them do **not** Show.
- **Tie for 3rd:** All horses tied for 3rd Show.
...
- Bonus Moves trigger on **back-to-back** identical sums (or either component number for the 2/3 and 11/12 horses).
- A 3rd consecutive roll does **not** trigger a bonus (the horse moves only 1 space).
- A 4th consecutive roll **does** trigger a new bonus (3rd + 4th form a new pair).
...
- The House player **cannot use their VIP Cards** during the round they are House.
- The House player **still drafts** a VIP Card at the end of the round for future use.
- Exception: If the House keeps the **Complimentary Chips** card, it resolves immediately.
- **Compensation for being House:** $3 in Round 2, $6 in Round 3, $9 in Round 4 (received before the race starts).
...
- **Winning bet:** Token value x Bet Spot multiplier = payout from supply
- **Losing bet:** Pay the red circle amount on the Bet Spot (flat cost, ignores token value)
- **Bonus Bet Token losing bet:** Pay Bet Spot red circle + Bonus Token red circle (exception: value-2 tokens with shield negate the Bet Spot loss)
