---
title: "Junta: Viva el Presidente!"
bgg_id: 84159
player_count: "3-5"
play_time: "45 min"
designer: "Sebastian Resl, Christoph Reiser"
source_pdf: "junta-viva-el-presidente-rules.pdf"
...
---
<!-- verification:begin -->
> ❗ **Known errors** — an audit found inaccuracies in this summary that could mislead players: Victory condition entirely missing: summary says "most wealth wins" but source requires 5+ VP game-end trigger; buildings count as 1 VP each; tiebreaker is most money in hand not most wealth. Until it is re-written, prefer the full rulebook text linked below.
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/junta-viva-el-presidente-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Junta%3A%20Viva%20el%20Presidente%21&game=junta-viva-el-presidente)
<!-- verification:end -->
...
1. Each player takes a Screen, Estate, Summary Card, and 1 Militia Die in their color.
2. Remaining dice and all Building Tiles are placed as Supplies in the center.
3. Shuffle all 45 Game Cards face-down as the Deck.
4. Roll to determine the first Presidente, who takes the Presidential Sunglasses.
...
| Phase | Action |
|-------|--------|
| 1. Draw Cards | Presidente: players + 2; Golpistas: 1 each |
| 2. Make Promises | Presidente distributes cards to Estates |
| 3. Command Militias | Secret orders behind screens |
| 4. Combat | Resolve battles by priority |
| 5. Spend Money | Buy buildings and militia |
| 6. Check Cards | Verify hand limits |

| Militia Order | Die Value |
|---------------|-----------|
| Attack player | Their Estate number |
| Defend self | Your Estate number |
| Defend Presidente | 6 |
