...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Hue&game=hue)
<!-- verification:end -->
...
### Movement
- Units move using movement points through urban terrain.
- Buildings, streets, walls, and rubble affect movement costs.
- Urban combat creates close-quarters engagements.

### Combat
- Combat is resolved using odds ratios on the Combat Results Table.
- Urban terrain provides significant defensive bonuses.
