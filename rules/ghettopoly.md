...
source_pdf: "ghettopoly-rules.pdf"
...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Ghettopoly&game=ghettopoly)
<!-- verification:end -->
...
- 1 game board
- Loan Shark tray (functions as the bank)
- 40 crack houses (equivalent to Monopoly houses)
- 17 projects (equivalent to Monopoly hotels)
- Pink Slip cards (equivalent to property deeds)
- Ghetto Stash cards (equivalent to Community Chest)
- Hustle cards (equivalent to Chance)
- 7 game pieces (Pimp, Hoe, 40 oz, Machine Gun, Marijuana Leaf, Basketball, Crack)
- Counterfeit money (game currency)
- 2 dice
...
- **Unowned property:** You may buy it by paying the listed price to the Loan Shark and taking the Pink Slip card. If you choose not to buy, it may be auctioned.
- **Owned property (by another player):** Pay rent to the property owner (amount listed on Pink Slip card).
- **Ghetto Stash space:** Draw a Ghetto Stash card and follow its instructions.
- **Hustle space:** Draw a Hustle card and follow its instructions.
- **Tax/shakedown space:** Pay the specified amount to the Loan Shark.
- **Liquor stores (railroads):** Standard railroad rules -- rent increases with more owned.
- **Utilities:** Standard utility rules.
- **Go to Jail corner:** Go directly to jail.
...
- Build crack houses evenly across the group.
- After 4 crack houses on each property, upgrade to a project (return crack houses to supply).

### Jail
- Go to jail by landing on the "Go to Jail" space, drawing certain cards, or rolling doubles three times.
- Get out by: paying a fine, using a get-out-of-jail card, or rolling doubles.
...
**Key Equivalencies to Monopoly:**
| Ghettopoly | Monopoly |
|------------|----------|
| Crack houses | Houses |
| Projects | Hotels |
| Liquor stores | Railroads |
| Ghetto Stash | Community Chest |
| Hustle | Chance |
| Loan Shark | Bank |
| Pink Slips | Title Deeds |
| Counterfeit money | Monopoly money |
