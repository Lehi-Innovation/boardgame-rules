...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Astoria&game=astoria)
<!-- verification:end -->
...
2. Distribute secret role cards to each player.
3. Shuffle and deal starting hands of alchemy cards.
4. Place the king's health marker on the starting position.
5. Set up initial threats on the board.

## Turn Structure

On each turn, a player:
1. Plays alchemy cards to influence events.
2. Resolves effects on threats, the king's health, or other players.
3. Draws new cards.
