...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Clash%20of%20the%20Gladiators&game=clash-of-the-gladiators)
<!-- verification:end -->
...
1. Shuffle the gladiator and animal cards.
2. Each player drafts or is dealt a team of gladiators.
3. Place scoring tokens nearby.
4. Determine a starting player.

## Turn Structure

Each round consists of:
1. **Deploy:** Players select gladiators from their hand to send into the arena.
2. **Combat:** Gladiators fight using dice rolls modified by their type.
3. **Resolve:** Wounds are assigned, defeated gladiators are removed, and points are scored.
...
| Gladiator Type | Specialty |
|---------------|-----------|
| Swordsman | Balanced fighter |
| Spearman | Range/initiative advantage |
| Net-thrower | Entangles opponents |
| Shield-Carrier | Defensive bonus |
| Trident-Carrier | High damage |

| Win Condition | Most points from eliminated enemy gladiators |
