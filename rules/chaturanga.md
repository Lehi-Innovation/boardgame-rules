...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Chaturanga&game=chaturanga)
<!-- verification:end -->
...
- 1 ashtapada board (8x8 grid, uncheckered)
- 16 light-colored pieces
- 16 dark-colored pieces
...
The game is won by:
- **Checkmate:** Placing the opponent's Raja under attack with no legal escape (though some historians believe capture rather than checkmate was the original rule).
- **Bare King:** Reducing the opponent to only their Raja with no other pieces remaining.

## Special Rules & Edge Cases

- There is no two-square initial pawn move (no en passant).
- There is no castling.
- Stalemate may be a win for the stalemating player (rather than a draw as in modern chess), though rules vary by historical source.
- The Mantri (Minister) is much weaker than the modern Queen, moving only 1 square diagonally.
- The Hasty (Elephant) jumps exactly 2 squares diagonally, unlike any modern chess piece.
- Not all rules of Chaturanga are known with certainty; the above represents the most commonly accepted reconstruction.
