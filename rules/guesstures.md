...
player_count: "4+"
play_time: "30 min"
source_pdf: "guesstures-rules.pdf"
...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/guesstures-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Guesstures&game=guesstures)
<!-- verification:end -->
...
### Scoring
- After all cards have been acted out or swallowed, add point values of grabbed cards under your team's Scene score on the Mimer-Timer.
- Maximum possible score per turn: 1 + 1 + 3 + 3 = 8 points, but could reach 10 if you play Scene 2 the same way.
...
### Scoring a Card
- Your score is 1 for "airplane," "type," and "size." Your score is 3 for more difficult words.
- Each card shows its point value.
- Only cards physically grabbed before being swallowed count.

## Scoring / Victory Conditions

After both teams have completed Scenes 1 and 2:
- Total the points from both scenes for each team.
- The team with the most total points wins.
- Clean the scoring surface by rubbing gently with a soft cloth.

## Special Rules & Edge Cases

- In most cases, forms of each word are acceptable. Example: "explosion" for "explode" is O.K. Saying "glasses" for "sunglasses" is not O.K.
- **Scene 2:** Play Scene 2 the same way as Scene 1, using the red card deck (2 and 4-point words). Enter each team's score next to "Scene 2" on the Mimer-Timer.
- **Fun Alternative:** Instead of dividing into teams, take turns being Actors while the rest of the players all shout out their guesses.
- If one team has one more player, that team chooses an Actor for 2 turns.
- Alternate teams until all players have had a chance to act in both Scenes.
