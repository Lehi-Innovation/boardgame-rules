...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/chancellorsville-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Chancellorsville%201863&game=chancellorsville)
<!-- verification:end -->
...
- 1 Game board (battlefield with movement locations, hidden movement maps, formation areas)
- 2 Rule books
- 7 blue Union named formation markers (wooden blocks)
- 8 blue cubes (Union cohesion and general special ability tracking)
- 3 blue cubes (Union control markers)
- 15 Union Player Activation cards
- 15 Union BOT Activation cards (for solitaire)
- 12 Union Reinforcement cards
- 1 Union screen
- 5 red Confederate named formation markers
- 7 red cubes (Confederate cohesion and general special ability tracking)
- 15 Confederate Activation cards
- 15 Confederate BOT Activation cards (for solitaire)
- 12 Confederate Reinforcement cards
- 1 Confederate screen
- 36 Tactics cards
- 25 black Momentum cubes
- 12 brown Redoubt cubes
- 9 six-sided dice
...
**Combat Results (dice pairs):**
| Roll | Result |
|---|---|
| Double 1s | Attacker -1 Cohesion |
| Double 2s | Attacker -1 Cohesion |
| Each 3 | +1 Momentum cube |
| Double 4s | Defender -1 Cohesion |
| Double 5s | Defender -1 Cohesion |
| Double 6s | Defender -2 Cohesion + retreat |
