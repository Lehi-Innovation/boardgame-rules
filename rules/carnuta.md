...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/carnuta-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Carnuta&game=carnuta)
<!-- verification:end -->
...
- 72 Ingredient cards (Day ingredients: Clover, Flower, Egg, Honey; Night ingredients: Skull, Butterfly, Berry, Mushroom)
- 8 Starting cards
- 22 double-sided runes (Sun on one side, Moon on the other)
- 4 player boards
- 4 counters (to track cards played)
- 8 Padlock tokens
- 8 Sickle tokens
- 8 Bonus Ingredient tokens
- 1 Ancestor token
- 1 score pad
...
1. Sort Ingredient cards into Day and Night piles, shuffle each separately, and form 2 facedown decks.
2. Reveal the top 4 cards of each deck, placing them in a row faceup (8 visible cards total).
3. Leave space for a discard pile.
4. Create a reserve of runes based on player count: 2 players = 1 Sun + 1 Moon; 3 players = 2 Sun + 2 Moon; 4 players = 3 Sun + 3 Moon.
5. Place the 8 Bonus Ingredient tokens nearby.
6. Shuffle the 8 starting cards and deal 1 to each player (placed faceup in front of them).
7. Place the Ancestor token in front of a random player (they go first).

**For Each Player:**

1. Choose a board and place it in front of you.
2. Insert a counter in the window of your board on level "1."
3. Place 4 runes on the first four spaces: 2 Sun side up and 2 Moon side up.
4. Place 2 Padlock tokens on the last two spaces of your board.
5. Place 2 Sickle tokens on your board.
...
1. Discarding down to a maximum of 3 cards in hand.
2. Moving your counter to match the number of cards played in front of you.

When your counter reaches certain bonus spaces, immediately gain the corresponding effect:
- **Padlock removal:** Remove a Padlock from your board, gaining an extra rune space.
- **Bonus Ingredient:** Take a Bonus Ingredient token from the center; it counts as 1 extra ingredient of the type shown at end of game.
...
- **Double cards:** Count as 2 ingredients of the type shown at end of game.
- **Salt cards (Wild):** Stack on top of a card already played. Counts as 1 extra ingredient of that type. Once placed, Salt cannot be moved.
...
- **6 points** for each set of 3 specific ingredients shown
- **4 points** for each set of 2 specific ingredients shown
- **2 points** for each of a specific ingredient shown
- **1 point** per ingredient of each of two types shown
- **1 point** per ingredient shown (including the card itself)
- **5 points** flat
- **2 points** flat
...
- You may perform the same action twice in a turn.
- Padlocked spaces cannot hold runes until the Padlock is removed by reaching the corresponding bonus space.
- At end of turn, you must discard down to 3 cards in hand; cards above this limit are discarded.
- Salt cards are permanently placed once stacked on a column and cannot be moved.
- Double cards count as 2 ingredients for scoring purposes.
- Bonus Ingredient tokens count as extra ingredients for scoring.
