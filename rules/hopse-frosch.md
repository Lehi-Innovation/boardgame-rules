...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Hopse%20Frosch&game=hopse-frosch)
<!-- verification:end -->
...
1. Assemble the game base with the central pond.
2. Each player selects a frog piece and places it at the starting position.
3. Place all drawing sticks in their holder.
4. Determine who goes first (youngest player or by agreement).

## Turn Structure

On your turn:
1. **Draw a stick** from the holder.
2. **Check the tip:**
...
3. Pass play to the next player.
...
| Stick Tip | Result |
|-----------|--------|
| Not red | Hop frog forward one space |
| Red | Skip turn |

| Win Condition | First frog into the pond |
