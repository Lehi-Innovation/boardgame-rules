...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/celestia-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Celestia&game=celestia)
<!-- verification:end -->
...
- 6 Adventurer pawns
- 6 Adventurer tiles
- 9 oval City tiles (numbered 1 to 25 in ascending value)
- 4 Event dice
...
- 68 Equipment cards:
  ...
  - 14 black Cannons
- 8 Turbo cards
- 4 x 2 Power cards (Ejection x2, Jetpack x2, Alternative Route x2, Wind Gust x2)
- 4 Magic Spyglass treasure cards (in first 4 cities only)
- 1 rulebook
...
- **"I will stay"** -- leaves pawn in the aircraft
- **"I will leave"** -- removes pawn, places it on their Adventurer tile, draws the top Treasure card from the current city's deck
...
- Fog: play 1 Compass
- Lightning: play 1 Lightning Arrester
- Birds: play 1 Foghorn
- Pirates: play 1 Cannon
- Blank: no card needed
...
- **Success:** Aircraft moves to the next city. All played cards go to the discard pile.
- **Failure:** The captain plays NO cards. The aircraft crashes. No passengers (including the captain) receive any Treasure this journey. The journey ends.
...
- If the captain is alone in the aircraft at the start of a leg, they may choose to land (take a Treasure) without rolling dice, or continue.
- If the deck runs out, shuffle the discard pile to form a new deck.
- If a city runs out of Treasure cards, remove that City tile; the aircraft no longer stops there. If a passenger takes the last card, no more passengers may disembark at that city.
- If the aircraft reaches the last city (25), starting with the captain and going clockwise, each player aboard draws a Treasure card. Some players may receive nothing if cards run out. A new journey then begins.
- The captain MUST play Equipment cards if he has them. He is never forced to play Turbo cards.
- Discussion and persuasion between players before deciding to stay or leave is encouraged.
- It is always allowed to count the remaining Treasure cards in any city.
