...
designer: "Ed Beach"
source_pdf: "here-i-stand-rules.pdf"
...
---
<!-- verification:begin -->
> ❗ **Known errors** — an audit found inaccuracies in this summary that could mislead players: Summary invents per-power VP targets and "closest to goal" wins; omits Domination Victory entirely; Standard Victory fires mid-game at 25 VP not only at final turn; New World Phase missing from turn structure; Spring Deployment misdescribed as "redeploy within home territories" vs source "one formation from capital to a controlled space". Until it is re-written, prefer the full rulebook text linked below.
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/here-i-stand-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Here%20I%20Stand&game=here-i-stand)
<!-- verification:end -->
