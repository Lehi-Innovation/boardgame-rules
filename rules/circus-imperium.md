...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Circus%20Imperium&game=circus-imperium)
<!-- verification:end -->
...
- 2 double-sided racing track maps
- Chariot and beast counters/miniatures
- Maneuvering cards
- Whip result cards
- Combat cards
- Player dashboards (tracking beast health, chariot damage)
- Dice
- Rules booklet
...
- On their own chariot
- On another player's chariot (if they boarded it)
- Riding a beast
- On foot
...
- Beasts are carnivorous alien creatures and can attack their own drivers if mistreated (too much whipping).
- A driver thrown from their chariot may attempt to board another or ride a loose beast.
- Crashes into the arena wall cause damage to both chariot and beasts.
- Frenzied beasts move according to special rules and may leave the track.
- The game is set in the Renegade Legion sci-fi universe but plays as a standalone game.
- Two different track layouts provide variety.
- Games are typically chaotic and rarely see all chariots complete the race intact.
