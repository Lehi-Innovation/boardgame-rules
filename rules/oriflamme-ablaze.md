---
title: "Oriflamme: Ablaze"
bgg_id: 313261
player_count: "3-5"
play_time: "15-30 minutes"
designer: Adrien Hesling, Axel Hesling
source_pdf: "OriflammeAblaze-_Rules_EN.pdf"
...
- 63 Influence Point tokens (values 1 and 5)
- 1 First Player tile
- 1 Resolution Direction tile
- 5 Bribery tokens (1 per family)
...
- **Face-down card:** Owner chooses to reveal (gain accumulated IP + apply ability) or leave hidden (+1 IP from supply placed on card).
- **Already revealed card:** Must apply its ability again.
- Eliminating any card earns the eliminator 1 IP.
- Face-down cards that are eliminated are revealed; any IP on them are lost.
...
- After 6 rounds, 1 card remains unplayed.
- Most Influence Points wins.
- IP on cards still in the Queue at game end do not count.
- **Tiebreaker:** Most cards remaining in the Queue.

## Special Rules & Edge Cases

- Can be combined with base Oriflamme: players choose 10 cards from both sets (keeping 1 family color).
- Stacking rules are identical to base game: covered cards are inactive until uncovered.
- Twin card is set aside at the start and used as a special play option.
- Bribery token is one-use per game.
- Mandatory abilities must be applied even against your own cards.
