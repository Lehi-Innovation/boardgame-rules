---
title: "Devil Bunny Hates the Earth"
bgg_id: 1817
player_count: "2-5"
play_time: "30 min"
...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Devil%20Bunny%20Hates%20the%20Earth&game=devil-bunny-hates-the-earth)
<!-- verification:end -->
...
1. Place the Taffy Factory board in the center of the table.
2. Each player places their Taffy Machine pawn on one of the designated platforms -- the pawn never moves during the game.
3. Distribute squirrel tokens across the platforms as indicated by the rules.

## Turn Structure

On your turn:
1. Determine which platform's squirrels you control (randomly selected).
2. Move those squirrels en masse along any connected pipe.
3. Drop one squirrel on each platform you pass through.
4. If a squirrel reaches your Taffy Machine, you score it.
