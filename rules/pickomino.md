...
source_pdf: "pickomino-rules.pdf"
...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/pickomino-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Pickomino&game=pickomino)
<!-- verification:end -->
...
1. Place the 16 worm helpings in ascending order (21-36) in a row in the center of the table. This is the grill.
2. The youngest player begins; play proceeds clockwise.
...
1. **Roll all 8 dice.**
2. **Choose one symbol** (a number 1-5 or worm) from the roll. Take ALL dice showing that symbol and set them aside. You may only choose a symbol you have not previously set aside this turn.
3. **Optionally reroll** all remaining dice and repeat step 2, OR **stop** and total your score.
4. **Each worm die counts as 5 points** when totaling your score.
5. You **must** have at least one worm die among your set-aside dice to claim a tile.
...
| Worm Helpings | Number | Worms Shown |
|---------------|--------|-------------|
| 21-24 | 4 tiles | 1 worm each |
| 25-28 | 4 tiles | 2 worms each |
| 29-32 | 4 tiles | 3 worms each |
| 33-36 | 4 tiles | 4 worms each |
