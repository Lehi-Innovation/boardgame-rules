...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Globbo%21&game=globbo)
<!-- verification:end -->
...
- 1 hex grid game board (alien playpen)
- Globbo pieces: Head, Blue Zap parts, Red Slap parts
- Little Angel pieces: Biters, Blips, Yeasts
- Rules sheet
...
- Blue Zaps must form an unbroken chain connected to the Head.
- Red Slaps must be adjacent to Blue Zaps.
- Globbo grows by adding new parts to the chain.
...
- When a Biter is destroyed by Globbo, it explodes into Blips and Yeasts.
- Blips and Yeasts can combine (when adjacent) to form new Biters.
- This creates a regeneration cycle: destroy Biters, they split, recombine, attack again.

### Combat
- Globbo's attacks destroy Little Angel units in range.
- Biter attacks damage Globbo body parts (removing them from play).
- Destroying the Head is devastating to Globbo but difficult due to protection from Zaps and Slaps.
...
**Victory:**
- Globbo: Eliminate all Little Angels
- Little Angels: Cripple Globbo

**Key Numbers:**
| Item | Value |
|------|-------|
| Players | 2 |
| Head range | 15 hexes (straight line) |
| Blue Zap range | 3 hexes |
| Red Slap range | Adjacent only |
