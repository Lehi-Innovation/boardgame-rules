...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Alaska&game=alaska)
<!-- verification:end -->
...
- Hex game board
- Hexagonal ice tiles
- Colored container blocks (one set per player)
- Player camp markers
- Spring thaw tokens or mechanism

## Setup

1. Place the game board centrally with the island in the middle.
2. Each player places their container blocks on the central island.
3. Each player sets up their camp on their assigned edge of the board.
4. Shuffle the ice tiles and prepare them for drafting.
...
- Ice tiles removed during thaw destroy any containers still on them or strand containers on isolated ice floes.
- Players may intentionally place ice to block opponents during Winter.
- The thaw mechanic creates increasing urgency as the game progresses.
- Some variants use dice or cards to determine which tiles are removed during thaw.
