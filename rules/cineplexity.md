...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Cineplexity&game=cineplexity)
<!-- verification:end -->
...
- 315 Cineplexity cards across 9 categories:
  - Actors
  - Characters
  ...
  - Setting
  - Theme
- Rules sheet (double-sided, glossy cardstock)
...
- The same movie title cannot win in two consecutive rounds.
- Sequels cannot be used in back-to-back rounds (e.g., "Die Hard" then "Die Hard 2").
- Television shows, miniseries, and home movies are not valid answers; only theatrical films count.
- Critique cards are subjective and require the director's judgment.
- Players may challenge answers, but the director has final authority.
- The game works best with groups that share similar movie knowledge.
