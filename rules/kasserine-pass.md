...
play_time: "120 min"
designer: "John Hill"
source_pdf: "kasserine-pass-rules.pdf"
...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Kasserine%20Pass&game=kasserine-pass)
<!-- verification:end -->
...
1. Place the map board on the table.
2. The Axis player places initial units according to the Axis Initial Units Appearance Chart.
3. The Allied player places initial units according to the Allied Initial Units Chart.
4. Place the turn marker on Turn 1.
5. Additional units arrive as reinforcements on specified turns according to the appearance charts.

## Turn Structure

Each turn (representing one day) follows the standard IGO-UGO sequence:
1. **Axis Movement Phase:** The Axis player moves units.
2. **Axis Combat Phase:** The Axis player resolves attacks.
3. **Allied Movement Phase:** The Allied player moves units.
4. **Allied Combat Phase:** The Allied player resolves attacks.
5. **End of Turn:** Advance the turn marker. Check for reinforcements.
...
| Unit Type | ZOC Entry Cost | Can Move Through ZOC? |
|-----------|---------------|----------------------|
| German Panzers | +2 MP | Yes |
| German Panzer Grenadiers | +2 MP | Yes |
| German Recon | +2 MP | Yes |
| Other German | +2 MP | No |
| All Allied | +4 MP | No |
