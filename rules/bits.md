...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Bits&game=bits)
<!-- verification:end -->
...
1. **Observe**: Examine the current board state and your available tiles.
2. **Place Tile**: Place one tile from your hand onto the board, connecting to existing tiles.
3. **Score**: Calculate points earned from the placement based on pattern matching and configuration.
4. **Draw**: Draw a new tile to replenish your hand.
...
| Action | Effect |
|---|---|
| Place Tile | Add to board, score patterns |
| Draw Tile | Replenish hand |

| Scoring | Based On |
|---|---|
| Pattern Match | Matching colors/shapes |
| Configuration | Tile arrangement |
