...
---
<!-- verification:begin -->
> ❗ **Known errors** — an audit found inaccuracies in this summary that could mislead players: Components accurate but domination rule, dial advancement conditions, Hero tokens, hand limit, and corruption supply all contradict source; five-regions-ruined end condition missing. Until it is re-written, prefer the full rulebook text linked below.
>
...
**Threat Dial Advancement Conditions:**
| Power | Advances When... |
|-------|-----------------|
| Khorne | Kills enemy figures in battle |
| Nurgle | Has cultists in 2+ regions with at least 1 Peasant token |
| Tzeentch | Has cultists in 2+ regions with at least 1 Warpstone token |
| Slaanesh | Has cultists in 2+ regions with at least 1 Noble or Hero token |

**Loss condition:** If the Old World deck is exhausted and no player has won, all players lose.

## Special Rules & Edge Cases

- Each region has a Resistance value; higher-resistance regions are harder to dominate and ruinate.
- Heroes in a region deal automatic hits to Chaos followers during battle.
- Ruinated regions are permanently changed and may no longer be entered or corrupted normally.
- The dial not only tracks victory progress but also unlocks Upgrade cards at specific positions.
- Populous regions (marked) receive additional Old World tokens.
- 3-player game: one power is not used (rules specify which can be omitted).
- Corruption token supply is limited (29 per power); if depleted, you cannot place more.
...
- Cultists place corruption tokens
- Most corruption in region = domination (score region VP)
- 12+ total corruption = Ruination (bonus VP, region changes)
