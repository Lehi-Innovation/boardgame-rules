...
---
<!-- verification:begin -->
> ❗ **Known errors** — an audit found inaccuracies in this summary that could mislead players: 3 of 4 victory conditions wrong (Coalition/Government/Warlords), Taliban special activities list Suborn instead of Ambush, Coalition colors wrong, Pass reward misstated. Until it is re-written, prefer the full rulebook text linked below.
>
