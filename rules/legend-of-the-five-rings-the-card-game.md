...
- Dynasty deck (per player): Characters, Holdings
- Conflict deck (per player): Events, Attachments, Characters
- Province cards (5 per player)
- Stronghold card (1 per player)
- Role card (1 per player)
- Fate tokens
- Honour tokens
- Status tokens (honoured/dishonoured)
- Ring tokens (5 elemental rings: Air, Earth, Fire, Water, Void)
- First player token

## Setup

1. Each player places their Stronghold face-up and 5 Province cards face-down in a row.
2. Shuffle Dynasty and Conflict decks separately.
3. Place 1 Dynasty card face-down on each province.
4. Place the 5 elemental ring tokens in the center as unclaimed.
5. Each player starts with honour equal to their Stronghold's honour value.
6. Determine first player (bid honour, lowest wins first player; difference in bids paid in honour).
7. Each player draws a starting hand from their Conflict deck (varies, typically 4 cards).
8. Each player gains fate equal to their Stronghold's fate value.
...
**Phase Order:**
1. Dynasty (reveal and play characters)
2. Draw (bid honour, draw Conflict cards)
3. Conflict (declare and resolve up to 2 conflicts)
4. Fate (remove fate, collect income, return rings)
5. Regroup (ready cards, check hand limit, pass first player)

**Ring Effects (when claimed by attacker):**

| Ring | Effect |
|------|--------|
| Air | Take 1 honour from opponent OR gain 2 honour |
| Earth | Draw 1 card; opponent discards 1 |
| Fire | Honour or dishonour a character |
| Water | Ready a character you control or bow a character with no fate |
...
| Condition | Result |
|-----------|--------|
| Break 3 opponent provinces | Win |
| Reach 25 honour | Win |
| Reach 0 honour | Lose |
