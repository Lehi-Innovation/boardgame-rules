...
source_pdf: "qwirkle-cubes-rules.pdf"
extracted_date: "2026-03-22"
summarized_date: "2026-03-22"
rulebook_version: "MindWare"
...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/qwirkle-cubes-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Qwirkle%20Cubes&game=qwirkle-cubes)
<!-- verification:end -->
...
### Scoring
- Score 1 point per die in each line you add to or create.
- If you complete a line of exactly 6 dice (a Qwirkle), score 6 bonus points (12 total for that line).
- If your placement touches multiple lines, score for each.
...
- No line may contain duplicate dice (same color AND same shape).
- You may swap dice instead of placing: return any number to the bag, draw the same number, and roll them. This uses your whole turn.
- All 6 dice in a Qwirkle line must be unique in the non-shared attribute.
