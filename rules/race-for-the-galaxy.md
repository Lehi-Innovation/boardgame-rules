...
source_pdf: "race-for-the-galaxy-rules.pdf"
extracted_date: "2026-03-22"
summarized_date: "2026-03-22"
rulebook_version: "Rio Grande Games"
...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/race-for-the-galaxy-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Race%20for%20the%20Galaxy&game=race-for-the-galaxy)
<!-- verification:end -->
...
- The VP chip pool is depleted, OR
- Any player has 12 or more cards in their tableau.
...
- Cards are the universal currency: to build, you discard cards from hand equal to the cost.
- Windfall worlds produce a good only when settled (or via Produce bonus). Production worlds produce each round a Produce phase occurs.
- Military worlds do not require card payment; instead your total military strength must meet or exceed the world's defense.
- Some developments grant VP based on specific card types in your tableau.
