...
<!-- verification:begin -->
> ❗ **Known errors** — an audit found inaccuracies in this summary that could mislead players: Invented money/treasury economy and Economic Phase; 55-card driven core never mentioned; Insurrection/Strategy/Surrender/Winter Attrition phases missing; victory conditions misstated. Until it is re-written, prefer the full rulebook text linked below.
>
> 📄 [Full rulebook text](https://jonnyallred.github.io/boardgame-rules/extracted/age-of-napoleon-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Age%20of%20Napoleon&game=age-of-napoleon)
<!-- verification:end -->
...
1. **Diplomacy Phase**: Attempt to sway neutral nations.
2. **Economic Phase**: Collect income and manage treasury.
3. **Reinforcement Phase**: Purchase and place new units.
4. **Movement Phase**: Move armies across the map.
5. **Combat Phase**: Resolve battles between opposing forces.
6. **Political Phase**: Check victory conditions and political events.
