...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Ierusalem%3A%20Anno%20Domini&game=ierusalem-anno-domini)
<!-- verification:end -->
...
1. Place the game board centrally with the Last Supper table visible.
2. Each player takes a starting deck of 10 basic cards.
3. Place Apostles at their designated positions at the table.
4. Set the Sanhedrin marker at the bottom of its track.
5. Prepare location and parable card supplies.
6. Distribute starting resources to each player.

## Turn Structure

On your turn:
1. **Play a card** from your hand.
2. **Visit a location** — The top of the card indicates which location you may access for collecting resources.
3. **Perform actions** — The bottom of the card shows icons that can be completed in the order they appear.
4. **Advance Sanhedrin** — If the card shows a Sanhedrin symbol, advance the Sanhedrin marker one space.
...
| Action | Effect |
|--------|--------|
| Listen to parable | Gain parable card |
| Go to table | Seat a follower |
| Change seats | Reposition a follower |
| Do a favor | Gain benefits, count toward scoring |
| Collect resources | Gather resources at location |

| Scoring Element | Points |
|----------------|--------|
| Follower behind 6-pt Apostle | 6 minus distance |
| Follower behind 4-pt Apostle | 4 minus distance |
| Follower behind 2-pt Apostle | 2 minus distance |
