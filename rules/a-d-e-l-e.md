...
<!-- verification:begin -->
> ❗ **Known errors** — an audit found inaccuracies in this summary that could mislead players: Action menu misrepresented (invented Share Information/Pick Up actions, omits 3-cube Special Action delivery and Spirit rolls); wounds reduce carrying capacity, not action cubes. Until it is re-written, prefer the full rulebook text linked below.
>
> 📄 [Full rulebook text](https://jonnyallred.github.io/boardgame-rules/extracted/a-d-e-l-e-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20A.D.E.L.E.&game=a-d-e-l-e)
<!-- verification:end -->
...
2. Choose ADELE player. They get the console (matching player count side), hazard tokens (4 drawn into bag), ADELE deck (4 cards drawn), and energy counter.
...
5. Distribute 5 face-down objects on ship locations, then place 20 shuffled objects (including 7 mission objects) face-down in ship locations.
