...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Louis%20XIV&game=louis-xiv)
<!-- verification:end -->
...
1. Arrange the 25 courtier tiles in a 5x5 grid.
2. Each player takes their set of influence markers.
3. Shuffle and deal mission cards to each player.
4. Place coat of arms tiles, money, and tokens as supply.
...
**Round Structure:**
1. Acquire influence cards
2. Place influence markers (adjacency required)
3. Evaluate courtiers (majority wins)
4. Complete missions (spend coat of arms)
