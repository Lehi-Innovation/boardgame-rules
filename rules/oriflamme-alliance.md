...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Oriflamme%3A%20Alliance&game=oriflamme-alliance)
<!-- verification:end -->
...
1. Each player takes a complete family of cards (same color).
2. Set aside any special setup cards per the Alliance rules.
3. Shuffle remaining cards, remove 3 random cards face down. Keep 7 in hand.
4. Each player takes 1 Influence Point.
5. Remaining IP form the supply.
6. Oldest player is First Player. Place Resolution Direction tile.
