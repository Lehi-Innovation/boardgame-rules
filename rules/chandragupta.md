...
---
<!-- verification:begin -->
> ❗ **Known errors** — an audit found inaccuracies in this summary that could mislead players: Turn sequence misordered, invented "Chaos cards" component in a cardless game, invented supply/fatigue and "Simple GBoH" rules, elephant rule contradicts source (Elephants do not rout, but Rampage). Until it is re-written, prefer the full rulebook text linked below.
>
...
- Multiple battle maps (hex grids)
- Hundreds of unit counters (infantry, cavalry, elephants, chariots, leaders)
- Chaos cards
- Dice
...
- Shock combat (melee charges)
- Missile fire (ranged attacks)
- Combat results based on differential between attack and defense values modified by terrain, facing, and unit condition
- Morale checks after combat

### Leadership
Leaders are critical for activating units. Higher-quality leaders can:
- Activate more units per turn
- Conduct additional activations
- Trump opponent activations
- Rally routing troops more effectively

## Scoring / Victory Conditions

Victory conditions are scenario-specific, typically based on:
- Rout points accumulated (destroying or routing enemy units)
- Control of key terrain objectives
...
- Elephants can cause panic among friendly units if they rout.
- Chariots are powerful on open ground but vulnerable in rough terrain.
- The Simple GBoH rules provide a streamlined alternative for faster play.
- Terrain effects significantly modify combat and movement.
- Stacking limits restrict how many units can occupy a hex.
- Supply and fatigue rules apply in longer scenarios.
