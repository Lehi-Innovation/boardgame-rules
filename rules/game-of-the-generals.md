...
player_count: "2"
play_time: "20-30 min"
designer: "Sofronio H. Pasola Jr."
source_pdf: "game-of-the-generals-rules.pdf"
...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Game%20of%20the%20Generals&game=game-of-the-generals)
<!-- verification:end -->
...
- 1 game board (8 columns x 9 rows = 72 squares)
- 42 playing pieces (21 per player in two different colors), each with rank printed on one side only
- 1 arbiter (optional; a third person or agreed-upon honor system)
...
### Movement Rules
- All pieces move identically: one square forward, backward, or sideways (not diagonally).
...
- Higher-ranked officers eliminate lower-ranked officers.
- **Spy** eliminates any officer (from 5-Star General down to 2nd Lieutenant) and Sergeant.
- **Private** eliminates Spy.
- **Spy** is eliminated by Private.
- **Flag** is eliminated by any piece.
...
- **Positioning:** Protecting the Flag while probing for the opponent's Flag.
- **Bluffing:** Moving pieces aggressively or defensively to mislead the opponent about their rank.
- **Deduction:** Tracking which pieces the opponent has lost to narrow down remaining threats.
...
| Attacker | Eliminates |
|----------|-----------|
| Any officer | Lower-ranked officers, Privates, Flags |
| Spy | All officers + Sergeant + Flag |
| Private | Spy + Flag |
...
| Item | Value |
|------|-------|
| Board size | 8 x 9 (72 squares) |
| Pieces per player | 21 |
| Privates per player | 6 |
| Spies per player | 2 |
| Flags per player | 1 |
