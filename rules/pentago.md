...
bgg_id: 19841
player_count: "2"
play_time: "10-15 minutes"
designer: "Tomas Floden"
source_pdf: "pentago-rules.pdf"
...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/pentago-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Pentago&game=pentago)
<!-- verification:end -->
...
- 1 game board base with 4 twistable 3x3 game blocks (quadrants)
- 18 marbles of each color (2 colors)
...
- A winning row of five can run across multiple game blocks.
- You must always twist a non-neutral game block if one exists (the twist is mandatory once all blocks have 2+ marbles).
- If your placement creates five in a row, you win immediately without needing to twist.
- If your twist creates five in a row for your opponent but not for you, your opponent wins.
- If the twist creates five in a row for both players simultaneously, it is a draw.
- Six or more in a row counts as a win (five is the minimum).
