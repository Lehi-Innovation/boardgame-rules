...
player_count: "2-6"
play_time: "30-45 min"
designer: "CO-5 Company"
source_pdf: "aggravation-rules.pdf"
...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/aggravation-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Aggravation&game=aggravation)
<!-- verification:end -->
...
1. **Rolls the die**: Roll one six-sided die.
2. **Moves a marble**: Move one marble the number of spaces shown on the die, or bring a marble out of base if a 1 or 6 is rolled.
3. **Bonus roll**: If a 6 is rolled, the player takes an additional turn after completing their move.
