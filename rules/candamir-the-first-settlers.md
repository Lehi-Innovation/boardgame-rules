...
At the start of your turn you may **trade** (with other players or 3-for-1 with the bank). Then choose one action:
...
**D. Events:** Moving toward a bear, wolf, snake, or Candamir icon requires a test. Roll the die and add your relevant ability score; meet or exceed the target number to succeed.
...
### Character Abilities
Each character has 4 abilities: **Strength, Prowess (fighting skill), Agility,** and **Charisma**. Each starts at the base value shown on the character card. Abilities are improved by experience markers (up to +4 for one ability using the 3/4 marker) and/or equipment (+2 per piece).

### Experience
When reaching an exploration tile with an experience point, place or advance an experience marker on your Character Board. You have three 1/2 markers and one 3/4 marker; only one ability can reach +4.

### Equipment
Equipment is found on exploration tiles (shield, bear-tooth necklace, bow, or boots). Each piece permanently adds +2 to the corresponding ability. You may not have two of the same equipment; finding a duplicate grants 1 experience point instead.

### Potions and Mead
- **Brigitta's Potion** (brewed from 1 mushroom + 1 herb): Drink before a die roll to add +2 to your ability score for that test. Only one potion per test.
- **Healing Potion** (1 honey + 1 mushroom): Drink at any time to raise endurance by 2 (maximum 4). One or two may be drunk at once.
- **Mead** (1 honey + 1 herb): Drink at the **end of your turn**. Each mead used causes every opponent who has as many or more VP cubes on the board than you to lose 1 endurance. No player's endurance may fall below -1.

### Adventures
The 3 face-up adventure cards each require a die test (sometimes two sequential tests, or a required ingredient/mead to attempt). Success earns the reward shown; place the completed card in front of you and draw a replacement. Failure leaves the card available; suffer any endurance penalty shown.

**Hero of Catan:** The first player to complete 3 adventures earns 1 special VP (cube placed in the Hero of Catan box). If another player completes more adventures, they take over the special VP.
...
- **Hero of Catan:** Earned by being the first to complete 3 adventure cards; may be stolen by whoever completes more.

**The first player to place all 10 of their VP cubes on the board wins immediately.**
...
**Turn Sequence:** (Optional: Trade) → Choose: Explore OR Build & Brew (village only, no goal token on board)

**Character Abilities:** Strength, Prowess, Agility, Charisma
...
| Good | Resources |
|------|-----------|
| Sword | 2 ore + 1 lumber |
| Chest | 1 hide + 1 ore + 1 lumber |
| Window Cover | 2 hide + 1 lumber |

**Brew Costs:**
| Drink | Ingredients |
|-------|-------------|
| Brigitta's Potion | 1 mushroom + 1 herb |
| Healing Potion | 1 honey + 1 mushroom |
| Mead | 1 honey + 1 herb |

**Victory:** First player to place all 10 VP cubes on the board wins.
