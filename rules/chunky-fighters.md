...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Chunky%20Fighters&game=chunky-fighters)
<!-- verification:end -->
...
- Fighter dice sets (4 dice per fighter: head, body, legs, weapon)
- Special ability cards (1 per fighter, unique powers)
- Damage/hit location dice
- Reference cards
...
- Each fighter has a unique special ability card that provides a one-time or ongoing power during combat.
- Weapons modify attack damage and may provide special effects (reach, double strike, etc.).
- Body part destruction may have cascading effects (e.g., destroyed legs reduce mobility).
- The game was originally designed as a print-and-play title; commercial editions include pre-assembled custom dice.
- Multiple starter sets and expansion sets add new fighters with unique dice faces and abilities.
- Tournament rules support larger player counts with bracket-style elimination.
