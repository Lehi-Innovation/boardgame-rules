...
source_pdf: "kutn-hora-the-city-of-silver-rules.pdf"
...
---
<!-- verification:begin -->
> ❗ **Known errors** — an audit found inaccuracies in this summary that could mislead players: SOURCE_MISMATCH: extracted file is the Czech Games Edition product page (czechgames.com), not rulebook; contains only marketing copy and component list stub, no rules. Until it is re-written, prefer the full rulebook text linked below.
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/kutn-hora-the-city-of-silver-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Kutn%C3%A1%20Hora%3A%20The%20City%20of%20Silver&game=kutn-hora-the-city-of-silver)
<!-- verification:end -->
...
1. Place the main board centrally. Assemble the market card stands.
2. Deal a setup card to each player — this determines which 3 of the 6 guilds each player belongs to (metallurgists, miners, builders, scribes, innkeepers, grocers). Guild membership is asymmetric.
3. Each player takes a dual-layer player board and all tokens of their color.
4. Set initial market prices on the card stands according to player count.
5. Shuffle and place building tiles in the offer area.
6. Place St. Barbara tiles on the cathedral track.
7. Give each player their 6 action cards and starting coins.
...
**Actions**: Mine | Rights | Plot | Building | Income | St. Barbara | (Joker = any action, costs 1 reputation)
