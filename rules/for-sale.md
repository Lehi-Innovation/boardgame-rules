...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/for-sale-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20For%20Sale&game=for-sale)
<!-- verification:end -->
...
1. Separate House cards from Cheque cards. Shuffle each into separate decks.
2. For 4 players: remove the top 2 House cards without looking at them.
3. Distribute starting coins based on player count:
   - 3 players: 28 coins each
   - 4 players: 21 coins each
   - 5 players: 16 coins each
   - 6 players: 14 coins each
4. Keep coins hidden. Randomly determine the first player.
...
**Each Round:**
1. Draw as many House cards as there are players and place them face-up in the center.
2. Players bid in clockwise order starting with the first player.
...
**Each Round:**
1. Draw as many Cheque cards as there are players and place them face-up.
2. All players simultaneously select 1 House card from their hand and play it face-down.
3. Reveal all played House cards. The player with the highest-valued House takes the highest Cheque; second-highest House takes the second-highest Cheque, and so on.
4. Played House cards are discarded.
