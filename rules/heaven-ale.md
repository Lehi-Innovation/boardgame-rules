...
source_pdf: "heaven-ale-rules.pdf"
...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/heaven-ale-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Heaven%20%26%20Ale&game=heaven-ale)
<!-- verification:end -->
...
1. Place main board centrally. Place ducats and scoring discs as reserves.
2. Separate resource tiles by back (I and II). Place 1 resource tile (I-backed) face-up on each of 15 resource spaces.
3. Sort and place shed tiles in 5 piles by type.
4. Separate monk tiles by back (I and II). Shuffle I-monks; place stacks of 4 on center spaces. Handle II-monks based on player count (2p: remove all; 3p: stack of 4 on leftmost space; 4p: stacks of 4 on all spaces).
5. Place 1 monk tile face-up on each of 4 monk spaces. Place 1 scoring disc on each of 6 scoring disc spaces. Place barrels (large on small) on each barrel spot.
6. Each player takes: player board, 5 privilege cards, player figure, brewmaster (on starting spot), 1 of each 5 resource markers (on starting spots), 25 ducats.
7. Determine starting player. First player places figure on "First player starting space." Others place counterclockwise, taking immediate rewards (2 ducats, or 1 brewmaster step, or 2 resource marker steps).
...
### Final Scoring
1. Check your brewmaster's position to determine your **resource exchange rate** and **victory point multiplier**:
...
2. **Even out resource markers:** Use the exchange rate to move resource markers closer together (move other markers backward to advance the lowest marker forward). Also, spend 10 ducats to advance any marker 1 step.

3. **Calculate production score:** Find your LOWEST resource marker position. Multiply that number by your brewmaster's unlocked VP multiplier.

4. Add barrel points (4 per large, 2 per small). Add 1 VP per barrel if barrel privilege card is placed.

5. Add 1 VP if your figure is on the First Player starting space.
...
| Action Space | What You Do |
|-------------|-------------|
| Resource | Buy tile(s), place shady (1x cost) or sunny (2x cost) |
| Monk | Buy monk tile(s), same pricing as resources |
| Scoring Disc A | Activate all tiles of chosen fertility number |
| Scoring Disc B | Trigger monks of chosen type → activate adjacent tiles |
| Scoring Disc C | Activate all tiles of chosen resource color |
| Barrel | Claim achieved barrel goals |
