---
title: "Savernake Forest"
bgg_id: 369142
player_count: "2-4"
play_time: "30-45 min"
designer: "Ruben Monteiro"
source_pdf: "savernake-forest-rules.pdf"
...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Savernake%20Forest&game=savernake-forest)
<!-- verification:end -->
...
1. **Choose a Card**: Select one of the available face-up cards (road or animal).
2. **Place the Card**: Add the chosen card to your personal forest grid (maximum 4x4).
3. **Refill Display**: Replace the taken card with a new one from the appropriate deck.
...
| Helper Animal | Benefit |
|---------------|---------|
| Rooster | First player choice next turn |
| Armadillo | +1 storage capacity for one animal |
| Goat | +1 value for one food item |
