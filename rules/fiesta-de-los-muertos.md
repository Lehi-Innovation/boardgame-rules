...
source_pdf: "fiesta-de-los-muertos-rules.pdf"
...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Fiesta%20de%20los%20Muertos&game=fiesta-de-los-muertos)
<!-- verification:end -->
...
1. Each player takes a skull slate, a deduction slate, and a marker.
2. Shuffle the character cards and deal 1 face-down to each player (keep secret).
3. Each player secretly reads their character, writes the character name on the inside of their skull slate, and folds the top to hide it.
4. Place the bone tokens of memory in a central pool.
5. Prepare any constraint cards if using advanced rules.
...
| Core mechanic | Word association + deduction |
| Character cards | 120 + 10 customizable |
| Constraint cards | 12 (advanced variant) |
| Scoring | Cooperative, count correct matches |
| Age | 12+ |
