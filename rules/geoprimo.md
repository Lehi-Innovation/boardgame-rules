...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Geoprimo&game=geoprimo)
<!-- verification:end -->
...
- 1 puzzle map of the world (divided into continents)
- Continent pieces
- Landmark/sight cards (42 famous world landmarks)
- Chips (reward tokens)
- Die or spinner
