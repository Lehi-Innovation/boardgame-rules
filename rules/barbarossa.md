...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/barbarossa-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Barbarossa&game=barbarossa)
<!-- verification:end -->
...
- Jewel tile
- 6 Event tiles
- 4 Magicians (large pawns)
- 4 Magic Hats (medium cylinders -- scoring markers)
- 4 Elfstones (small cubes -- jewel markers)
- 4 Blocks of clay (plasticine)
- 12 Curse Tokens (black)
- 13 Arrows
- Pad of paper
- 1 Die
- Rule book and example sheet
...
- **First correct guess** on an object: guesser scores **5 points** (move Magic Hat forward 5 spaces).
- **Second correct guess** on an object: guesser scores **3 points**.
- An object may not receive more than 2 arrows.
- Wrong guesses incur no penalty.
...
- **-5 points** for each of your objects with no arrows in it.
- **-2 points** for each of your objects with only one arrow in it.

After final scoring, the player closest to the end space wins.

## Special Rules & Edge Cases

- The pieces of paper under the board are revealed at game end to verify all answers were truthful.
- If any player gave false letters or wrong answers, the rules state: "don't play with him again."
- You cannot exceed 13 Elfstones on the Jewel Scale.
- Objects must represent a single word (optional house rule: allow two-word riddles or phrases).
- Dragon spaces benefit all other players, not you.
...
### Resource Limits
- Max 13 Elfstones
- 3 Curse Tokens initially, up to 6 total per game
