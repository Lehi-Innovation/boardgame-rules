...
player_count: "3-5"
play_time: "45 min"
designer: "Paul Randles, Mike Selinker, Bruno Faidutti"
source_pdf: "key-largo-rules.pdf"
...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Key%20Largo&game=key-largo)
<!-- verification:end -->
...
2. Each player takes a boat, starting money, and starting divers.
3. Shuffle the treasure deck and place it near the wreck locations.
4. Set up the equipment shop, market, and tavern areas.
5. Determine the hurricane track (10-day countdown).

## Turn Structure

The game lasts 10 days. Each day has two action phases (morning and afternoon):

1. **Secret Selection:** All players simultaneously choose a location/action for the phase by selecting a card face-down.
2. **Reveal:** All players reveal their chosen locations simultaneously.
3. **Resolve:** Actions are resolved at each location. When multiple players choose the same location, interactions and competition occur.
...
|----------|--------|---------|
| Wreck | Dive | Draw treasure cards |
| Market | Sell | Convert treasures to cash |
| Shop | Buy | Acquire diving equipment |
| Tavern | Recruit | Hire more divers, hear rumors |
| Open Water | Dolphins | Guaranteed tourist income |

| Key Numbers | Value |
|-------------|-------|
| Players | 3-5 |
| Game length | 10 days (20 action phases) |
| Actions per phase | 1 (simultaneous selection) |
