...
source_pdf: "modern-art-rules.pdf"
...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/modern-art-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Modern%20Art&game=modern-art)
<!-- verification:end -->
...
- 1 game board (artist columns with 4 round rows for value tiles)
- 70 painting cards (5 artists: Manuel Carvalho 12, Sigrid Thaler 13, Daniel Melim 12, Ramon Martins 12, Rafael Silveira 12; plus auction type)
- 5 museum screens
- 1 hammer token (auctioneer marker)
- 132 money tokens (1k, 5k, 10k, 25k, 50k, 100k euros)
- 12 artist value tiles (10k, 20k, 30k)
...
- All bids in units of 1k euros.
- Cannot bid more than you have.
- Winner pays the auctioneer. If the auctioneer wins, they pay the bank instead.
- Winner places the painting face up in front of their screen.
...
- The 5th painting of any artist ends the round immediately and is NOT auctioned or owned by anyone.
- If the 5th painting is the second card of a Double Auction, two paintings go unsold.
- Players keep unplayed cards between rounds.
- A player who runs out of cards cannot auction but can still bid.
- If all players run out of cards before the 4th round ends naturally, the round ends and the final painting played is not auctioned.
- Paintings are never carried over between rounds; only cards in hand carry over.
