---
title: "EastFront: The War in Russia 1941-45"
bgg_id: 22143
player_count: "2"
play_time: "120-480 min"
designer: "Tom Dalgliesh, Craig Besinque"
source_pdf: "eastfront-the-war-in-russia-1941-45-rules.pdf"
...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20EastFront%3A%20The%20War%20in%20Russia%201941-45&game=eastfront-the-war-in-russia-1941-45)
<!-- verification:end -->
...
- 2 large game maps (22.5" x 34" each, combining to 45" x 34") covering Eastern Europe, the Balkans, Finland, and Russia to the Trans-Volga
- Wooden block units (representing armies, corps, and other formations for both sides)
- Unit stickers (applied to blocks showing unit type, strength steps, and nationality)
- Production and reinforcement charts
- Turn record track
- Dice
...
### Combat Resolution
- Units fire in order of their combat class (elite units fire first).
- Each step rolls one die; hits are scored on rolls equal to or less than the unit's combat value.
- Terrain modifiers affect combat (rivers, cities, forests provide defensive benefits).
- Weather affects combat effectiveness (winter favors the Soviets; summer favors the Germans).
...
- **Campaign game:** The side controlling more victory-point cities at the end of the game wins.
- **Shorter scenarios:** Specific territorial objectives must be achieved within the time frame.
- **Sudden death:** Capturing certain key cities (Moscow, Stalingrad, Berlin) may trigger immediate victory in some scenarios.

## Special Rules & Edge Cases

- The fog of war (hidden blocks) is the central mechanic. Players cannot inspect opponent blocks.
- Weather changes seasonally and dramatically affects gameplay (mud seasons halt offensives; winter favors Soviet operations).
- The Axis player typically has the initiative early (1941-1942) but must achieve decisive results before Soviet production overwhelms them.
- Soviet units start weaker but receive massive reinforcements as the war progresses.
- Finnish, Romanian, Hungarian, and Italian allies are represented but have restrictions on their operations.
- Rail lines are crucial for supply and redeployment. Destroying or repairing rail lines is a key strategic consideration.
- The game can be combined with WestFront and MedFront for a full European theater experience.
