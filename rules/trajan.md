...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Trajan&game=trajan)
<!-- verification:end -->
...
1. Each player receives a mat, leader, 15 tokens, 2 discs, Arch of Trajan, and 12 action markers (placed 2 per tray in the action circle).
2. Place demand tiles face-down, randomly removing 3. Distribute forum tiles to provinces and board spaces.
3. Fill construction district with tiles. Place time marker based on player count.
4. Stack senate discs in player order. Deal 3 commodity cards and 1 bonus tile per player.
5. Each player selects 3 Trajan tiles (different categories) for slots II, IV, VI on their mat.
...
### Step 3: Perform One Action (Optional)
...
| Action # | Area | Options |
|---|---|---|
| 1 | Seaport | Draw cards, play cards, ship goods |
| 2 | Forum | Take 1 forum tile |
| 3 | Military | Recruit, move leader, deploy troops |
| 4 | Trajan | Take Trajan tile for mat |
| 5 | Senate | Advance disc for VP |
| 6 | Construction | Recruit workers, deploy to sites |
...
**Demand Penalties:** 1 unmet = -4 | 2 unmet = -9 | 3 unmet = -15
