...
---
<!-- verification:begin -->
> ❗ **Known errors** — an audit found inaccuracies in this summary that could mislead players: SOURCE_MISMATCH: extracted text is Evolution: Flight expansion (North Star Games) not Evo by Philippe Keyaerts. Until it is re-written, prefer the full rulebook text linked below.
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/evo-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Evo&game=evo)
<!-- verification:end -->
...
- 2 double-sided game boards (different sides for different player counts)
- 1 Climate Wheel
- 1 Biology Lab (mutation auction display)
- 5 clan markers
- 5 dinosaur boards (player mats tracking mutations)
- 48 normal gene tokens
- 8 unique gene tokens
- 1 cloth bag
- 88 MP tokens (Mutation Points)
- 40 dinosaurs (8 per player in 5 colors)
- 15 event cards
- 13 climate tokens (including 1 meteorite)
- 1 combat die
- 1 rulebook
...
### Gene Types (Normal)
- **Legs:** Increase movement range (+1 per pair, base 2)
- **Horns:** Improve combat success on attack and defense
- **Thermoregulation:** Survive hotter climates
- **Fur:** Survive colder climates
- **Eggs:** Place more new dinosaurs during Birth phase
- **Alchemical Vials:** Provide bonus MP

### Gene Types (Unique)
- **Bony Plates:** Defensive combat advantage
- **Flippers:** Allow movement across water areas
- **Wings:** Allow movement to non-adjacent areas (flight)
- **Regeneration:** Recover eliminated dinosaurs
- **Sixth Sense:** Preview upcoming climate changes
- And others with various special abilities
...
### Mutation Points (MP)
- Earned primarily during the Survival Phase (1 MP per surviving dinosaur per round)
- Can also be earned from alchemical vial genes and event cards
- Spent during the Mutations Phase to bid on genes
...
- The fewer dinosaurs you have, the earlier you act each round (initiative advantage), creating an interesting tension between having many dinosaurs (more MP from survival) and fewer dinosaurs (better initiative).
- A maximum bid of 6 MP is unbeatable in the auction -- no other player can outbid it.
- Only one dinosaur may occupy each area (unless a special ability allows otherwise).
- Dinosaurs cannot move through or into water areas without the Flippers gene.
- If a player's last dinosaur is eliminated, they are not necessarily out -- they can still bid on genes and may re-enter the board during the Birth phase if they have adjacent positions from events.
- The meteorite always appears in the last 3 rounds, so the game lasts 9 to 11 rounds.
- Combat is not mandatory; you can choose not to enter an occupied area.
