...
player_count: "2-4"
play_time: "45-60 min"
designer: "Ragnar Brothers"
source_pdf: "mare-balticum-rules.pdf"
...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Mare%20Balticum&game=mare-balticum)
<!-- verification:end -->
...
- Game board (Baltic Sea map with fishing zones and ports)
- Fishing boat tokens (multiple per player)
- Fish tokens (5 types)
- Port storage areas
- Action cards or dice
- Score track
...
- Types and quantities of stored fish
- Set collection bonuses for diverse catches
- Port majority bonuses

The player with the most points wins.

## Special Rules & Edge Cases

- Fish zones are depleted as fish are caught; timing your catches is important.
- Different fish types have different values.
- Weather or event cards may affect movement or fishing in certain rounds.
- Port capacity may be limited.
