...
source_pdf: "before-the-wind-rules.pdf"
...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Before%20the%20Wind&game=before-the-wind)
<!-- verification:end -->
...
1. **Card Display Phase**: A row of Action cards is laid out face-up for selection.
2. **Action Selection/Bidding Phase**: Players take turns selecting or bidding on Action cards. Each card offers one of three actions: take goods, store goods in warehouse, or load goods onto ships.
3. **Action Resolution Phase**: Players perform the actions on their selected cards.
4. **Ship Departure Phase**: Fully loaded ships depart, scoring points. New ships may arrive.
5. **Cleanup Phase**: Discard used cards, draw new cards, pass Starting Player token.
...
| Action | Effect |
|---|---|
| Take Goods | Acquire goods cards |
| Store Goods | Place goods in warehouse |
| Load Ships | Transfer goods to ships for points |

| Phase | Activity |
|---|---|
| Display | Reveal Action cards |
| Selection/Bid | Choose or bid on cards |
| Resolution | Perform chosen actions |
| Departure | Ships with full cargo score |
