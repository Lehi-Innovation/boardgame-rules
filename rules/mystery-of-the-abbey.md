...
source_pdf: "mystery-of-the-abbey-rules.pdf"
...
<!-- verification:begin -->
> ❗ **Known errors** — an audit found inaccuracies in this summary that could mislead players: Correct revelation worth +4 pts in summary but source says +2; "most suspect cards at game end: Bonus" is invented with no source support. Until it is re-written, prefer the full rulebook text linked below.
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/mystery-of-the-abbey-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Mystery%20of%20the%20Abbey&game=mystery-of-the-abbey)
<!-- verification:end -->
...
- 1 board (Templars' Abbey map)
- 6 monk miniatures (1 per player)
- 6 deduction notebooks
- 1 pad of 50 suspect sheets
- 90 illustrated cards (24 Suspect cards, Library books, Scriptorium books, Event cards, Crypt cards, Mass cards)
- 3 wooden monk dice
- 1 Mass bell
...
- **Mass**: Triggered by the Mass cards. All monks must return to the Chapel. The bell is passed after each Mass.
- **Event cards**: Drawn during gameplay with various effects (movement bonuses, forced card exchanges, etc.).
- **Vow of Silence**: Some cards or effects prevent questioning.
- Players may lie only when specifically allowed by certain card effects.
- The dice determine random monk interactions (confessional visits, etc.).
