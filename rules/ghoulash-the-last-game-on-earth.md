---
title: "Ghoulash: The Last Game on Earth"
bgg_id: 2402
player_count: "2"
play_time: "30 min"
designer: "Jon Richmond"
source_pdf: "ghoulash-the-last-game-on-earth-rules.pdf"
...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Ghoulash%3A%20The%20Last%20Game%20on%20Earth&game=ghoulash-the-last-game-on-earth)
<!-- verification:end -->


## Overview

Ghoulash: The Last Game on Earth is a two-player pen-and-paper strategy game where each player acts as the other's game master. Using specially designed game charts, players hide ghouls, holes, debris, and first-aid kits on their Obstacle Grid while navigating through the opponent's Movement Grid. No dice, cards, spinners, or movable pieces are used -- the entire game is played on paper with pencils. Players take turns describing their movement through the grid while their opponent reveals what hazards they encounter. The goal is to destroy all eight of your opponent's ghouls before suffering 12 wounds.

## Components

- Game Book with removable game charts (enough for 16 games)
- Each chart has two grids: Obstacle Grid and Movement Grid
- Pencils (2)

## Setup

1. Each player takes a game chart and a pencil.
2. Players sit facing each other, keeping their charts hidden from the opponent.
3. Each player places (marks) the following items on their Obstacle Grid:
   - 8 Ghouls (each with a designated Weak Spot)
   - Holes
   - Debris
   - First-Aid Kits
4. Placement follows the scenario's rules for the number and arrangement of obstacles.
...
- **Empty space:** Continue your turn or end it.
- **Hole:** You fall in and lose your next turn.
- **Debris:** You suffer 1 wound.
- **First-Aid Kit:** You heal wounds (reduces wound count).
- **Ghoul:** A fight begins.

### 3. Ghoul Combat (if applicable)
When you encounter a Ghoul, you must try to hit its Weak Spot:
- Declare which part of the Ghoul you attack (the Weak Spot location varies).
- **Hit the Weak Spot:** The Ghoul is destroyed. Mark it on both grids.
- **Miss the Weak Spot:** You suffer 1 wound. The Ghoul remains.
...
| Hole | Lose next turn |
| Debris | 1 wound |
| First-Aid Kit | Heal wounds |
| Ghoul | Fight (hit weak spot = destroy, miss = 1 wound) |
...
| Wounds to die | 12 |
| Players | 2 |
| Components needed | Paper + pencils |
