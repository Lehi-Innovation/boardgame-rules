...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Ice%20Cream&game=ice-cream)
<!-- verification:end -->
...
2. Distribute ice cream balls on the board as directed.
3. Deal 6 cards to each player (for 2–4 players).
4. Each player places their cards in a face-down pile in front of them.
5. Turn the top 2 cards face up beside the pile — these are the player's "open cards."
6. Place cherries nearby.

## Turn Structure

On your turn:
1. **Roll the die** — The number shown is how many spaces you may move ice cream balls.
2. **Move ice cream balls** — Move balls of your choice clockwise around the board, distributing the die value among multiple balls if desired.
3. **Check for matches** — If you have created a stack of 3 balls matching the exact color order of one of your open cards, discard that card.
4. **Cherry option** — If 2 balls match the bottom 2 of an open card, place a cherry on top to lock the cone.
...
| Component | Count |
|-----------|-------|
| Ice cream balls | 18 (6 per color) |
| Colors | 3 (green, yellow, red) |
| Cherries | 5 |
| Cards per player | 6 |
| Open cards | 2 at a time |

| Action | Rule |
|--------|------|
| Move balls | Clockwise, split die roll |
| Match 3-stack | Discard matching open card |
| Cherry lock | 2-ball partial match |
| Win | Discard all cards first |
