...
---
<!-- verification:begin -->
> ❗ **Known errors** — an audit found inaccuracies in this summary that could mislead players: Brussels-board actions invented while real ones missing, invented Compass resolution step, hallucinated "Canal-related scoring", wrong first-player rule, contradicted auction tie/refund rules, shield majorities omitted. Until it is re-written, prefer the full rulebook text linked below.
>
> 📄 [Full rulebook text](https://jonnyallred.github.io/boardgame-rules/extracted/bruxelles-1893-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Bruxelles%201893&game=bruxelles-1893)
<!-- verification:end -->
