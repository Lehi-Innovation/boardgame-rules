...
player_count: "2-4"
play_time: "30-45 min"
designer: "Henry Russell"
source_pdf: "rare-species-rules.pdf"
...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Rare%20Species&game=rare-species)
<!-- verification:end -->
...
1. Place the 12 female cards face-down on the 12 yellow squares in the middle of the board.
2. Place the 12 male cards face-up on the 12 green squares that surround the female cards.
3. Each player selects a playing piece and places it on a corner of the board on the circular brown track.
4. Determine the starting player (youngest player goes first).
...
2. **Move:** Move your playing piece clockwise around the board the number of spaces shown on the die.
3. **Resolve Space:** Follow the instructions of the space landed on, which may allow you to look at or collect animal cards.
4. **Match Attempt:** If you have the opportunity, attempt to match a male card with its corresponding female card by turning over a face-down female card.
...
| Action | When |
|---|---|
| Roll and Move | Every turn |
| Peek at Female Card | When landing on appropriate space |
| Claim Match | When you can pair male + female of same species |
| Score a Pair | Successfully matched pair = 1 point |
