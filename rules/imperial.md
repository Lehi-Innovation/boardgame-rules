...
- 1 Gameboard (Europe map with nations, sea/land regions, rondel, scoring track, tax chart)
- 54 Bond cards (6 nations, denominations 2/4/6/9/12/16/20/25/30 million)
- Flags (15 per nation)
- 6 Nation flag cards
- 1 Investor card
- Bank notes
- Armies and Fleets (wooden, in 6 nation colors)
- 30 Factories (18 unbuilt + 12 starting)
- 18 Octagonal nation markers
- 1 Turn marker
...
- Switzerland is neutral; cannot be entered.
- 15 brown land regions outside the nations; only armies may enter.
- Player funds and nation treasuries strictly separate.
- Government control passes to the player with the highest total bond investment in that nation.
- A nation with no bonds has no government; its turn is skipped.
- Hostile armies (upright) block production and factory building; friendly foreign armies (lying down) do not.
