---
title: "Concilium Urbis"
bgg_id: 416817
player_count: "1-6"
designer: "Daniel Fuster"
source_pdf: "concilium-urbis-rules.pdf"
...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Concilium%20Urbis&game=concilium-urbis)
<!-- verification:end -->
...
- **Build:** Place building tiles in your city during the construction phase.
- **Produce:** Generate resources from existing buildings.
- **Vote:** Use voting tokens to influence which laws take effect.
- **Trade:** Exchange resources with other players (if applicable).
...
- Laws voted into effect change the scoring landscape for all players, creating a dynamic strategic environment.
- The voting mechanism means players must consider not just their own city but the political landscape.
- Solo mode provides an automated opponent for single-player games.
- Building placement follows adjacency and zoning rules on the city board.
