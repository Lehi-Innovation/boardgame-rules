---
title: "Micro Armour: The Game - WWII"
bgg_id: 17379
player_count: "2+"
play_time: "120 min"
designer: "GHQ"
...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Micro%20Armour%3A%20The%20Game%20-%20WWII&game=micro-armour-the-game-wwii)
<!-- verification:end -->
...
1. Set up the tabletop terrain according to a scenario.
2. Each player selects a force from the appropriate national TOE.
3. Deploy forces according to scenario setup instructions.
...
2. **Movement Phase:** Move units according to terrain and vehicle capabilities.
3. **Fire Phase:** Units fire at enemy targets. Resolve hits and damage.
4. **Morale Phase:** Check morale for units that took casualties.
5. **Rally Phase:** Attempt to rally suppressed or broken units.
