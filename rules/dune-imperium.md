...
---
<!-- verification:begin -->
> ❗ **Known errors** — an audit found inaccuracies in this summary that could mislead players: Tiebreaker is garrisoned troops not troops in supply; Reveal turn does not allow troop deployment (invented mechanic). Until it is re-written, prefer the full rulebook text linked below.
>
...
- Game board
- 8 Leaders (2 per House)
- Per player: 3 Agents, 10-card starting deck, 16 cubes (troops), 2 discs, 1 Score marker, 1 Councilor token, 3 Control markers, 1 Combat marker
- 67 Imperium Deck cards, 40 Intrigue cards, 18 Conflict cards (I/II/III)
- 24 Reserve cards (Arrakis Liaison, The Spice Must Flow, Foldspace)
- Solari, spice, and water tokens
- First Player marker, Mentat, 4 Alliance tokens
- House Hagal cards (for solo/2-player)
...
| Icon | Board Spaces |
|---|---|
| Emperor | Conspire (costs 4 spice), Wealth |
| Spacing Guild | Heighliner (costs 6 spice), Foldspace |
| Bene Gesserit | Selective Breeding, Secrets |
| Fremen | Desert, Sietch Tabr (requires 2+ Fremen Influence) |
| Landsraad | High Council, Hall of Oratory, Mentat, Swordmaster, Rally Troops |
| City | Arrakeen, Carthag, Research Station |
| Spice Trade | Imperial Basin, Hagga Basin, The Great Flat |
...
- Faction Influence: 1 VP at 2 Influence, Alliance token VP at 4 Influence
- Control bonuses from winning specific Conflicts
- Certain Imperium cards with VP
- Intrigue cards (Plot, Combat, Endgame types)

## Special Rules & Edge Cases

- **Mentat:** A freelance Agent any player can hire for one round by sending an Agent to the Mentat space. Returns at end of round.
- **Swordmaster:** Your 3rd Agent, gained by sending an Agent to the Swordmaster board space.
- **Alliance tokens:** First player to reach 4 Influence with a Faction gains the Alliance. If another player surpasses them, they take the Alliance token (and its VP).
- **Control markers:** Winning certain Conflicts gives control of Arrakeen (1 Solari bonus), Carthag (1 Solari), or Imperial Basin (1 spice) whenever any player uses that space.
- **Faction Influence:** Gaining 2 = 1 VP; losing below 2 = lose that VP. Reaching 4 = bonus shown on track.
- **Intrigue cards:** Plot (play anytime on your turn), Combat (only during Combat phase), Endgame (only at game end).
- **Sietch Tabr** requires 2+ Fremen Influence to send an Agent there.
...
**Agent Turn:** Play 1 card -> Send Agent -> Gain effects
**Reveal Turn:** Reveal remaining hand -> Gain Persuasion/Swords -> Deploy troops -> Buy cards
