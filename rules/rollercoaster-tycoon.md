...
play_time: "45-60 min"
designer: "Rob Daviau"
source_pdf: "rollercoaster-tycoon-rules.pdf"
...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20RollerCoaster%20Tycoon&game=rollercoaster-tycoon)
<!-- verification:end -->
...
- Game board depicting a theme park with attraction spaces
- Guest pawns (neutral figures representing park visitors)
- Player money tokens/bills
- Attraction cards or tiles
- Dice
- Player markers
- Score track or guest point tokens
...
- Guests are neutral and can benefit any player; the key is strategic movement to direct them to your rides.
- Players cannot move guests backward on the track.
- Some attractions are more valuable (generate more guest points) but cost more to purchase.
- Money management is important; overspending on one attraction may leave you unable to compete for later, better ones.
- Malfunctioning rides do not generate guest points until repaired.
