...
source_pdf: "the-quest-for-el-dorado-rules.pdf"
...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/the-quest-for-el-dorado-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20The%20Quest%20for%20El%20Dorado&game=the-quest-for-el-dorado)
<!-- verification:end -->
...
**Restrictions:**
- Cannot move onto mountains or occupied spaces.
- Cannot split a card's power between two pieces (2-player variant).
...
- **Scientist:** Draw 1 card, optionally remove 1 card from hand
- **Travel Log:** Draw 2 cards, remove up to 2 from hand (then remove itself)
- **Native:** Move onto any adjacent space ignoring requirements (not onto occupied/mountain spaces)
...
- At end of turn, keep experts or items in hand for next turn (optional) or discard them.
- When draw pile is empty, shuffle discard pile to form new draw pile, then draw.
- You may choose not to move and only buy.
- Unspent power or coins are lost at end of turn.
