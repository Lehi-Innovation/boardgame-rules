...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Hot%20Spot&game=hot-spot)
<!-- verification:end -->
...
1. Place the map with Chiros and its 14 crustal platforms.
2. The Ziegler player sets up defensive forces on the 14 crustal platforms.
3. The Technocrat player prepares their raiding force at designated entry points.
4. Reference combat tables are placed nearby.

## Turn Structure

Each game turn:
1. **Technocrat Movement Phase** — The attacker moves forces.
2. **Combat Phase** — Resolve engagements between opposing forces.
3. **Ziegler Response Phase** — The defender moves and counterattacks.
4. **Environmental Phase** — Resolve any environmental hazards from the molten surface.
...
| Player | Role |
|--------|------|
| Ziegler Corporation | Defend 14 crustal platforms |
| Technocrats | Raid and capture platforms |
