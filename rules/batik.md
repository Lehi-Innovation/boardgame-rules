...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Batik&game=batik)
<!-- verification:end -->
...
1. Stand the frame upright on a flat surface.
2. Each player takes one set of 9 wooden pieces.
3. Determine who goes first.

## Turn Structure

Players alternate turns. On each turn:
1. Choose one of your remaining pieces.
2. Drop it into the top of the frame.
3. The piece slides down and rests where gravity takes it.
...
### Turn Sequence
1. Choose a piece from your supply
2. Drop it into the frame
3. If it sticks out the top, you lose the round (forfeit that piece)
4. Continue until one player runs out of pieces
