...
source_pdf: "innovation-rules.pdf"
...
1. Split cards into 10 supply piles by age, arranged in a clock pattern.
2. Randomly set aside 1 card (without looking) from each of ages 1-9 as normal Achievements (9 total). Place them in the center.
3. Place the 5 Special Achievements nearby.
4. Each player draws 2 age-1 cards. Simultaneously, each player chooses 1 to meld (place face up as their first card) and keeps the other as their starting hand.
5. The player whose melded card is closest to A alphabetically goes first.
6. First player (or first 2 in 4-player) takes only 1 action on their first turn.
...
| Players | Achievements to Win |
|---------|-------------------|
| 2 (or 4-player teams) | 6 |
| 3 | 5 |
| 4 | 4 |
...
| Achievement Age | Min Score Required |
|----------------|-------------------|
| 1 | 5 |
| 2 | 10 |
| 3 | 15 |
