...
source_pdf: "judge-dredd-rules.pdf"
...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/judge-dredd-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Judge%20Dredd&game=judge-dredd)
<!-- verification:end -->
...
- Action Cards may be played before dice rolls to modify results.
- Any player may play Action Cards on any Judge (even themselves).
