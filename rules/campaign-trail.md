...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Campaign%20Trail&game=campaign-trail)
<!-- verification:end -->
...
- Game board (map of the United States)
- Candidate pawns
- Voter tokens in player colors
- Campaign cards (deck per player)
- Money tokens
- State cards with electoral vote values
- Debate cards
- Solo mode deck (50 cards)
- Rules booklet
...
- The game supports 1-6 players, including a dedicated solo mode with a 50-card solo deck.
- Each card provides a choice of 4 out of 6 actions, creating meaningful decisions each turn.
- Campaign Rallies require your candidate to be in the target state (use Travel to move there first).
- Advertising allows remote voter placement but costs money.
- The game is described as "remarkably unpolitical" -- it focuses on campaign strategy mechanics rather than real-world policy positions.
- Advanced solo mode adds additional depth and solo debates.
