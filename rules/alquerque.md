...
bgg_id: 11464
player_count: "2"
source_pdf: "alquerque-rules.pdf"
...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/alquerque-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Alquerque&game=alquerque)
<!-- verification:end -->
...
- 1 Alquerque board (5x5 grid with diagonal lines indicating allowed movement)
- 12 pieces per player (2 colors)
...
- The first player has only one place to move (the center position) but a choice of 3 pieces.
- You may choose not to capture, but risk being huffed.
- **Alternative version:** Allow backward movement; the winner is the last player with a piece on the board (elimination).
