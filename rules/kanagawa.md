...
- 72 Lesson cards (18 each in 4 colors: green/Trees, red/Characters, yellow/Buildings, blue/Animals)
- 19 Diploma tiles
- 3 Storm tokens (wild Season)
- 15 Brush pawns
- 1 School board
- 4 Starting tiles
- 1 Grand Master pawn
...
- **Landscape icons:** Enable painting specific landscapes on your Print.
- **Supplies:** Immediate effects (gain a Brush, take the Assistant pawn, keep a card between rounds).
- **Know-how:** Permanent new abilities.
...
- Must have a Brush pawn on a matching Landscape icon in your Studio.
- The Brush is moved from your Studio to the Lesson card on your Print.
- Cards in your Print form a continuous panoramic painting.

### Brush Management
- Brushes can be moved each round using Arrow icons on your Studio.
- Brushes on Prints are "locked" until moved back by an Arrow ability.
- You can gain new Brushes through Studio Supplies.
...
- **Diploma Harmony points**
- **End-of-game bonus icons** on Print cards (1 Harmony each)
- **Storm tokens:** Placed on Print cards to create the most beneficial season sequences.

The player with the most Harmony points wins. Tiebreak: most Lesson cards in Print.

## Special Rules & Edge Cases

- The back color of Lesson cards hints at the Main Subject on the Print side (green = Trees, red = Characters, yellow = Buildings, blue = Animals).
- You can always look at the backs of cards in the draw deck.
- Storm tokens act as wild Seasons -- place them at game end on Print cards to optimize season scoring.
- The Assistant pawn passes between players during a round; the Grand Master pawn only changes at round end.
- The keep-a-card ability (from certain Studio cards) lets you retain one Lesson card between rounds.
