...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/carpe-diem-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Carpe%20Diem&game=carpe-diem)
<!-- verification:end -->
...
1. Place game board centrally. Each player assembles a frame from 4 random parts, places a random building board inside (shovel pointing toward them), and covers 9 banderole spaces.
2. Prepare scoring cards by player count and place face-up on card spaces.
3. Each player places their meeple on an unoccupied semicircular space on the game board.
4. Place 4 light green tiles on each of the 7 large blueprint spaces (28 tiles total). Place 1 dark green tile on each of the 11 seal spaces.
5. Shuffle fountain cards into a face-down pile.
6. Starting player gets 8 VP; subsequent players get 9, 10, 11 VP (special: in 3-player, third player gets 13).
...
**Each Round:**
1. Move your meeple to one of the two opposite semicircular spaces (connected by black lines). You must move; you cannot stay.
2. Pick one building tile from the adjacent blueprint space.
3. Immediately place the tile in your district following building rules.
...
| Phase | Rounds | After |
|-------|--------|-------|
| 1 | 7 rounds | Scoring period 1 |
| 2 | 7 rounds | Scoring period 2 |
| 3 | 7 rounds | Scoring period 3 |
| 4 | 7 rounds | Scoring period 4 + final scoring |

| Dwelling | Reward |
|----------|--------|
| Merchant | Wares -> coins + 1 |
| Baker | 2 bread |
| Administrator | +2 banderole bar |
| Craftsman | Free dark green tile |
