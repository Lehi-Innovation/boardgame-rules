...
player_count: "2-6"
play_time: "45-90 min"
designer: "Patrick Treloar"
source_pdf: "rave-rules.pdf"
...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Rave&game=rave)
<!-- verification:end -->
...
2. Each player selects a playing piece and places it on the start space.
3. Each player receives 50 pounds in starting money.
4. Shuffle the Flyer cards and Vibe cards into separate decks.
5. Place Energy tablet tokens in a supply.
...
1. **Roll/Spin:** Determine movement.
2. **Move:** Move your piece along the board.
3. **Resolve Space:** Follow the instructions of the space landed on, which may involve:
   - Visiting a club to collect flyers
   - Drawing a Vibe card
   - Encountering police patrols
   - Purchasing energy tablets
4. **Attend a Rave (when ready):** Once you have 3 flyers, decide which rave to attend and purchase your ticket.
...
| Step | Action |
|---|---|
| 1 | Collect 3 flyers from clubs |
| 2 | Choose a rave and buy a ticket |
| 3 | Travel to meeting points |
| 4 | Attend the rave |
| 5 | Dance using energy tablets |
| 6 | Earn WOW Triptych sections |

**Win:** Collect all 3 WOW Triptych sections
