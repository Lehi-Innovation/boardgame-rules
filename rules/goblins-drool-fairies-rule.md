...
source_pdf: "goblins-drool-fairies-rule-rules.pdf"
...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/goblins-drool-fairies-rule-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Goblins%20Drool%2C%20Fairies%20Rule%21&game=goblins-drool-fairies-rule)
<!-- verification:end -->
...
1. All cards begin goblin-side-up in the deck.
2. Each player is dealt 1 random Goblin Star Card. Un-dealt Goblin Star Cards are set aside, out of the game.
3. Shuffle remaining cards and deal 3 more Goblin Cards to each player (starting left of dealer).
4. Each player now has 4 Goblins.
5. Deal 4 Fairies from the deck to the "Fairy Ring" in the center of the play area.
6. Set aside all remaining cards (out of the game).
7. Determine first player (youngest, rock-paper-scissors, or fastest to say "Goblins Drool, Fairies Rule!").
...
| Step | Action | Details |
|------|--------|---------|
| 1 | Add | Place 1 card from your hand into the Fairy Ring |
| 2 | Flip | Flip all rhyming cards in Ring (or ALL if Star Card) |
| 3 | Take | Take all cards matching your added card's Symbol |
