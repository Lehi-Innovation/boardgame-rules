...
source_pdf: "can-t-stop-rules.pdf"
...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/can-t-stop-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Can%27t%20Stop&game=can-t-stop)
<!-- verification:end -->
...
1. Each player chooses a color and takes all cubes of that color.
2. Set the 3 white cubes aside.
3. Roll two dice to determine who goes first (highest total; reroll ties).
...
### Rolling
1. Roll all 4 dice.
2. Combine them into **two pairs** (any arrangement you choose).
3. Each pair creates a sum (between 2 and 12).
4. Advance white cubes in those columns according to the placement rules.
...
**Turn Sequence:**
1. Take 3 white cubes
2. Roll 4 dice
3. Pair into two sums
4. Advance/place white cubes
5. Choose: Stop (keep progress) or Roll again (risk busting)
