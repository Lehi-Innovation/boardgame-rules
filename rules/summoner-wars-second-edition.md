...
source_pdf: "summoner-wars-second-edition-rules.pdf"
...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Summoner%20Wars%20%28Second%20Edition%29&game=summoner-wars-second-edition)
<!-- verification:end -->
...
1. Place the battlefield board between both players.
2. Each player selects a faction and takes its complete deck.
3. Separate your Summoner card and place it on your designated starting space.
4. Place starting units on their designated spaces as shown on the faction reference card.
5. Shuffle remaining unit and event cards to form your draw deck.
6. Draw 5 cards as your starting hand.
...
| Phase | Action | Limit |
|---|---|---|
| Draw | Draw to 5 cards | Once per turn |
| Summon | Play units, pay magic | Any number of units |
| Event | Play event card | 1 per turn |
| Move | Move units 0-2 spaces | Up to 3 units |
| Attack | Roll dice vs adjacent enemy | Up to 3 units |
| Build Magic | Place cards in magic pile | Up to 2 cards |
