...
player_count: "3-6"
play_time: "60 min"
source_pdf: "lifeboats-rules.pdf"
...
---
<!-- verification:begin -->
> ❗ **Known errors** — an audit found inaccuracies in this summary that could mislead players: SOURCE_MISMATCH: summary describes a different Lifeboats game (voting mechanics, sailors/officers, 3-island scoring); source is 2001 Jeff Siadek game with 6 named characters, Row/Mug/Change Seats actions, love/hate scoring; no overlap between summary and source mechanics. Until it is re-written, prefer the full rulebook text linked below.
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/lifeboats-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Lifeboats&game=lifeboats)
<!-- verification:end -->
