...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Gambit%207&game=gambit-7)
<!-- verification:end -->
...
- Question cards (with numerical trivia questions and answers)
- Answer pads/sheets
- Betting tokens
- Scoring track or pad
- Pencils

## Setup

1. Place the question cards in a draw pile.
2. Give each player an answer pad and pencil.
3. Give each player betting tokens.
4. Set all scores to 0.
5. Determine first player (or question reader).
...
### 6. Score Points
- The player whose answer is closest to the correct answer earns points.
- Players who correctly bet on the closest player earn points.
- Betting on yourself and being correct may earn bonus points.
...
- Bet on yourself if you think your answer is best
- Bet on an opponent who seems more knowledgeable
- Watch for answers that seem too precise or too wild
...
**Points per Round:**
- Points for having the closest answer
- Points for correctly betting on the closest player
