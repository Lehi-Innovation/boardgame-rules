...
source_pdf: "On the Dot - rules.pdf"
...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/on-the-dot-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20On%20the%20Dot&game=on-the-dot)
<!-- verification:end -->
...
- 64 pattern cards
- 16 transparent squares (4 sets of 4 squares, each set with a matching color border)
...
- **Rotate** any square in any direction.
- **Flip** any square over.
- **Overlap** all four squares to form a single square matching the target pattern.

## Scoring / Victory Conditions

- **Competitive:** First player to collect 5 pattern cards wins.
- **Solitaire:** Beat your own record for cards solved within the time limit.

## Special Rules & Edge Cases

- You must always use **all four** transparent squares to duplicate the pattern.
- You may rotate and flip the squares in any direction.
- All four squares must end up overlapping to form a **single square** (no offset stacking).
- You may **not** cover or block the face-up pattern card with your squares during play.
- If a player calls "On the Dot!" but their solution is incorrect, they are **out for that round** and other players continue.
