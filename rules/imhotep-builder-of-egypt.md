---
title: "Imhotep: Builder of Egypt"
bgg_id: 191862
player_count: "2-4"
play_time: "40 min"
designer: "Phil Walker-Harding"
source_pdf: "imhotep-builder-of-egypt-rules.pdf"
...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/imhotep-builder-of-egypt-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Imhotep%3A%20Builder%20of%20Egypt&game=imhotep-builder-of-egypt)
<!-- verification:end -->
...
- 120 Wooden blocks ("stones") — 30 each in black, white, brown, gray
- 5 Site boards (double-sided A/B)
- 1 Scoring track board
- 8 Ship tokens (various capacities: 1-, 2-, 3-, and 4-stone ships)
- 4 Supply sled tokens (1 per color)
- 21 Round cards (7 each for 2-, 3-, and 4-player games)
- 34 Market cards
...
### Round Start
- Flip the top round card to reveal which 4 ships are available this round.
- Place 4 new market cards face up on the Market board.
...
### End of Round
- Assess the Temple (each stone visible from above = 1 point).
- Return 4 ships to the pile.
- Discard remaining market cards from the Market board.
- Stones on site boards and supply sleds stay.
- New start player = the player to the left of whoever sailed the 4th ship.
...
- The ship must be loaded with at least its **minimum** number of stones (shown at the bow).
- The destination site must have an open dock (no other ship sailed there this round).
...
- 2 players: 1st = 10 pts, 2nd = 1 pt
- 3 players: 1st = 12 pts, 2nd = 6 pts, 3rd = 1 pt
- 4 players: 1st = 15 pts, 2nd = 10 pts, 3rd = 5 pts, 4th = 1 pt
...
- You may sail a ship with no stones of your own color on it.
- Only 4 ships are available each round; 1 of 5 sites will always go unused.
- Supply sled maximum is 5 stones.
- Scoring track goes to 40; if you exceed 40, continue around and remember you have looped.
- Red market cards must be played immediately upon drawing.
- Blue market cards replace your regular action (not in addition to it).
