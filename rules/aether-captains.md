---
title: "Aether Captains"
bgg_id: 86003
player_count: "1"
play_time: "20-30 min"
designer: "Todd Sanders"
source_pdf: "aether-captains-rules.pdf"
...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/aether-captains-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Aether%20Captains&game=aether-captains)
<!-- verification:end -->
...
Each turn:
1. **Roll dice**: Roll your available dice pool.
2. **Allocate dice**: Assign dice to ship stations (weapons, movement, repairs, etc.).
3. **Resolve actions**: Execute each station's action based on allocated dice.
4. **Enemy phase**: Enemies attack and advance.
5. **Check conditions**: Determine if game continues.
