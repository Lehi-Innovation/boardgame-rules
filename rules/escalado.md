...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Escalado&game=escalado)
<!-- verification:end -->
...
- 1 long green fabric race track
- 5-6 model racehorses (different colors)
- 1 mechanical hand crank (vibration mechanism)
- Betting chips or money tokens
- Track rails/barriers
- Starting gate
- Finishing line markers
...
- **Ownership prize:** The owner of the winning horse receives prize money.
- **Place prizes:** Owners of horses finishing second and third also receive smaller prizes.
- **Betting payouts:** Players who bet on the winner (and possibly place finishers) collect winnings from the bookie based on the odds.
...
- **Place:** Bet on the horse to finish in the top 2 or 3.
...
- The track must be perfectly level for fair races; even slight tilts can favor certain lane positions.
- The crank operator should turn at a consistent speed to ensure fair vibration.
- Horses may occasionally get stuck or fall over -- re-position them and continue.
- The bookie role can rotate each race for fairness, or one player can serve as permanent bookie.
- Players may choose not to bet in any given race (but still earn ownership prizes).
- The vibration-based movement is inherently random -- no amount of strategy can control which horse wins.
- Some versions include obstacles or jumps on the track for added excitement.
