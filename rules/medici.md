...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/medici-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Medici&game=medici)
<!-- verification:end -->
...
7. Shuffle the cards in use and form a face-down draw pile. Set removed cards aside unseen.
8. Randomly choose a starting player who takes the start player token.
