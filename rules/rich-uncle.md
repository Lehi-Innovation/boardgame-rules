...
play_time: "30-60 min"
designer: "Unknown"
source_pdf: "rich-uncle-rules.pdf"
...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Rich%20Uncle&game=rich-uncle)
<!-- verification:end -->
...
- 2 Dice (one dark for tens, one light for units)
- Daily Bugle newspaper cards (market quotation cards)
- Stock certificates
- Play money (starting at $10,000 per player)
- Player tokens
