...
player_count: "2-4"
play_time: "45 min"
designer: "Richard Darst"
source_pdf: "jumbulaya-rules.pdf"
...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Jumbulaya&game=jumbulaya)
<!-- verification:end -->
...
1. Fill the three middle columns of the board with random letter tiles face-up (27 tiles total).
2. Each player draws 5 random letter tiles and places them on their tile rack.
3. Each player takes their set of colored ownership markers.
4. Select a random first player.

## Turn Structure

On your turn, do one of the following:
1. **Form a word** on one row of the board, then claim that row.
2. **Pass** or **discard tiles** (mix discarded tiles back into the draw pile and draw replacements).
...
| Board rows | 9 |
| Tiles in rack | 5 |
| Max tiles added per turn | 2 from rack |
| Jumbulaya length | 7-9 letters |
| Game-ending word length | 10 tiles |
