...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Dablot%20Prejjesne&game=dablot-prejjesne)
<!-- verification:end -->
...
- 1 game board: 6 x 7 grid with diagonal lines
- 30 Sami pieces: 1 King, 1 Prince, 28 Warriors
- 30 Landowner pieces: 1 Landowner, 1 Son, 28 Peasants
...
- There is no promotion of pieces (unlike checkers).
- All pieces move identically — the rank system only affects which pieces can be captured.
- The King/Landowner are the most powerful pieces and can capture anything.
- The Prince/Son cannot capture the opposing leader (King or Landowner).
- Warriors and Peasants can only capture equal or lower rank.
- Mandatory capture applies — you cannot choose not to capture if a capture is available.
- If multiple capture paths exist, the player freely chooses which to take.
...
1. King / Landowner (captures all)
2. Prince / Son (captures all except opposing leader)
3. Warriors / Peasants (captures only equal or lower rank)
