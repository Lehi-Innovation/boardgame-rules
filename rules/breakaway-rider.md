...
player_count: "2-6"
play_time: "45-60 min"
designer: "Tom Dalgliesh, Lance Gutteridge"
source_pdf: "breakaway-rider-rules.pdf"
...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Breakaway%20Rider&game=breakaway-rider)
<!-- verification:end -->
...
3. Designate one player as the starting race leader and give them the yellow jersey token.
4. Place minute chips in a central supply.

## Turn Structure

Each round:
1. Each player draws 1 card (7th card).
2. The race leader plays a pace card (plus any modifier cards).
3. Successive players play pace cards to try to match or beat the leader's pace.
4. Resolve who stays in the peloton, who falls behind, and who breaks away.
5. Award or transfer the yellow jersey if applicable.
...
| Card Type | Effect |
|---|---|
| Pace card (39-50) | Sets or matches race speed |
| Spurt | +2 to your pace |
| Headwind | -2 to target's pace |
| Mountain | Leader cannot be overtaken this round |
