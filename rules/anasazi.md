...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Anasazi&game=anasazi)
<!-- verification:end -->
...
1. Place mesa pieces on the board in the pattern shown in the rulebook.
2. Place tower tokens face-down on the pueblos marked on each mesa.
3. Shuffle mission cards and deal one secretly to each player. This card determines which color treasures the player is trying to collect.
4. Each player takes 7 camp tokens in their color.
5. In turn order, each player places 2 camp tokens between the mesas in the valley spaces.
...
1. **Place an expedition marker** in a valley space between mesas.
2. **Discover:** If your marker is the first to touch a particular mesa, you may secretly look at one tower on that mesa.
3. **Claim treasure:** If your expedition marker touches the line around a pueblo, you receive the treasure in that space. If there is a tower, it is revealed and placed on the corresponding color track.
...
| Phase | Action |
|-------|--------|
| Place | Put one camp token in a valley space |
| Peek | If first to touch a mesa, secretly view one tower |
| Claim | If touching a pueblo boundary, claim the treasure |
| End | All markers placed OR 4 towers of one color revealed |
| Score | Points for treasures matching secret mission color |
