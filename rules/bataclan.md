...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Bataclan&game=bataclan)
<!-- verification:end -->
...
1. Distribute all 28 dice evenly among players.
2. Place the velvet dish in the center of the table.
...
2. Place it on top of the tower (or start the tower if it's the first turn).
3. The die face showing upward must be equal to or higher than the face showing on the previous die.
4. If the tower falls, collect all the fallen dice and add them to your supply.
...
- Values range from 1-6 on each die.

### On Collapse
- Take ALL fallen dice
- Next player starts a new tower

### Win Condition
- First player with no dice remaining wins
