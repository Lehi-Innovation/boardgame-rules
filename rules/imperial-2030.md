...
designer: "Mac Gerdts"
source_pdf: "imperial-2030-rules.pdf"
...
- 1 Gameboard with 6 nations, sea/land regions, rondel, scoring track, tax chart
- 54 Bond cards (6 nations, denominations 2/4/6/9/12/16/20/25/30 million)
- 90 Flags (15 per nation)
- 6 Nation flag cards
- 1 Investor card
- 130 Bank notes (1/2/5/10 million)
- 48 Armies (wooden, in 6 colors)
- 48 Fleets (wooden, in 6 colors)
- 24 Factories (12 brown armament facilities, 12 blue shipyards)
- 18 Octagonal nation markers (3 per nation)
- 1 Turn marker
...
### Rondel Movement
- First turn: place on any rondel space.
- Subsequent turns: move clockwise; first 3 spaces free. Each space beyond 3 costs **(1 + Power Factor)** million, paid from the nation's treasury.
- Maximum rondel move: 6 spaces. Cannot stay on same space.
...
**Final scoring:**
- For each bond a player holds: multiply the bond's **interest** (printed on the bond) by the owning nation's **Power Factor** (from scoring track).
- Add all bond values together.
- Add personal cash.
- Each million = 1 victory point.

**Tiebreaker:** Higher credit sum in the nation with the most power points.

## Special Rules & Edge Cases

- Player funds and nation treasuries are strictly separate.
- Players may donate personal cash to a nation's treasury but not the reverse.
- Players cannot trade bonds with each other.
- A nation without any bonds purchased has no government; its turn is skipped.
- Switzerland is neutral and cannot be entered.
- Hostile armies (standing upright) in a home province prevent factory building and production there.
- Friendly foreign armies (lying down) do not prevent anything.
- Power Factor increases as nations gain power points (read from scoring track).
