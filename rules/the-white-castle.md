...
player_count: "1-4"
play_time: "80 min"
designer: "Sheila Santos, Israel Cendrero"
source_pdf: "the-white-castle-rules.pdf"
...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20The%20White%20Castle&game=the-white-castle)
<!-- verification:end -->
...
2. Roll and sort the 9 action dice by value onto the three castle levels (lowest values on bottom level, highest on top).
3. Each player takes a player board, starting resources, courtiers, gardeners, and warriors.
4. Deal starting bonus cards.
5. Seed the castle levels with available action tiles and rewards.
6. Place markers on scoring tracks.
...
1. **Draft a die** from one of the three castle levels.
2. **Perform the associated action** for that level.
3. **Gain or pay resources** based on the die's value.
...
| Castle Level | Action | Key Resource |
|---|---|---|
| Level 1 (Bottom) | Place gardeners | Coins |
| Level 2 (Middle) | Deploy courtiers | Food |
| Level 3 (Top) | Train warriors | Iron |

**Die Value:** Lower = cheaper but weaker | Higher = stronger but costlier
