...
player_count: "2-6"
play_time: "30 min"
designer: "Cory Jones, Rob Heinsoo"
...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/epic-spell-wars-of-the-battle-wizards-duel-at-mt-skullzfyre-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Epic%20Spell%20Wars%20of%20the%20Battle%20Wizards%3A%20Duel%20at%20Mt.%20Skullzfyre&game=epic-spell-wars-of-the-battle-wizards-duel-at-mt-skullzfyre)
<!-- verification:end -->
...
- 8 Skull Life Counters
- 1 Mt. Skullzfyre standee

## Setup

1. Shuffle each deck separately (Source, Quality, Delivery).
2. Each player chooses a Hero to play.
3. Each Wizard starts with 20 Hit Points. Place a skull counter on the 20 space on your Hero card (or use dice to track). You can raise your HP with Dead Wizard cards, up to a maximum of 25.
4. Place the Treasure deck and the Dead Wizard deck near the play area.
5. Place Mt. Skullzfyre and the Last Wizard Standing tokens to the side.
...
- Source + Quality + Delivery (full three-component spell)
- Source + Delivery
- Source + Quality
- Quality + Delivery
- Any single component
- A Wild Card in the Delivery slot or no Delivery Component (initiative 0)
...
- **Arcane (purple):** Sophisticated magic splatters your foes while gaining you Treasures.
- **Dark (red):** Risk a touch of magic backlash to send your foes to their messy deaths.
- **Elemental (blue):** Blast your foes to kingdom come.
- **Primal (green):** Quick and tricky spells that often allow you to choose your victims.
- **Illusion (yellow):** The forces of nature can either heal you or deliver a slow death to your foes.
...
### Targets
- **Strongest/Weakest Foes:** The strongest foe is the foe with the most Hit Points. The weakest foe is the one with the fewest. If there is a tie, you choose who is stronger/weaker.
- **Stronger/Weaker Foes:** A stronger foe is any foe with more HP than you. A weaker foe is any foe with fewer HP. In between? Roll to determine.
- **Random Foes:** Starting with the person to your left, distribute snakes on a chart. Then roll a die to see who the victim is.
...
- **The Dead Wizard Deck:** When a Wizard is slain (or starts the second+ game dead), they immediately draw a card from the Dead Wizard Deck. Being dead is not enough to get a Wizard completely out of the action. At the start of each new round, if any dead Wizards are present, they draw Dead Wizard cards. If the Wizard takes a few rounds to kill another, they will see up to four Dead Wizard cards total. You may then play those each round.
- **Four Player Game Free Spell Resolution:** In a four-player game, if a player has already acted (played a spell), with an initiative of 18, you are the fastest of the three-component spells to resolve.
- **Fist of Nature:** A Primal Spell Component that does not match any of the glyphs in your Spell -- so it gets discarded -- but the card Mysterious Shudder's Arcane glyph becomes a component of your Source. It is placed into the Quality slot or above it.
- The player with only one Component will act first in the round. Then players with two, then three.
- Dead Wizards continue drawing Dead Wizard cards each round until only one wizard remains.
