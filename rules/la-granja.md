...
source_pdf: "la-granja-rules.pdf"
...
---
<!-- verification:begin -->
> ❗ **Known errors** — an audit found inaccuracies in this summary that could mislead players: Farm Phase steps wrong: "Take income" step omitted; "Choose donkey marker" misplaced from Transportation Phase to Farm Phase; invented "harvest goods" tiebreaker not in source. Until it is re-written, prefer the full rulebook text linked below.
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/la-granja-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20La%20Granja&game=la-granja)
<!-- verification:end -->
