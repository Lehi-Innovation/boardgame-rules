...
source_pdf: "dixit-journey-rules.pdf"
...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/dixit-journey-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Dixit%20Journey&game=dixit-journey)
<!-- verification:end -->
...
- 84 Dixit cards (oversized, illustrated)
- 1 game board with scoring track and numbered card slots
- 8 voting dials
- 8 wooden rabbit pawns (one per player color)
...
- **Storyteller:** Choose a card and craft a clue that is neither too obvious (everyone guesses) nor too obscure (no one guesses).
- **Other players:** Select the best decoy card from your hand to match the clue, then vote for the card you believe is the storyteller's.

## Scoring / Victory Conditions

**If some players (but not all) voted for the storyteller's card:**
- The storyteller scores **3 points**.
- Each player who found the storyteller's card scores **3 points**.
...
**Bonus points (always):**
- Each non-storyteller player scores **1 bonus point** for each vote their own submitted card received.
...
- **3-player variant:** Each player has **7 cards** in hand instead of 6. Non-storyteller players submit **2 cards** each instead of 1 (so 5 total cards are displayed). At end of turn, draw 2 cards instead of 1. Bonus point scoring: players still score 1 bonus point per vote on either of their cards (regardless of which card received the vote).
- **Clue flexibility:** Clues can be a single word, a phrase, a complete sentence, hummed music, a mime, an onomatopoeia, or a reference to a movie, song, book, proverb, etc.
- **Voting restriction:** Players can never vote for their own card.
- **Reshuffle:** When the draw pile is exhausted, shuffle the discard pile to form a new draw pile.
- **Compatibility:** Dixit Journey cards can be mixed with cards from any other Dixit edition or expansion.
