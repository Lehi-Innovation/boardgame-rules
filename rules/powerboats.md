...
source_pdf: "powerboats-rules.pdf"
...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/powerboats-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Powerboats&game=powerboats)
<!-- verification:end -->
...
- 1 start/finish tile
- 6 speedboats (player colors)
- 18 triangular dice (faces 1-2-3)
- 6 score markers
- 10 damage counters
- 5 buoys (numbered 0-3 plus finish)
- 4 lake border tiles
- 6 lake tiles (double-sided: dark blue/light blue)
...
- **Add or remove:** You may add 1 die from the stock OR remove 1 die to the stock OR keep the same number.
- **Re-roll:** Choose which of your existing dice to re-roll. Roll all selected dice plus any newly added die at once.
- Place all dice on your color area (they stay until your next turn).
...
- **Accelerate:** Add 1 die to increase speed.
- **Decelerate:** Remove 1 die to reduce speed.
- **Re-roll:** Re-roll any or all existing dice for new values (1, 2, or 3 each).
- **Turn:** Rotate boat 60 degrees before moving.
...
### Damage
- If land or a buoy blocks your path so you can't use your full dice total, you crash. Your boat stops at the last reachable water space.
- Damage counters received = remaining unused movement.
- Crashing removes ALL your dice (speed resets to zero).
- Collecting 4+ total damage counters sinks your boat for the current race.
- Between races: repair your boat but keep 1 damage counter. After race 2, you may start race 3 with up to 2 damage counters.
