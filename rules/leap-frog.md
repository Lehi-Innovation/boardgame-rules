...
play_time: "20 min"
designer: "Uncredited"
source_pdf: "leap-frog-rules.pdf"
...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Leap%20Frog&game=leap-frog)
<!-- verification:end -->
...
2. Each player places their 4 frogs on their starting spaces (typically one side of the board).
3. Determine starting player.

## Turn Structure

On your turn:
1. **Spin/Roll** (if applicable) to determine movement options.
2. **Move one frog** to an adjacent empty lily pad, OR
3. **Leap over** an adjacent frog (opponent's or your own) to land on the empty lily pad beyond.
4. Captured frogs are removed from the board.
...
**Turn Summary:**
1. Spin/Roll (if applicable)
2. Move or Leap one frog
3. Remove captured frogs
