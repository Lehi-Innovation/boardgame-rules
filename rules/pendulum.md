...
1. Place the game board (correct side for player count) centrally.
2. Place the council board nearby.
3. Place the 3 sand timers on matching-color action areas in the top-row gold circles.
4. Shuffle achievement cards; reveal the top one with the legendary achievement token.
5. Shuffle province cards; deal 4 face up to the display.
6. Each player takes their character's stratagem cards, player mat, 3 common workers, 2 grande workers, 4 VP tokens, starting resources, and starting province cards.
7. Place VP tokens on starting positions of the 4 victory tracks.
...
1. **Place workers** on open action spaces (top row when timer is up, bottom row when timer is down).
2. **Retrieve workers** from spaces that have been timed (the timer has flipped over them).
3. **Execute the action** of the space when retrieving a timed worker.

### Council Phase (Turn-Based)
After a set number of timer flips, the Council phase triggers:
1. All action stops.
2. Players may retrieve any remaining timed workers and resolve their actions.
3. Play council reward cards and resolve council voting.
4. Advance victory tracks based on council results.
...
| Timer Color | Duration | Action Type |
|-------------|----------|-------------|
...
| Victory Track | Measures |
|---------------|----------|
| Power | Military strength |
| Prestige | Cultural influence |
| Popularity | Public support |
| Legendary | Exceptional deeds |
...
|-------|------|-------------|
| Action Round | Real-time | Place/retrieve workers; execute actions when timers flip |
| Council | Turn-based | Vote, resolve council cards, advance tracks |

| Timer | Duration | Action Weight |
|-------|----------|---------------|
| Green | 45 sec | Light/Quick |
| Black | 2 min | Medium |
| Purple | 3 min | Heavy/Strategic |
