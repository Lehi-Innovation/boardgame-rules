...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Im%20M%C3%A4rchenwald&game=im-m-rchenwald)
<!-- verification:end -->
...
1. Shuffle the 49 forest cards.
2. Lay them face down in a 7x7 grid.
3. Each player places their token at the designated starting edge.
4. Set aside any special cards as directed by the rules.

## Turn Structure

On your turn:
1. **Move** your token to an adjacent card in the grid (orthogonally).
2. **Reveal** the card if it is face down.
3. **Resolve** the card's effect (encounter obstacle, find a clue, or discover the princess).
...
| Card Type | Effect |
|-----------|--------|
| Goblin | Obstacle — impedes progress |
| Witch | Challenge or setback |
| Crow | Blocks or redirects |
| Clear | Safe passage |
| Princess | Goal — rescue to win |

| Grid | 7 x 7 (49 cards total) |
