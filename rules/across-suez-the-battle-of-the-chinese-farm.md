---
title: "Across Suez: The Battle of the Chinese Farm"
bgg_id: 9577
player_count: "2"
play_time: "60-120 min"
designer: "Jim Dunnigan, Mark Herman"
source_pdf: "across-suez-the-battle-of-the-chinese-farm-rules.pdf"
...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Across%20Suez%3A%20The%20Battle%20of%20the%20Chinese%20Farm&game=across-suez-the-battle-of-the-chinese-farm)
<!-- verification:end -->
...
1. Unfold the map and place it between the two players.
2. Sort counters by nationality (Egyptian and Israeli).
3. Place units on their designated starting hexes as specified in the setup instructions.
4. The Israeli player sets up first, then the Egyptian player.
5. Determine first player (typically Israeli, as the attacker).

## Turn Structure

The game lasts 7 turns. Each turn follows the standard move-shoot sequence:

1. **First player movement phase:** The first player moves their units according to movement allowances and terrain costs.
2. **First player combat phase:** The first player resolves attacks using the differential Combat Results Table (CRT).
3. **Second player movement phase:** The second player moves their units.
4. **Second player combat phase:** The second player resolves attacks.
...
| Turn | Time | Special Rules |
|------|------|---------------|
| 1 | Night | Reduced movement, no artillery |
| 2-3 | Day | Normal rules |
| 4 | Night | Reduced movement, no artillery |
| 5-6 | Day | Normal rules |
| 7 | Night | Reduced movement, no artillery |
