---
title: "Dynasty League Baseball"
bgg_id: 7290
player_count: "1-2"
play_time: "60-120 min"
designer: "Michael Cieslinski"
source_pdf: "dynasty-league-baseball-rules.pdf"
...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/dynasty-league-baseball-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Dynasty%20League%20Baseball&game=dynasty-league-baseball)
<!-- verification:end -->
...
1. Each manager writes their lineup on a scoresheet, selecting a starting pitcher and batting order.
2. **Weather:** Home team manager rolls white and blue dice (generating 0-99) and consults the Weather chart for the region, month, and day/night status to determine temperature, sky, precipitation, and wind.
3. **Umpire Crews:** Assign a crew to each series; roll two dice to determine the home plate umpire.
4. Determine batting order and starting positions per normal baseball rules.

## Turn Structure

The game follows standard baseball innings. Each half-inning:

1. **Roll dice** (red, white, blue) to generate a 3-digit number (000-999).
2. **Check the appropriate card:**
   - Numbers 0-499: Check the hitter's card
   - Numbers 500-999: Check the pitcher's card
3. **Find the result** in the correct column (vs. Right or vs. Left, depending on pitcher/batter matchup).
4. **Resolve the play:** Results include types of outs (groundout, flyout, strikeout), hits (single, double, triple, home run), walks, and special results.
5. **Advance baserunners:** Results in parentheses on the card indicate automatic runner advancement. Optional advancement uses the Baserunner Advancement chart.
...
**Card Lookup:** 0-499 = Hitter card | 500-999 = Pitcher card

**Column:** vs. Right or vs. Left (based on pitcher/batter matchup)

**Endurance:** Numerical = starter | "Long" = 15 | "Short" = 7
