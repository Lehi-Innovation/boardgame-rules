...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20DDR-Reise&game=ddr-reise)
<!-- verification:end -->
...
1. Place the board showing the DDR map in the center.
2. Each player selects a pawn and chooses a home city.
3. Shuffle the city cards; deal 5 green location cards to each player (these are the cities they must visit).
4. Shuffle the encounter card deck and place it face-down.
5. Determine the starting player.

## Turn Structure

On your turn:
1. **Roll Dice:** Roll and move your pawn along connected routes.
2. **Visit Cities:** If you arrive at one of your destination cities, reveal the matching card.
3. **Random Encounter:** Draw an encounter card if required by the space or rules, and resolve the event.
4. **Return Home:** After visiting all 5 cities, head back to your home city.
