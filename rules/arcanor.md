...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Arcanor&game=arcanor)
<!-- verification:end -->
...
2. Each player places their 12 cylinders on the row closest to them: 6 cylinders on the row, with 6 more stacked on top of the first 6 (creating 6 stacks of 2 cylinders each).
3. Smaller cylinders sit on top of larger ones (Russian doll style).
...
1. **Move one cylinder** (or stack) according to the movement rules.
2. **Check for nesting:** Cylinders may stack on top of or inside larger cylinders.
3. **Check victory:** If a player has accumulated 12 points worth of cylinders on the opponent's home row, they win.
...
| Cylinder Size | Count per Player | Point Value |
|---------------|-----------------|-------------|
| Small | 3 | 4 points |
| Medium | 3 | 3 points |
| Large | 3 | 2 points |
| Extra-large | 3 | 1 point |
