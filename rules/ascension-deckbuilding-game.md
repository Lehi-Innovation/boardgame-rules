...
player_count: "1-4"
play_time: "30 min"
designer: "Justin Gary, Robert Dougherty, Brian Kibler"
source_pdf: "ascension-deckbuilding-game-rules.pdf"
...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/ascension-deckbuilding-game-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Ascension%3A%20Deckbuilding%20Game&game=ascension-deckbuilding-game)
<!-- verification:end -->
