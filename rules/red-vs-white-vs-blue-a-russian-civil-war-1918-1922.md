---
title: "Red vs White vs Blue: A Russian Civil War 1918-1922"
bgg_id: 187050
player_count: "2"
play_time: "120-180 min"
designer: "Unknown"
source_pdf: "red-vs-white-vs-blue-rules.pdf"
...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Red%20vs%20White%20vs%20Blue%3A%20A%20Russian%20Civil%20War%201918-1922&game=red-vs-white-vs-blue-a-russian-civil-war-1918-1922)
<!-- verification:end -->
...
2. Apply stickers to blocks if not already done.
3. One player takes the Red (Bolshevik) forces; the other takes the White and Blue forces.
4. Place starting units in their historical positions as indicated by the scenario setup.
5. Shuffle event/strategy cards and deal starting hands.
6. Determine first player per scenario rules.

## Turn Structure

Each game turn represents a period of the civil war and consists of:

1. **Card Play Phase:** Players simultaneously select and reveal strategy cards that determine initiative and available actions.
2. **Movement Phase:** The player with initiative moves their units first, followed by the opponent. Units move between regions along roads and rail lines.
3. **Battle Phase:** Resolve battles in contested regions. Blocks engage based on their combat values, rolling dice to inflict hits.
4. **Supply Phase:** Check supply lines for all units. Unsupplied units may be reduced or eliminated.
5. **Reinforcement Phase:** Place new units or reinforce existing ones using available reinforcement points.
...
| Phase | Action |
|---|---|
| Card Play | Select and reveal strategy cards |
| Movement | Move units between regions |
| Battle | Resolve combat in contested regions |
| Supply | Check supply lines |
| Reinforcement | Place/reinforce units |
