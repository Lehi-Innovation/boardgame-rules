...
bgg_id: 16620
player_count: "2-4"
source_pdf: "domination-rules.pdf"
...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/domination-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Domination&game=domination)
<!-- verification:end -->
...
- 1 plastic gameboard unit (circular with grid of holes)
- 52 plastic playing pieces (for 2 players: green and red, 18 of each color; for 3 players: 3 colors, 12 each; for 4 players: 4 colors, use individual set-up)
- 1 label sheet
- 1 colored instruction booklet
...
- Your own pieces go to your reserve (can be placed later)
- Opponent pieces are captured and removed from the game
...
- A pile's limit is 5 pieces. Excess pieces from the bottom are removed when a pile exceeds 5.
- You can only move a pile or piece if your color is on top.
- Moves are always in straight lines, horizontally or vertically. Never diagonally.
- When making a multiple move, you can jump over other piles and pieces.
- You may split a pile by taking only the top portion.
- Reserve pieces placement counts as your turn (no movement that turn).
