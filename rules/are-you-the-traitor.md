...
source_pdf: "are-you-the-traitor-rules.pdf"
...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/are-you-the-traitor-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Are%20You%20the%20Traitor%3F&game=are-you-the-traitor)
<!-- verification:end -->
...
1. Select role cards based on player count (the rules specify which roles to include at each count).
2. Shuffle the role cards and deal 1 face down to each player.
3. Players look at their own role secretly.

## Turn Structure

Each round is a single discussion phase followed by an accusation:

1. **Discussion:** All players talk openly, trying to figure out who has which role. Players may say anything -- truth, lies, or misdirection.
2. **Accusation:** At any time, a player may point at another player and make an accusation. The type of accusation depends on the accuser's suspicion.
...
| Role | Team | Goal |
|------|------|------|
| Good Wizard | Good | Receive the key |
| Evil Wizard | Evil | Receive the key |
| Traitor | Evil (hidden) | Appear good, help evil |
| Key-Holder | Good | Give key to Good Wizard |
| Guard | Good | Identify the Traitor |
