...
<!-- verification:begin -->
> ❗ **Known errors** — an audit found inaccuracies in this summary that could mislead players: Starting deck invents wound chips and omits 1 Crash Gem chip; multiplayer win condition wrong (lowest pile, not last survivor); Height Bonus draw mechanic entirely omitted. Until it is re-written, prefer the full rulebook text linked below.
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/puzzle-strike-bag-of-chips-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Puzzle%20Strike%3A%20Bag%20of%20Chips&game=puzzle-strike-bag-of-chips)
<!-- verification:end -->
