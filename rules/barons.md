...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Barons&game=barons)
<!-- verification:end -->
...
3. Set up the central card pool/market.

## Turn Structure

On each turn, a player:
1. Plays cards from their hand to perform actions.
2. Uses card functions to build structures and recruit followers.
3. Draws new cards.
