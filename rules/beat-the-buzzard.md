---
title: "Beat the Buzzard"
bgg_id: 699
player_count: "3-5"
play_time: "20 min"
designer: "Alex Randolph"
source_pdf: "beat-the-buzzard-rules.pdf"
...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/beat-the-buzzard-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Beat%20the%20Buzzard&game=beat-the-buzzard)
<!-- verification:end -->
...
1. Each player takes one complete set of cards numbered 1–15.
2. Shuffle the 15 prize cards (10 mice + 5 buzzards) and place them face-down in a central pile.
3. Determine a starting player or simply begin.

## Turn Structure

Each round follows this sequence:

1. **Reveal Prize Card**: Flip the top card from the prize pile. It shows either a positive mouse value or a negative buzzard value.
2. **Simultaneous Selection**: Each player secretly selects one card from their hand and places it face-down.
3. **Reveal Bids**: All players simultaneously reveal their chosen cards.
4. **Resolve Winner**:
...
5. **Discard Played Cards**: All played bid cards are removed from the game (each card can only be used once).
...
| Card Type | Values | Winner |
|-----------|--------|--------|
| Mouse (positive) | +1 to +10 | Highest unique bid |
| Buzzard (negative) | -1 to -5 | Lowest unique bid |

| Bid Cards | 1–15, one-time use each |
|-----------|------------------------|
| Tied bids | Cancel (skip those players) |
| Unclaimed prize | Carries to next round |
