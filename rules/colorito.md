...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/colorito-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Colorito&game=colorito)
<!-- verification:end -->
...
- 1 Colorito board (2 pads)
- 10 red pieces numbered 1 to 10
- 10 yellow pieces numbered 11 to 20
- 10 dark blue pieces numbered 1 to 10
- 10 light blue pieces numbered 11 to 20

## Setup

1. One player takes dark blue (1-10) and light blue (11-20) pieces; the other takes red (1-10) and yellow (11-20).
2. Place the board between players so each player has the arrows of their colors on their side.
3. Place pieces on the first two rows according to the numbers: red pieces start on blue-numbered spaces and vice versa.
...
- You cannot step solely on colored spaces (must also include white/numbered spaces).
- **Special situation:** If the only target spaces of a player not yet occupied by their correct pieces are occupied by opponent's pieces, that player is declared the winner.
- **"Just Colours" variant (easier):** Ignore the numbers entirely. Just get pieces onto the row with the matching color to win.
- **"Strict game" variant (harder):** Even in a Step-Jump, the Step must land on a space with the piece's own color or white before starting the Jump.
