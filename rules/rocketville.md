...
source_pdf: "rocketville-rules.pdf"
...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Rocketville&game=rocketville)
<!-- verification:end -->
...
- Game board depicting Rocketville with multiple districts
- Player rocket pieces (one per player)
- Vote tokens
- Endorsement cards
- Promise cards
- Robot helper tokens
- Campaign cards (hand management deck)
- District tiles or markers
- Score track
...
- Direct vote tokens earned
- Endorsement card bonuses
- Fulfilled promise bonuses
- Robot-related scoring

The player with the most votes becomes the Mayor of Rocketville and wins.

## Special Rules & Edge Cases

- Rockets can only move to adjacent districts; long-distance travel requires multiple turns.
- Some districts may be temporarily unavailable or contested.
- Promise cards that are unfulfilled by game end may result in vote penalties.
- Robots have specific types with different abilities; choosing which to recruit is a key strategic decision.
- Campaign card management is critical; running out of cards limits your options.
