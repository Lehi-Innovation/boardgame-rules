---
title: "Realm of the Jade Goddess"
bgg_id: 31410
player_count: "2-4"
play_time: "60-90 min"
...
1. Place the central row and column of tiles on the board (these start fully explored).
2. Each player places their jeep on the center space of the board.
3. Distribute starting gold and archaeologists to each player.
4. Shuffle the terrain tiles face-down as a draw pool.
...
1. **Move Jeep (optional):** Move your jeep along paths on the board:
...
2. **Explore:** If your jeep is adjacent to unexplored terrain, draw and place a tile:
...
3. **Place Archaeologists:** Place archaeologists on the newly explored or adjacent tiles:
...
| Action | Cost |
|---|---|
| Move Jeep (white line) | Free |
| Move Jeep (brown line) | Stops movement |
| Place 1 Archaeologist | Free |
| Place 2 Archaeologists | 1 gold |
| Place 3 Archaeologists | 2 gold |
