...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/mow-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Mow&game=mow)
<!-- verification:end -->
...
- Green packet: 48 cow cards (for 2-5 players), totaling 74 flies
- Yellow packet: 48 additional cow cards (for 6-10 players)
- 1 Arrow card (direction of play)
- Illustration cards
...
- **2-player variant**: Use 3 simultaneous herds in a star layout. Players alternate between herds. When you take a herd, start a new one in its place. When the deck empties and one herd is taken, the round ends (the other 2 herds are not scored).
- A farmer who cannot or chooses not to add a cow MUST take the entire herd.
