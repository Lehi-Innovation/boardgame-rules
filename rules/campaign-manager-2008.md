...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Campaign%20Manager%202008&game=campaign-manager-2008)
<!-- verification:end -->
...
- 45 Campaign Strategy cards per player (90 total)
- Battleground state cards
- Issue markers and Key Demographic markers
- Voter support tokens
...
- Gaining voter support in a state
- Shifting issue markers
- Placing Media Support cards (which remain in play until replaced)
...
- Place your markers on spaces currently occupied by opponent colors.
- Remove opponent tokens from the board.
- Replace opponent tokens on white (undecided) spots with your own markers.
...
### Victory
- **McCain** needs 115 additional electoral votes (beyond his safe states) to reach 270.
- **Obama** needs 113 additional electoral votes to reach 270.
- If both players reach exactly 269 votes, the game is a **draw**.

The first player to accumulate 270 or more electoral votes wins immediately.

## Special Rules & Edge Cases

- Players may only draw a card if their hand has fewer than 5 cards.
- When your deck runs out, reshuffle your discard pile to form a new deck.
- Media Support cards stay in play until replaced, unlike other cards which are discarded after use.
- Breaking News events are drawn whenever a new state enters play, adding unpredictability.
- The pre-game draft of 15 from 45 cards creates different strategic options each game.
- Each candidate's starting electoral position is asymmetric, reflecting the 2008 political landscape.
...
**Key Mechanics:**
- Draft 15 from 45 cards pre-game
- Gain voter support, shift issues, play Media Support
- Breaking News on new state entry
