...
source_pdf: "fast-food-franchise-rules.pdf"
...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Fast%20Food%20Franchise&game=fast-food-franchise)
<!-- verification:end -->
...
2. Each player selects a token and receives starting capital.
3. Place all franchise markers and advertising tokens nearby.
4. Shuffle relevant card decks.
5. Each player places their token on the Start square of the outer track.
...
|------|---------|
| Players | 2-4 |
| Board | Two-level (outer track + inner franchise grid) |
| Dice | 2 six-sided |
| Win condition | First to $1 million or last player standing |
| Franchise limit | 1 per city square |
| Key mechanic | Franchise chain building + advertising |
| Designer | Tom McMurchie |
