...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Byzanz&game=byzanz)
<!-- verification:end -->
...
- 96 goods cards (6 types of goods, with values from 1 to 4)
- Merchant cards (wild cards, worth 5 points when sold as a set of 3)
- Rules sheet
...
- Starting with the player who won the last auction, each player drafts one type of good and takes **all cards of that type** from the market.
...
- The **lowest 2 cards** in the set are discarded from the game.
- The **highest card** is kept face-down in a scoring pile.
- Merchant cards act as wilds and can substitute for any goods type.
...
- Cards serve dual purpose: they are both bidding currency and scoring resources, creating tension between spending and collecting.
- Merchant cards are wild and worth 5 points when sold as part of a set of 3.
- The number of auctions per round equals the number of players.
- Auction lot sizes decrease throughout each round (first lot is largest, last is smallest).
- Hand limit of 7 cards forces players to sell or discard.
- When bidding, all cards played as a bid are lost regardless of whether you win.
