...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/attack-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Attack%21&game=attack)
<!-- verification:end -->
...
3. Unused PP are **wasted** (cannot be saved).
4. Place new land units immediately in any owned region(s). Navy cards are placed in front of you (or in the centre if you control the sea).
