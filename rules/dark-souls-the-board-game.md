...
designer: "David Carl, Alex Hall, Mat Hart, Rich Loxam"
...
1. Place Bonfire tile; set Mini Boss and Main Boss tiles aside. Shuffle 6 exploration tiles, lay out 4 around the Bonfire with aligned doorways. Place Fog Gate on farthest tile.
2. Set Spark dial: 5 Sparks (1 player), 4 (2 players), 3 (3 players), 2 (4 players).
3. Choose Mini Boss; set aside its model, Health dial, data card, behaviour cards, treasure.
