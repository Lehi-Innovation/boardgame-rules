...
source_pdf: "icetowers-rules.pdf"
...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/icetowers-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20IceTowers&game=icetowers)
<!-- verification:end -->
...
1. Each player chooses a color. Set aside unused colors.
2. Randomly scatter all pieces across the tabletop.
3. Stand all pieces upright in place.
4. Players indicate readiness by touching (not picking up) a pyramid of their color.
5. As soon as all players show ready, the game begins.
...
| Piece Size | Pip Value | Can Cap |
|-----------|-----------|---------|
| Large (3-pip) | 3 | Only free-standing or other larges |
| Medium (2-pip) | 2 | Larges, mediums, and free-standing |
| Small (1-pip) | 1 | Anything (most versatile) |
