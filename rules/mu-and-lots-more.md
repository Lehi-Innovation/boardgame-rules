---
title: "Mu and Lots More"
bgg_id: 32928
player_count: "2-6"
play_time: "30-60 min"
designer: "Doris Matthaus, Frank Nestel"
source_pdf: "mu-and-lots-more-rules.pdf"
...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/mu-and-lots-more-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Mu%20and%20Lots%20More&game=mu-and-lots-more)
<!-- verification:end -->
...
- 60 cards in 5 suits (numbered 0-11 per suit)
- Scoring tokens/pad
...
- The 60-card deck with 5 suits enables all four games without modification.
- Each game has detailed rules in the rulebook; this summary covers the core concepts.
- All four games are trick-taking at their core but each adds a significant twist that changes strategy.
