...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Mertwig%27s%20Maze&game=mertwig-s-maze)
<!-- verification:end -->
...
1. Choose a scenario card that determines the maze layout and objectives.
2. Place the board and set up counters according to the scenario.
3. Each player selects a character and places it at the maze entrance.
4. Shuffle and deal play cards as specified.

## Turn Structure

On your turn:
1. **Move:** Roll dice and move your character through the maze.
2. **Encounter:** Resolve any encounters (monsters, traps, treasures) at your location.
3. **Combat:** Fight monsters using dice and play cards.
4. **Collect:** Gather treasures and items.
