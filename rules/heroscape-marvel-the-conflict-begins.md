---
title: "Heroscape Marvel: The Conflict Begins"
bgg_id: 24703
player_count: "2"
play_time: "30-60 min"
designer: "Craig Van Ness, Rob Daviau, Stephen Baker"
source_pdf: "heroscape-marvel-the-conflict-begins-rules.pdf"
...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/heroscape-marvel-the-conflict-begins-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Heroscape%20Marvel%3A%20The%20Conflict%20Begins&game=heroscape-marvel-the-conflict-begins)
<!-- verification:end -->
...
### Basic Game
1. Build the battlefield from the quick-start scenario or choose from the Battlefield & Game Scenarios section.
2. Each player chooses an Army Card and takes the corresponding figure.
3. Place figures on starting zones as indicated.
4. Place Order Markers nearby.

### Master Game
1. **Build your battlefield:** Choose a scenario or create your own from the terrain tiles.
2. **Gather and place your army:** Draft armies using one of three methods:
...
3. Place figures in starting zones.

## Turn Structure

The game is played in rounds. Each round:

1. **Place Order Markers:** Each player has Order Markers numbered 1, 2, 3 plus an "X" (decoy). Place markers face-down on Army Cards to secretly plan which units act each turn. Players place simultaneously.
2. **Roll for Initiative:** Each player rolls the d20. Highest goes first. Reroll ties.
3. **Take Turns:** Players alternate taking 3 turns each per round. Usually each player takes 3 turns.
4. **Move the Round Marker** after all turns.

### On Your Turn
1. **Reveal your Order Marker** for that turn number (1st turn = reveal "1" markers, etc.).
2. **Action 1: Move Figure(s)** on your chosen Army Card (optional).
3. **Action 2: Attack with Figure(s)** on that Army Card (optional).
...
| Range | Max spaces for ranged attack |
| Attack | Number of attack dice rolled |
| Defense | Number of defense dice rolled |
| Life | Wounds to destroy the figure |
| Points | Army drafting cost |

| Turn Step | Action |
|-----------|--------|
| 1 | Reveal Order Marker |
| 2 | Move figures on chosen Army Card |
| 3 | Attack with figures on chosen Army Card |
