...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Wingspan&game=wingspan)
<!-- verification:end -->
...
1. Shuffle bird deck; place 3 face-up in the bird tray.
2. Place food tokens and egg miniatures in supply.
3. Toss 5 food dice into the birdfeeder tower.
4. Choose goal board side (Green = competitive scoring; Blue = personal targets).
5. Randomly place 4 end-of-round goal tiles on the board.
6. Each player receives: 1 player mat, 8 action cubes, 2 bonus cards, 5 bird cards, 5 food tokens.
7. Players keep up to 5 bird cards, discarding 1 food token per bird kept. Choose 1 bonus card to keep.
...
1. Score end-of-round goal (place 1 cube on goal board).
2. Remove bird cards from tray; refill.
3. Reroll all dice remaining in birdfeeder.
...
| Source | VP |
|---|---|
| Bird card face values | Printed VP per card |
| Bonus cards | Per card's condition |
| End-of-round goals | Per goal board |
| Eggs on birds | 1 VP per egg |
| Food cached on birds | 1 VP per food token |
| Tucked cards under birds | 1 VP per card |
...
| Action | Habitat | Benefit |
|---|---|---|
| Play Bird | Any (matching bird type) | Add bird to engine |
| Gain Food | Forest | Take food from birdfeeder |
| Lay Eggs | Grassland | Produce eggs on birds |
| Draw Cards | Wetland | Draw bird cards |
