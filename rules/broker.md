...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Broker&game=broker)
<!-- verification:end -->
...
1. Place the game board with stock price tracks in the center.
2. Set all company stock prices at their starting values.
3. Distribute starting cash equally to all players.
4. Place stock certificates in a supply.
5. Determine starting player.

## Turn Structure

On each turn, a player:
1. May buy or sell stocks at current prices.
2. Plays cards or rolls dice to influence stock prices.
3. Stock prices are adjusted according to the market effects.
...
| Action | Effect |
|---|---|
| Buy stock | Pay current price, receive shares |
| Sell stock | Receive current price, return shares |
| Manipulate market | Adjust stock prices up or down |
