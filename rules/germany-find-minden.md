---
title: "Germany: Find Minden"
bgg_id: 28436
player_count: "2-6"
play_time: "45 min"
designer: "Günter Burkhardt"
source_pdf: "germany-find-minden-rules.pdf"
...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Germany%3A%20Find%20Minden&game=germany-find-minden)
<!-- verification:end -->
...
- 1 large game board (map of Germany without place names, divided into zones)
- Location cards (describing cities, landmarks, sights)
- Scoring tokens or markers
- Player pieces
...
- **Small zone (precise):** Worth more points if correct, but harder to get right.
- **Large zone (general):** Worth fewer points, but a safer bet.
...
- Confident guesses on small zones earn high points
- Safe guesses on large zones earn modest points
- Wrong guesses earn nothing
