...
source_pdf: "runebound-rules.pdf"
...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Runebound&game=runebound)
<!-- verification:end -->
...
- 1 Game board depicting the realm of Terrinoth
- 6 Hero cards with matching plastic figures
- Adventure cards (quest, combat, exploration, and social encounters)
- Asset cards (weapons, armor, and items)
- Skill cards (abilities for heroes)
- Class cards
- Scenario cards and story tokens
- Combat tokens (double-sided with various symbols)
- Gold tokens
- Life tokens, miscast tokens, stun tokens, success tokens
- Terrain dice
- Hero playmats
- Adventure gems (placed on map locations)
...
- Defeating the main villain of the scenario
- Collecting a successful combination of quest objectives
- Being the first to complete the scenario's specific goal

The game is competitive by default -- the first player to fulfill the scenario's victory condition wins.

## Special Rules & Edge Cases

- **Two Acts**: The game is split into Act I and Act II, each lasting 12 rounds. Act II introduces more powerful enemies and advances the scenario's story.
- **Knocked Out**: If a hero loses all health, they are knocked out and must spend their next turn recovering, losing gold and adventure progress.
- **Terrain Dice**: Different terrain types (forests, hills, mountains, plains, water) require matching die faces. Roads are easier to traverse.
- **Fast Travel**: Some settlements allow heroes to move quickly between distant locations.
- **Skill Cards**: These serve as both combat modifiers and special abilities. Managing your hand is critical.
