...
player_count: "2-7"
play_time: "180 min"
designer: "Vincent Tsao"
source_pdf: "junta-rules.pdf"
...
---
<!-- verification:begin -->
> ❗ **Known errors** — an audit found inaccuracies in this summary that could mislead players: Political phase order wrong: source has Assign Offices (phase 2) before Development Aid (phase 3); summary reverses them, puts Offices at phase 4; phase 1 (draw cards) and phase 5 (choose location) omitted entirely. Until it is re-written, prefer the full rulebook text linked below.
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/junta-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Junta&game=junta)
<!-- verification:end -->
...
1. **Accept Development Aid:** Presidente draws development aid cards.
2. **Budget Allocation:** Presidente proposes how to distribute the money among offices.
3. **Vote on Budget:** Players vote to accept or reject the proposed budget.
4. **Assign Offices:** Players receive government positions.
5. **Bank Deposits:** Players secretly deposit money into Swiss bank accounts.
6. **Assassination Attempts:** Players may attempt to assassinate other players.
7. **Return from Exile:** Exiled players may return.
8. **Coup d'Etat:** Any player may call a coup.
9. **Coup Consequences:** Resolve the military coup.
...
| Phase | Key Action |
|-------|-----------|
| Budget | Presidente proposes distribution |
| Vote | Accept/reject budget (majority rules) |
| Assassination | Play assassin + guess target location |
| Bank Deposit | Hide location, deposit secretly |
| Coup | Deploy forces, resolve battles |

| Key Numbers | Value |
|-------------|-------|
| Ideal player count | 7 |
| Game includes rules for | 2-7 players |
| Assassination success | Varies by card type |
