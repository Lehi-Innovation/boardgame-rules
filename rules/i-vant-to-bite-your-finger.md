---
title: "I Vant to Bite Your Finger"
bgg_id: 14346
player_count: "2-4"
play_time: "15 min"
designer: "Uncredited"
...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20I%20Vant%20to%20Bite%20Your%20Finger&game=i-vant-to-bite-your-finger)
<!-- verification:end -->
...
1. Place the game board flat on the table with Dracula and his clock at the end of the path.
2. Each player selects a token and places it at the start of the graveyard path.
3. Ensure Dracula's cloak is closed (reset the mechanism if needed).
4. Determine who goes first (youngest player or by agreement).

## Turn Structure

On your turn:
1. **Choose how many spaces to move** — Move your token forward any number of circles (1 or more).
2. **Advance the clock** — Move the clock hand forward by the same number of clicks as spaces moved.
3. **Check Dracula** — If Dracula's cloak opens (triggered by the clock mechanism), you must put your finger in his mouth.
...
| Action | Effect |
|--------|--------|
| Move forward | Advance 1+ spaces along graveyard path |
| Click clock | 1 click per space moved |
| Dracula wakes | Must put finger in mouth for bite |

| Game Facts | Details |
|-----------|---------|
| Path length | 14 red circles |
| Players | 2–4 |
| Age range | 4+ |
| Year published | 1979 |
