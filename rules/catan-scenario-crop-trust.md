...
- The seed vault requires cooperative investment from all players.
- Crop storage records track each player's contributions.
- The game uses a fixed starting setup for the first game; variable setup rules are provided for subsequent games.
- All Catan base game rules apply except where modified by this scenario.
...
**Win condition:** First to 10 VP (if crops are preserved)
**Lose condition:** All players lose if critical crops are lost
