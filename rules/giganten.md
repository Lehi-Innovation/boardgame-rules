...
player_count: "2"
play_time: "30-45 min"
designer: "Herbert Pinthus"
source_pdf: "giganten-rules.pdf"
...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Giganten&game=giganten)
<!-- verification:end -->
...
- 1 game board (hex grid with land, water, and swamp terrain)
- 46 dinosaur stand-up pieces (23 per player), with rank/strength numbers printed on one side
- Egg pieces (hidden among each player's army)
- Terrain tiles (large edition: 4 modular board sections)
...
- **Land dinosaurs:** Move on land and swamp hexes.
- **Water dinosaurs:** Move in water hexes.
- **Amphibious dinosaurs:** Move on both land and water.
- **Flying dinosaurs (pterodactyls):** Can move over any terrain.

### 2. Resolve Combat (if applicable)
If your piece moves into a hex occupied by an opposing piece, combat occurs:
- Both players reveal their pieces' strength values.
- The piece with the higher strength value in the current terrain type wins.
- The losing piece is removed from the game.
- If strength values are equal, both pieces are removed.
...
- **On land:** Compare land strength values.
- **In water:** Compare water strength values.
- **In swamp:** Some editions treat swamp as land; others have special rules.
...
- Large land predators (high land strength)
- Marine reptiles / plesiosaurs (high water strength)
- Pterodactyls (flying, moderate strength)
- Smaller dinosaurs (scouts with low strength but mobility)
- Eggs (no combat ability, must be protected)
...
### Terrain Effects
- **Lakes:** Impassable to land dinosaurs; only water creatures and flyers can enter.
- **Swamp:** Accessible to land creatures (in most editions), treated as water in high-water variants.
- **Land:** Standard movement for land dinosaurs.
...
|------|-------|
| Players | 2 |
| Pieces per player | 23 |
| Eggs per player | 1 |
| Movement | 1 hex per turn |
| Board type | Hex grid with terrain |
