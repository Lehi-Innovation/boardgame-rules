...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/hotel-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Hotel&game=hotel)
<!-- verification:end -->
...
1. Assemble hotel pieces and place the board centrally.
2. Position the bank and town hall on designated spaces.
3. Distribute starting money to each player (amount varies by player count).
4. Each player selects a car and places it on the start space.
5. Players roll to determine turn order.

## Turn Structure

On your turn:
1. Roll the number die and move your car clockwise that many spaces.
2. If you land on an occupied space, move to the next empty space.
3. Take the action corresponding to the space you landed on.
4. Special actions when passing the Bank or Town Hall.
...
| Colored Die Result | Building Effect |
|-------------------|----------------|
| Red circle | Cannot build |
| Green circle | Build at listed price |
| "H" | Build at half price |
| "2" | Build at double price (optional) |

| Action Trigger | What Happens |
|---------------|--------------|
| Land on money-stack | May buy adjacent land |
| Land on metal-beam | May build improvements |
| Pass Town Hall | May buy one entrance |
| Land on entrance | Pay rent (roll for stay length) |
| Pass Bank | Collect $2,000 |
