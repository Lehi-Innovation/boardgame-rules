...
source_pdf: "ticket-to-ride-europe-rules.pdf"
...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Ticket%20to%20Ride%3A%20Europe&game=ticket-to-ride-europe)
<!-- verification:end -->
...
2. Shuffle train car cards; deal 4 to each player. Place 5 face-up next to the deck.
3. Each player takes 45 train cars and 3 stations in their color.
4. Deal each player 1 long route ticket and 3 regular tickets. Players must keep at least 2 tickets total (may keep all).
5. Place scoring markers at 0.
...
| Action | Details |
|---|---|
| Draw Cards | Take 2 (or 1 locomotive from display) |
| Claim Route | Play matching cards = route length |
| Draw Tickets | Take 3, keep at least 1 |
| Build Station | Pay 1/2/3 cards for 1st/2nd/3rd station |
