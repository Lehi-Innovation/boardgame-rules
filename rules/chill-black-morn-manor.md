...
- Full-color board in 48 moveable sections (modular tiles)
- Rules folder
- 96 cards
- 6 pawns
- 70 playing pieces
- 2 ten-sided dice
- 10 Master cards (each depicting a different creature)
...
- The manor layout changes every game due to modular board sections, providing high replay value.
- Ten different Masters (creatures) provide variety, each with unique abilities and vulnerabilities.
- Players may become corrupted or turned into Minions during the game if certain events occur.
- The game is based on the Chill horror role-playing game setting by Pacesetter.
- Combat resolution uses the two ten-sided dice for percentile rolls.
- The Minion player has hidden information about the Master's abilities, creating an asymmetric gameplay dynamic.
- The game supports solo play through to 8 players, with more Envoys in larger groups.
