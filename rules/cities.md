...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/cities-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Cities&game=cities)
<!-- verification:end -->
...
- 1 game board
- 100 building pieces (25 each in red, blue, green, and yellow)
- 48 feature tiles
- 32 city tiles
- 32 worker pawns and 12 achievement rings (8 + 3 each in 4 player colors)
- 4 player aid cards
- 32 scoring cards
- 1 cloth bag
- 1 star token
- 4 starting tiles (with colorless back)
- 4 scoring tokens (1 in 4 player colors)
...
- **Row A (Scoring Cards):** Draw 4 scoring cards; place 3 face-up and 1 face-down.
- **Row B (City Tiles):** Draw 4 city tiles; place 3 face-up and 1 face-down.
- **Row C (Feature Tiles):** Draw 6 feature tiles; place 5 face-up and 1 face-down.
- **Row D (Building Pieces):** Pull pieces from the bag, placing 1 in each of the first 10 squares (not on question mark spaces).
...
- Blue background feature tiles go on water spaces
- Green background feature tiles go on park spaces
- Grey background feature tiles go on building spaces with no building pieces
...
**Achievement rules:**
- "Adjacent" means orthogonal, not diagonal
- An "area" means a group of orthogonally connected spaces
- All number requirements are minimums, not exact (unless stated)
- A special feature tile counts as an empty city space of any color for achievements
- If you claim an achievement but later no longer meet its requirements, you keep it
...
- Face-down items: Players may not look at face-down items until chosen. When chosen, they are turned face-up and taken.
- **2-Player Variant:** Play 4 rounds (or 7 rounds for a longer game with a 3x5 neighborhood). Each player uses 8 workers and must place 2 per row.
- The same spaces/pieces may contribute to multiple scoring cards.
- Items that cannot be legally placed are removed from the game, not kept.
