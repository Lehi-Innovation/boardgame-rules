...
player_count: "2"
play_time: "25 min"
designer: "Jason Venter"
source_pdf: "court-of-the-medici-rules.pdf"
...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/court-of-the-medici-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Court%20of%20the%20Medici&game=court-of-the-medici)
<!-- verification:end -->
...
1. Each card represents a noble. Each card contains: Rank (1-5), Title (indicating nobility level), Crest (one of 4 house colors), and Text (special abilities).
2. Sort cards by value: ranks between 2 and 10, as well as 2 Ladies-in-Waiting (Rank 1), 2 Ministers (Rank 4), 2 Jesters (Rank 3, wild), and 10 courtiers.
3. Choose either House Gonzaga or House Della Rovere for each player.
4. Shuffle all the cards in your house together and make a deck from each pile.
5. Take a card off the top of your deck and place it face up in the middle of the play area as a starting card.
6. Deal 7 cards face-down as your starting hand.

## Turn Structure

On your turn, you must play a card. Choose among the following ways to play:

1. **Send a Noble to Court** -- Place a card on the table in front of you.
2. **Form an Alliance** -- Place a card on top of or next to cards already in play to create an alliance (a group of same-colored nobles).
3. **Conspiracy** -- Place a card on top of any card or stack of cards to change the controlling allegiance.
4. **Plan for the Future** -- Place a card face-down on the bottom of your deck.
...
| Action | Description |
|--------|------------|
| Send to Court | Play a card face-up |
| Alliance | Group same-colored nobles together |
| Conspiracy | Use 2+ nobles to displace an Inner Circle member |
| Plan for Future | Place card face-down on bottom of deck |
