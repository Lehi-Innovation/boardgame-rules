---
title: "Bunny Bunny Moose Moose"
bgg_id: 59149
player_count: "3-6"
play_time: "20 min"
designer: "Vlaada Chvatil"
source_pdf: "bunny-bunny-moose-moose-rules.pdf"
...
---
<!-- verification:begin -->
> ❗ **Known errors** — an audit found inaccuracies in this summary that could mislead players: Source is a CGE web-page scrape with no rules; all gameplay/setup/scoring content is unsupported by it. Until it is re-written, prefer the full rulebook text linked below.
>
> 📄 [Full rulebook text](https://jonnyallred.github.io/boardgame-rules/extracted/bunny-bunny-moose-moose-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Bunny%20Bunny%20Moose%20Moose&game=bunny-bunny-moose-moose)
<!-- verification:end -->
...
**Moose Antlers:**
- Two hands at temples with thumbs touching head and fingers pointing up (wide antlers) or down (compact antlers).

**Rabbit Ears:**
- Two fingers on each hand held on top of the head (straight ears) or to the sides (floppy ears).

**Tongue:**
- Players may optionally stick out their tongue. Sticking out the tongue **reverses** your animal identity -- moose antlers with tongue out count as a rabbit, and rabbit ears with tongue out count as a moose.

**Bush:**
- Any hand position that is neither clear ears nor clear antlers is a "bush" and scores no points.
...
- Trail cards shift as figures move beyond boundaries, keeping all figures on the path.
- The narrator cannot score from their own gestures -- they score only through their bet.
- Cards are read "as if looking in a mirror" -- the left/right orientation on scoring cards is reversed relative to the player.
- A player's tongue position reverses their animal identity for all scoring purposes.
- If a player's hand position is ambiguous (neither clear ears nor antlers), they are a "bush" and score nothing.
- The poem must be read slowly enough for the narrator to draw and place one card per line.
- Hunter cards drawn before the first complete reading of the poem do not trigger "Bam!" -- they are placed like normal scoring cards.

## Player Reference

**Gesture Quick Reference:**
- Moose: Hands at temples, fingers spread up or down
- Rabbit: Two fingers on each hand, on top of head or to sides
- Tongue out: Reverses your animal (moose becomes rabbit, rabbit becomes moose)
- Neither clear gesture: "Bush" -- no score, both figures move back 1
