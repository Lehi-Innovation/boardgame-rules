...
---
<!-- verification:begin -->
> ❗ **Known errors** — an audit found inaccuracies in this summary that could mislead players: Source is a publisher marketing/product page with no rulebook content; needs correct rulebook. Until it is re-written, prefer the full rulebook text linked below.
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/bunny-bunny-moose-moose-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Bunny%20Bunny%20Moose%20Moose&game=bunny-bunny-moose-moose)
<!-- verification:end -->
