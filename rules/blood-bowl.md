...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/blood-bowl-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Blood%20Bowl&game=blood-bowl)
<!-- verification:end -->
...
- 1 Game Board (pitch with grid squares, End Zones, and wide zones)
- 2 Dugouts (with Turn Track, Re-roll Track, Score Track, Reserves, KO'd, and Dead/Injured boxes)
- Plastic player figures for two teams
- Team cards (showing player statistics)
- Special Block dice (with 6 results)
- Standard dice (D6, D8)
- Scatter template and Range ruler
- Turn counters, Score counters, Re-roll counters
- Ball token
...
- Equal STR: 1 die
- One player stronger: 2 dice, stronger player chooses
- One player more than twice as strong: 3 dice, stronger player chooses
...
- Beat AV: roll on Injury Table
- **2-7 Stunned:** Player placed face-down; turned face-up at end of their team's next turn
- **8-9 KO'd:** Removed to KO'd box; roll 4+ at next kick-off to return
...
### Re-rolls
- **Team Re-rolls:** May re-roll any dice result (not Armour/Injury/Casualty) during your turn. Cannot re-roll a die more than once.
- **Player Re-rolls:** From skills; cannot be combined with team re-roll on same roll.
