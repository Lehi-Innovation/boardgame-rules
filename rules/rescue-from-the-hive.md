...
designer: "Unknown"
source_pdf: "rescue-from-the-hive-rules.pdf"
...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Rescue%20from%20the%20Hive&game=rescue-from-the-hive)
<!-- verification:end -->
...
- Die-cut counters (Space Marines, Znon defenders, hostage markers)
- Darter space ships (up to 6)
- Scout units
- Engineer units
- Two-person lancer units
- Rules booklet
- Dice

## Setup

1. Place the spacecraft map in the center of the table.
2. One player takes the Terran forces (Space Marines); the other takes the Znon forces.
3. **Terran Force Selection:** The Terran player spends a specified number of points to purchase their forces: scouts, engineers, two-person lancer units, and up to 6 Darter space ships.
4. **Znon Force Selection:** The Znon player spends points to set up defenses within the spacecraft.
5. Place hostage markers in the designated location within the ship.
6. Set up the hyperdrive countdown timer.

## Turn Structure

Each turn consists of:

1. **Terran Phase:** The Terran player moves units, searches rooms, and initiates combat with Znon defenders.
2. **Znon Phase:** The Znon player moves defenders, triggers traps, and attempts to delay the Marines.
3. **Hyperdrive Check:** Advance the hyperdrive timer. If it reaches its maximum before the hostages are rescued, the Znons escape and win.
4. **Rescue Check:** If the Marines reach the hostages and can evacuate them, the Terrans win.
...
| Unit Type | Role |
|---|---|
| Scouts | Search rooms, detect hidden enemies |
| Engineers | Breach doors, bypass security |
| Lancers | Primary combat units (2-person teams) |
| Darters | Space ships for fire support and evacuation |
