---
title: "Fight in the Skies"
bgg_id: 6638
player_count: "2-12"
play_time: "60-120 min"
designer: "Mike Carr"
source_pdf: "fight-in-the-skies-rules.pdf"
...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Fight%20in%20the%20Skies&game=fight-in-the-skies)
<!-- verification:end -->
...
- **Damage types:** Fuselage hits, wing hits, engine hits, pilot hits, fire.

### Altitude Management
- Aircraft performance varies with altitude.
- Higher altitudes provide tactical advantages (diving attacks) but reduce engine performance.
- Altitude is tracked on the separate log sheet, adding a three-dimensional element to the grid-based map.
...
- Complete specific mission objectives (photo reconnaissance, balloon busting, ground strafing).
- Campaign rules track pilot experience over multiple engagements.

## Special Rules & Edge Cases

- **Aircraft data cards:** Each WWI aircraft type has unique performance characteristics (speed, climb rate, dive speed, structural strength, armament).
- **Pilot survival:** Rules determine if a pilot survives a crash, is captured, or killed behind enemy lines.
- **Optional rules:** Weather, ground attacks, rescuing downed pilots, anti-aircraft fire, and balloon defense.
