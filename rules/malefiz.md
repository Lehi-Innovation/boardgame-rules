...
player_count: "2-4"
play_time: "30-45 min"
designer: "Werner Schoppner"
source_pdf: "malefiz-rules.pdf"
...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/malefiz-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Malefiz&game=malefiz)
<!-- verification:end -->
...
1. Each player places their 5 pawns in their starting houses at the bottom of the board.
2. Place the 11 barricade pieces on the specially marked spaces on the board.
...
1. Roll the die.
2. Move one of your pawns exactly the number shown on the die.
...
| Action | Rule |
|--------|------|
| Roll die | Move one pawn exactly that many spaces forward |
| Hit barricade | Remove and replace it anywhere on the board |
| Hit opponent pawn | Send it back to starting house |
| Reach target | Must land with exact roll to win |
