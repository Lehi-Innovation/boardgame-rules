...
source_pdf: "gravwell-escape-from-the-9th-dimension-rules.pdf"
...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/gravwell-escape-from-the-9th-dimension-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Gravwell%3A%20Escape%20from%20the%209th%20Dimension&game=gravwell-escape-from-the-9th-dimension)
<!-- verification:end -->
...
2. Place 2 derelict ships on yellow spaces (#26 and #36). In a 2-player game, use only 1 derelict on space #36.
3. Place round-tracking pawn on "Start" bubble.
4. Each player chooses a color, places their ship in the Singularity (center), and takes their matching Emergency Stop! card (face up).
5. Shuffle 26 Fuel Cards. Deal stacks of 2 cards (1 face-down, 1 face-up on top) equal to the number of players x 3.
6. Place unused cards face down away from play.
...
Each Movement Phase:
1. All players simultaneously choose 1 Fuel Card from hand and place it face down.
2. Reveal all cards simultaneously.
3. Resolve cards in alphabetical order (A first, Z last).
4. Discard resolved cards.
...
|-----------|-------|--------|
| Standard | Normal | Move toward nearest ship |
| Repulsor | Purple | Move away from nearest ship |
| Tractor Beam | Teal | Pull all other ships toward you |
| Emergency Stop! | Player color | Cancel your Fuel Card this phase (once/round) |
