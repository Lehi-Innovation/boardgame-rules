...
---
<!-- verification:begin -->
> ❗ **Known errors** — an audit found inaccuracies in this summary that could mislead players: Invented 6-phase turn with initiative (actual: 2-month igo-ugo player turns), invented event/combat cards, VP victory replaced by fabricated surrender mechanics. Until it is re-written, prefer the full rulebook text linked below.
>
> 📄 [Full rulebook text](https://jonnyallred.github.io/boardgame-rules/extracted/asia-engulfed-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Asia%20Engulfed&game=asia-engulfed)
<!-- verification:end -->
