...
designer: "Don Carlston"
source_pdf: "personal-preference-rules.pdf"
...
>
> 📄 [Full rulebook text](https://jonnyallred.github.io/boardgame-rules/extracted/personal-preference-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Personal%20Preference&game=personal-preference)
<!-- verification:end -->
...
- 1 game board
- 4 Movement Pieces
- 16 Preference Tokens (4 of each color)
- 4 boxes of Category Cards (Food & Drink, Activities, People, Potpourri)
- 4 Color-coded Preference Cards
- 1 Secret Envelope
...
**Turn order rules:**
- No team takes more than one guessing turn.
- The last-place team may PASS until all others have guessed.
- When "IT" is the person being guessed, their team/partner guesses last regardless of waiting.
...
- 1 correct guess (no double) = advance 1 space
- 1 correct DOUBLED guess = advance 2 spaces
- 1 incorrect DOUBLED guess = move back 1 space
...
- **2-3 Players:** Each player acts independently (no teams). A player does not advance when they are "IT." Bluffing is not part of the game.
- **Planning Ahead:** Category Cards have black symbols on one side and gray on the other. Play all "black" cards first, then all "gray" cards, then shuffle for new combinations.
- "IT" rotates to the left after each round.
- The "IT" player's own team (or the "IT" player in small games) always guesses last.
- A player who is "IT" should not change their ranking after discussion and guessing begin.
- Teams should openly discuss their guesses, but "IT" must remain silent and not react.
