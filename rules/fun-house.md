...
play_time: "30 min"
designer: "Uncredited"
source_pdf: "fun-house-rules.pdf"
...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Fun%20House&game=fun-house)
<!-- verification:end -->
...
- Game board (depicting a fun house obstacle course)
- Player pawns
- Die or spinner
- Challenge/stunt cards
- Prize tokens or cards
- Rules booklet
...
- **Trivia questions:** Answer correctly to earn a reward or advance.
- **Stunt challenges:** Complete a physical or skill-based task.
- **Obstacle spaces:** Follow the instructions on the space (may advance or set you back).
...
- **Slides:** Move forward quickly (advance extra spaces).
- **Traps:** Move backward or lose a turn.
- **Shortcuts:** Skip ahead on the course.
- **Dead ends:** Lose your next turn or go back to a previous space.
...
| Year | 1988 |
| Based on | Fox TV show "Fun House" (1988-1991) |
