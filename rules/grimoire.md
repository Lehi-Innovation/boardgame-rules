...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Grimoire&game=grimoire)
<!-- verification:end -->
...
2. Place all VP Tokens in the VP Token Area on the board.
3. Shuffle the Item Card and Quest Card decks and place them in their designated areas on the board.
4. Put the Spell Level Marker under the "6" on the Spell Level Chart.
5. Put the Turn Order markers off to the side.
6. Give each player a Grimoire and the corresponding Bookmark.
7. Each player's space in front of them is their "Territory" where they keep Quest Cards, Item Cards, and VP Tokens.
