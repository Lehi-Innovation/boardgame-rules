...
source_pdf: "alemungula-rules.pdf"
...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Alemungula&game=alemungula)
<!-- verification:end -->
...
- Wooden board with 2 rows of 5 pits (called "ful alemungula")
- Seeds or stones (typically 4 per pit, 40 total)
- The board is called "tisiya alemungula" ("alemungula wood")
...
- **Singletons can be moved:** This is a key difference from many mancala games and increases the number of available moves.
- **Capture values are 2 and 4 only** — not other even numbers.
- **Chain captures** proceed backward from the final pit along the sowing direction.
- **No capture from own side:** Captures only occur when the last seed lands on the opponent's side.
- The game may be played in a series of rounds, with the loser setting up first in the next round.
