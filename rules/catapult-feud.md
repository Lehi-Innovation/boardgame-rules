...
source_pdf: "catapult-feud-rules.pdf"
...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/catapult-feud-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Catapult%20Feud&game=catapult-feud)
<!-- verification:end -->
...
- 2 player boards
- Plastic wall bricks (multiple types)
- 2 catapults with rubber bands
- 5 troops per player (10 total)
- 4 boulders per player (8 total)
- 6 Action Cards per player (one of each type)
- 1 distance marker
- Rules sheet
...
- Troops may be placed on top of bricks or on the player board.
- If a troop is not on a brick, it must be at a distance of at least 1 from all bricks.
- Troops can be stacked on top of bricks however you see fit, as long as they lay flat (not tilted).
- The winning army must have at least one troop standing upright.
...
- If there are still cards in your deck during the Cleanup Phase, draw 1 Action Card for each troop you lost that round. If no cards remain, you draw nothing.
- Discarded cards go back in the box and are out of the game.
- Only boulders and elastic bands provided with the game may be used in catapults. Never load anything else.
- Do not modify elastic bands to increase tension.
- Bricks must stay within player board borders at all times during building.
