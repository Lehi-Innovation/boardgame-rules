...
---
<!-- verification:begin -->
> ❗ **Known errors** — an audit found inaccuracies in this summary that could mislead players: Invented secret bidding for turn order, Test-on-Student "sign only"+rep loss invented, gold-to-VP ratio wrong (fixed 3:1), board sides misidentified, core seal/endorsement system omitted. Until it is re-written, prefer the full rulebook text linked below.
>
...
1. Place the game board (apprentice or master side).
...
1. **Choose Turn Order:** Players secretly bid on turn order positions using bid cards.
2. **Declare Actions:** In turn order, place cubes on action spaces.
3. **Resolve Actions:** Actions resolve in a fixed order.
...
1. **Convert Reputation to Points:** Reputation determines base VP.
2. **Published Theories:** Score points for theories that are still correct. Lose points for debunked theories.
3. **Artifacts:** Some provide end-game VP.
4. **Grants:** Scored if grant conditions are met.
5. **Gold:** Remaining gold converts to points (ratio varies by player count).
