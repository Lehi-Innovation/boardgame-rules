---
title: "Saboteur: The Lost Mines"
bgg_id: 245214
player_count: "3-9"
play_time: "30-60 min"
designer: "Frederic Moyersoen"
source_pdf: "saboteur-the-lost-mines-rules.pdf"
...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Saboteur%3A%20The%20Lost%20Mines&game=saboteur-the-lost-mines)
<!-- verification:end -->
...
1. **Play or Discard**: Either play a path card to extend tunnels, play an action card for its effect, OR discard 1-2 cards from hand.
2. **Move Dwarf**: After playing/discarding, move your dwarf up to 3 spaces along connected paths (up to 5 if starting from a campfire).
...
2. **Loyal dwarfs**: Pool their clan's treasure and divide evenly.
3. **Selfish dwarfs**: Keep all their own treasure.
4. **Saboteurs**: Pool with the opposing clan's loyal dwarfs and divide.
5. Subtract dragon tokens (-2 VP each).
...
| Role | Scores For |
|------|-----------|
| Loyal Dwarf | Own clan (share treasure equally) |
| Selfish Dwarf | Self only (keeps own treasure) |
| Saboteur | Opposing clan (shares with their loyal dwarfs) |

| Movement | Spaces |
|----------|--------|
| Normal | Up to 3 |
| From Campfire | Up to 5 |
