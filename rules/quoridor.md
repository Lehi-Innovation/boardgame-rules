...
source_pdf: "quoridor-rules.pdf"
extracted_date: "2026-03-22"
summarized_date: "2026-03-22"
rulebook_version: "Gigamic"
...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/quoridor-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Quoridor&game=quoridor)
<!-- verification:end -->
...
### 2 Players
- Each player takes 10 fences and places them in their storage area.
- Each player places their pawn in the center of their base line (edge of the board).
- Draw to determine who starts.

### 4 Players
- Each player takes 5 fences.
- Pawns placed in the center of each of the 4 sides.
...
- Fences are permanent once placed and cannot be moved or removed.
- Diagonal movement is not allowed.
- A typical game lasts 10-20 minutes.
- Tournament play may use timed turns.
- The critical strategic tension is between advancing your pawn and using fences to lengthen your opponent's path.
