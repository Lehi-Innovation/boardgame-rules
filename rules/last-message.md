...
source_pdf: "last-message-rules.pdf"
...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/last-message-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Last%20Message&game=last-message)
<!-- verification:end -->
...
- 1 screen
- 4 erasable boards (with 9-space grids)
- 2 dry erase markers
- 1 transparent token
- 1 sand timer (30 seconds)
- 12 double-sided sheets representing 6 crime scenes (for Detectives)
- 3 folded sheets representing 6 crime scenes (for Victim/Criminal)

## Setup

1. Choose one player to be the **Victim** and another to be the **Criminal**. Both sit on the same side of the table, behind the screen.
2. All other players are **Detectives** and sit on the opposite side of the table.
3. Choose 1 of the 6 crime scenes; place the 4 illustration sheets in front of the Detectives.
4. The Criminal places the folded illustration for that crime scene in front of themselves and the Victim (hidden from Detectives).
5. The Criminal secretly chooses any character in the illustration and places the transparent token on it.
6. The Victim takes the 4 erasable boards and one marker. The Criminal takes the sand timer and the other marker.
...
**Round Summary:**
1. Victim draws clues (30 seconds)
2. Criminal erases spaces
3. Detectives guess one suspect

**Roles:**

| Role | Count | Goal |
|------|-------|------|
| Victim | 1 | Help Detectives find the Criminal |
| Criminal | 1 | Prevent identification for 4 rounds |
| Detectives | All others | Identify the Criminal |
