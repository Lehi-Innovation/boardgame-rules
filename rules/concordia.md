...
play_time: "100 min"
designer: "Mac Gerdts"
source_pdf: "concordia-rules.pdf"
...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/concordia-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Concordia&game=concordia)
<!-- verification:end -->
...
### Intermediate Scoring (Recommended for First Game Only)
