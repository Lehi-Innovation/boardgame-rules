...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/ethnos-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Ethnos&game=ethnos)
<!-- verification:end -->
...
4. Discard all Bands; reshuffle for new Age. Control markers remain on the board.
