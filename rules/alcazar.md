...
player_count: "2"
play_time: "15-30 min"
designer: "Andrew Perkis"
source_pdf: "alcazar-rules.pdf"
...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Alcazar&game=alcazar)
<!-- verification:end -->
...
- Game board with a 4x4 grid of castle towers
- 1 red pawn and 1 green pawn
- 8 walls that fit between adjacent towers
...
- Walls rotate around tower intersections and can be moved to any valid position on the board, not just adjacent positions.
- Only one wall may be moved per turn.
- A player may not move a wall and a pawn on the same turn.
- Pawns cannot occupy the same tower simultaneously.
- The game has no draws under standard rules — one player will always eventually win.
