...
designer: "Gary Chalk, Ian Livingstone"
source_pdf: "battlecars-rules.pdf"
...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/battlecars-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Battlecars&game=battlecars)
<!-- verification:end -->
...
- **Ramming (Side Ram)**: Roll 3 dice plus rammer's speed. Rammed vehicle takes full damage. If you perform the ram, you take no damage; if you are rammed, you take half damage (rounded down).
- **Ramming (Shunt Ram)**: Roll 3 dice minus rammed vehicle's speed. Rammed vehicle takes full damage. If you perform the ram, you take no damage; if you are rammed, you take half damage (rounded down).
...
| Side Ram | 3D + rammer speed | None (if performing); Half if rammed | Full |
| Shunt Ram | 3D - rammed speed | None (if performing); Half if rammed | Full |