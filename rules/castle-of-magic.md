...
---
<!-- verification:begin -->
> ❗ **Known errors** — an audit found inaccuracies in this summary that could mislead players: Invented Keep/Tower spell descriptions (actual +1 Combat/Count Down spells missing), game-end triggers and co-winner rule omitted. Until it is re-written, prefer the full rulebook text linked below.
>
...
- The Ritual Spell begins when any Ritual Indicator is moved off its starting position, which drops the magical barrier to the Keep.
...
- Combat is the only way to transfer item points between players.
