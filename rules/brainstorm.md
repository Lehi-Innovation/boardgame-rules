...
play_time: "30-45 min"
designer: "Uncredited"
source_pdf: "brainstorm-rules.pdf"
...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Brainstorm&game=brainstorm)
<!-- verification:end -->
...
3. Shuffle the category cards and place them in a draw pile.
4. Determine a starting player.

## Turn Structure

On each turn:
1. Draw a category card and read the category aloud.
2. Players (either in turn or simultaneously, depending on the variant) call out items that fit the category.
3. For each answer that matches one listed on the card, the answering player advances 1 space.
4. For particularly creative or unusual valid answers, the player may advance 2 spaces.
5. Play passes to the next player or a new card is drawn.
...
| Answer Type | Movement |
|---|---|
| Standard valid answer | Advance 1 space |
| Unusual/creative valid answer | Advance 2 spaces |
