...
player_count: "2"
play_time: "15 min"
designer: "Traditional (Indian)"
source_pdf: "kaooa-rules.pdf"
...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Kaooa&game=kaooa)
<!-- verification:end -->
...
| Role | Pieces | Win Condition |
|------|--------|---------------|
| Vulture | 1 piece | Capture 4 crows |
| Crows | 7 pieces | Trap the vulture (no legal moves) |

| Key Rules | Detail |
|-----------|--------|
| Board shape | Pentagram (10 points) |
| Crow jumping | Not allowed |
| Vulture jumping | Single jump only per turn |
| Placement phase | Crows placed one per turn |
