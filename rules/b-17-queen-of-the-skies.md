...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20B-17%2C%20Queen%20of%20the%20Skies&game=b-17-queen-of-the-skies)
<!-- verification:end -->
...
1. Select or randomly determine a target for the mission using the mission table.
2. Fill in the crew record sheet with the names and positions of your 10 crew members: Pilot, Co-Pilot, Navigator, Bombardier, Engineer/Top Turret Gunner, Radio Operator, Ball Turret Gunner, Right Waist Gunner, Left Waist Gunner, and Tail Gunner.
3. Note the starting mission number and consult the tables for the route, weather, and fighter opposition levels.
