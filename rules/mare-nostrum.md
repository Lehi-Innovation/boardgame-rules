...
source_pdf: "mare-nostrum-rules.pdf"
...
---
<!-- verification:begin -->
> ❗ **Known errors** — an audit found inaccuracies in this summary that could mislead players: Victory condition threshold wrong (4 vs 5 Heroes/Wonders); 4th victory condition (4 Capital/Legendary Cities) entirely absent; Collect Resources and Claim Leadership phases absent from turn structure; wrong terminology throughout (Directors vs Leaders; Political Phase vs Build Phase). Until it is re-written, prefer the full rulebook text linked below.
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/mare-nostrum-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Mare%20Nostrum&game=mare-nostrum)
<!-- verification:end -->
...
1. Each player chooses 1 of 5 empires, each starting with 3 provinces.
2. Place starting units, cities, and resources as indicated on empire cards.
3. Assign director roles: Trade Director to player with most markets/caravans, Political Director to most cities/temples, Military Director to most legions/triremes.
4. Place resources in provinces.
...
| Improvement | Effect |
|------------|--------|
| Legion | Military unit (land combat) |
| Trireme | Naval unit (sea combat) |
| Fortress | Defensive structure |
| City | Increases political influence |
| Temple | Increases political influence |
| Market/Caravan | Increases trade influence |
| Hero | Provides special abilities |
| Wonder | Alternate victory path |
...
1. **Build the Pyramids** (collect specific set of resources and build the wonder).
2. **Control 4 Heroes/Wonders** (any combination of 4 heroes and/or wonders).
3. **Build all 3 Directors** (hold all three Director positions simultaneously through dominance in trade, politics, and military).
...
| Phase | Leader | Action |
|-------|--------|--------|
| Trade | Trade Director | Set trade terms, exchange resources |
| Political | Political Director | Build improvements |
| Military | Military Director | Move units, resolve combat |
