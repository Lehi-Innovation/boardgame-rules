---
title: "Finis ton Assiette"
bgg_id: 27768
player_count: "2-4"
play_time: "15 min"
designer: "Pierre-Nicolas Lapointe"
source_pdf: "finis-ton-assiette-rules.pdf"
...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Finis%20ton%20Assiette&game=finis-ton-assiette)
<!-- verification:end -->
...
1. Deal 3 plate cards face-up in front of each player.
2. Deal 4 fork cards to each player as their starting hand.
3. Place the remaining cards as a face-down draw pile.
...
| Starting plates | 3 per player |
| Hand size | 4 cards |
| Fork colors | Green, Red, Blue |
| Wild card | Magic Fork (yellow) |
| Win condition | First to clear all plates |
