...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20San%20Juan&game=san-juan)
<!-- verification:end -->
...
1. The **Governor** (starting player) chooses one role placard, places it in front of them, and all players perform that role's action. The Governor gets a **privilege** (bonus) for the chosen role.
2. Clockwise, each subsequent player selects an unchosen role and all players perform that action, with the selecting player gaining the privilege.
3. After all players have chosen a role, return all role placards to the center. Pass the Governor placard left. Begin a new round.
...
| Role | All Players Do | Privilege (Chooser) |
|------|---------------|---------------------|
| Builder | Build 1 building | Pay 1 less card |
| Producer | Produce 1 good | Produce 2nd good |
| Trader | Sell 1 good | Sell 2nd good |
| Councillor | Draw 2, keep 1 | Draw 5, keep 1 |
| Prospector | Nothing | Draw 1 card |
