...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Composio&game=composio)
<!-- verification:end -->
...
1. Place the board with the alphabet visible in the center.
2. Give each player a supply of markers.
3. Determine a starting player.

## Turn Structure

On your turn:
1. **Think of a word** that contains all previously marked letters plus at least one new letter.
2. **Place a marker** on the new letter(s) you are adding.
3. **Announce your word** to the group.
...
| Turn Action | Think of a word with all marked letters + 1 new letter |
|------------|-------------------------------------------------------|
| First Turn | Any word; mark one of its letters |
| Challenge | Dispute an opponent's word validity |
| Elimination | Cannot form a valid word with all marked letters |
| Win Condition | Most points or last player standing |
