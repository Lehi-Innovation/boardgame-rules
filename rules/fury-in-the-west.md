...
designer: "Stephen Peek"
source_pdf: "fury-in-the-west-rules.pdf"
...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Fury%20in%20the%20West&game=fury-in-the-west)
<!-- verification:end -->
...
- Hex map (Battle of Shiloh area including Pittsburg Landing, Shiloh Church, Tennessee River)
- Unit counters (Union and Confederate infantry, cavalry, artillery)
...
- Clear: 1 MP
- Woods: 2 MP
- Rough/Broken: Variable
- River crossings: High cost
- Roads: Reduced cost
...
- **Artillery:** Ranged bombardment capability; can support attacks from behind the front line.
- **Column Formation:** Units in column move faster on roads but are vulnerable in combat.
- **Flanking:** Attacks from multiple directions receive combat bonuses.
- **Prisoners:** Surrounded units may be captured rather than destroyed.
- **Night Turns:** Reduced movement and combat during night hours.
- **Surprise Attack:** First Confederate turn may receive combat bonuses simulating the surprise at Shiloh.
...
| Turn = | 1 hour |
| Map scale | Hex grid |
| Scenario | Battle of Shiloh (April 6-7, 1862) |
