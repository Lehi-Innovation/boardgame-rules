...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Merchants%20of%20Amsterdam&game=merchants-of-amsterdam)
<!-- verification:end -->
...
1. Place the board centrally with the Dutch auction clock accessible to all.
2. Each player takes pieces in their color and starting money.
3. Shuffle commodity cards and prepare draw piles.
4. Place starting tokens on the board as indicated.

## Turn Structure

Each round:
1. **Reveal auction lot:** Draw cards or tokens to form the lot being auctioned.
2. **Dutch Auction:** Start the clock. The price pointer descends from a high value. Any player can slam the button to claim the lot at the current price.
3. **Place/Score:** The winning bidder places tokens on the board according to what was auctioned.
4. **Scoring rounds** occur periodically.
