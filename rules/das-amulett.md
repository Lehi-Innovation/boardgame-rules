...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Das%20Amulett&game=das-amulett)
<!-- verification:end -->
...
2. Each player receives 10 energy stones and an amulet board.
3. Shuffle the spell card deck and prepare the jewel supply.
4. Set out the four types of metal resource tokens.
5. Determine the starting player.

## Turn Structure

Each round:
1. **Spell Card Auction:** A new spell card is revealed and auctioned.
2. **Energy Stone Recovery:** Remove one energy stone from each active spell card; recovered stones return to their owners.
3. **Resource Production:** Active spell cards produce metal resources for their owners.
4. **Jewel Auction:** Available jewels are auctioned using metal resources.
5. **Special Abilities:** Players may use abilities granted by their active spell cards.
