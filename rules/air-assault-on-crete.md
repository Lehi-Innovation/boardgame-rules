...
bgg_id: 3044
player_count: "2"
play_time: "120-300 min"
designer: "Randall Reed, Vance von Borries"
source_pdf: ""
...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Air%20Assault%20on%20Crete&game=air-assault-on-crete)
<!-- verification:end -->
...
1. **German Bombardment Phase**: German player conducts air bombardment of Allied positions.
2. **German Airborne Assault Phase**: German paratroops are dropped onto the map. Paratroop units take losses from both scattering during the drop and defensive fire, resolved with a single die roll.
3. **German Air Landing Phase**: Additional German forces arrive by transport aircraft at captured airfields.
4. **German Movement Phase**: German ground units move.
5. **German Combat Phase**: German units attack adjacent Allied units.
6. **Allied Movement Phase**: Allied ground units move.
7. **Allied Combat Phase**: Allied units attack adjacent German units.
