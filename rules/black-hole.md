...
play_time: "10-15 min"
designer: "Wal Joris"
source_pdf: "black-hole-rules.pdf"
...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/black-hole-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Black%20Hole&game=black-hole)
<!-- verification:end -->
...
- 1 triangular board (21 cells)
- 10 red tiles (numbered 1-10)
- 10 blue tiles (numbered 1-10)
...
- **Place a tile:** Put your next numbered tile (in order) on any unoccupied cell on the board.
...
- Since tiles are placed in ascending order, low-value tiles (1, 2, 3) are placed early when there are many open spaces, while high-value tiles (8, 9, 10) are placed when few spaces remain.
- Strategic play involves placing high-value tiles away from likely Black Hole locations and low-value tiles near them.
- Corner cells have fewer adjacent cells (2) compared to edge cells (3-4) or interior cells (up to 6), affecting their risk.
