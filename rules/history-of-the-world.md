...
source_pdf: "history-of-the-world-rules.pdf"
...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/history-of-the-world-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20History%20of%20the%20World&game=history-of-the-world)
<!-- verification:end -->
...
**Battle Summary:**
- Invader: 2 dice | Defender: 1 die (2 if fortified)
- Terrain: Defender +1 | Naval: Defender rerolls 1 die
...
- Capitol: 2 pts | City/Monument: 1 pt each
