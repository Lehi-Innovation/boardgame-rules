...
designer: "Rick Priestley, Andy Chambers, Gavin Thorpe"
source_pdf: "gorkamorka-rules.pdf"
...
1. Set up terrain on the playing surface to represent the desert wasteland.
2. Each player deploys their mob according to the scenario rules.
3. Place objectives (scrap counters, etc.) as required by the scenario.
