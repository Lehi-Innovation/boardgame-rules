...
1. **Action Die Phase**: Roll Action Dice as normal; new characters and factions may modify available actions.
2. **Hunt Phase**: Modified by Smeagol tiles in the Hunt Pool.
3. **Action Resolution Phase**: New characters, factions, and siege engines provide additional options.
4. **Battles of the War of the Ring** (separate game mode): Uses its own tactical turn structure for resolving individual battles.
