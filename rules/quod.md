...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Quod&game=quod)
<!-- verification:end -->
...
- Squares can be any size and any rotation, making them very difficult to block.
- The 4 corner spaces of the 11x11 grid are removed (not playable).
- Quasars are a limited resource -- using them too early leaves you vulnerable later.
- The game was featured in Scientific American (March 1996).
