...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/claustrophobia-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Claustrophobia&game=claustrophobia)
<!-- verification:end -->
...
2. Place the starting tunnel tile(s) as specified.
3. The Human player sets up warrior miniatures and dashboards per scenario.
4. The Demon player prepares their event cards and troglodyte miniatures.
5. Place any special tokens or items per scenario instructions.
