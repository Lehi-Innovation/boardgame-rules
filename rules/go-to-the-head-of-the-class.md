...
>
> 📄 [Full rulebook text](https://jonnyallred.github.io/boardgame-rules/extracted/go-to-the-head-of-the-class-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Go%20to%20the%20Head%20of%20the%20Class&game=go-to-the-head-of-the-class)
<!-- verification:end -->
