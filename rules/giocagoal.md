...
play_time: "30-60 min"
designer: "Uncredited"
source_pdf: "giocagoal-rules.pdf"
...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20GiocaGoal&game=giocagoal)
<!-- verification:end -->
...
- Half playing field/pitch
- 1 complete team of plastic football figures (various poses: forwards, midfielders, defenders, goalkeeper)
- 1 coach figure
- 1 bench
- 1 referee figure
- 1 goal
- Balls (semi-spheric and round varieties)
- Rules sheet
...
### Ball Types
- **Semi-spheric ball:** The recommended ball. Easier to control, rolls more predictably.
- **Round ball:** More difficult to control, moves less predictably. For experienced players.
...
|------|-------|
| Players | 2 |
| Boxes needed | 2 (one per team) |
| Manufacturer | Atlantic (Italy, 1970s) |
| Ball types | Semi-spheric (easy), Round (hard) |
| Similar to | Subbuteo |
