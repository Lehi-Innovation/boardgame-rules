...
source_pdf: "jurassic-parts-rules.pdf"
...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/jurassic-parts-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Jurassic%20Parts&game=jurassic-parts)
<!-- verification:end -->
...
- 6 Paleontologist Mats
- 12 Resource Cards
- 58 Fossil Tiles (various dinosaurs, plants, and Pile of Bones wild cards)
- 72 Chisels (12 per player in 6 colors)
- 20 Amber tokens
...
### Placing Chisels
- Place on any empty gap between two Fossil Tiles to create a crack.
- No gaps exist along the outside edge of the Slab.
- Place one at a time; resolve any split before continuing.

### Breaking Rocks
Some tile edges have Rocks that require extra chisels:
- **No Rocks:** 1 chisel to create the crack.
- **Rocks on ONE edge:** Spend (dull) 1 chisel + play 1 chisel to the gap = 2 total.
- **Rocks on BOTH edges:** Spend (dull) 2 chisels + play 1 chisel to the gap = 3 total.
- Must complete rock-breaking in one turn; partial breaking is not allowed.
...
- 1st purchase: 1 amber
- 2nd purchase: 2 amber
- 3rd+ purchase: 3 amber each
