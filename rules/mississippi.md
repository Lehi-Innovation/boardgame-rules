...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Mississippi&game=mississippi)
<!-- verification:end -->
...
2. Each player chooses a boat and places it at the start.
3. Shuffle and deal movement cards (if applicable).
4. Place obstacles as indicated on the board.

## Turn Structure

Players take turns in clockwise order. On your turn:
1. Play a movement card or roll dice to determine your movement.
2. Move your boat along the river the indicated number of spaces.
3. Resolve any encounters with obstacles or other boats.
