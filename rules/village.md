...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Village&game=village)
<!-- verification:end -->
...
- 44 Family members (11 per player in 4 colors)
- 4 Black monks
- 40 Goods tiles (horses, oxen, wagons, plows, scrolls)
- 24 Customer tiles
- 15 Coins, 20 Grain bags
- 72 Influence cubes (6 colors including plague cubes)
- 4 Farmyards with bridge markers
- Game board (9 action areas)
- 2 Cloth bags (green for cubes, black for monks)
- Scoring markers and reference cards
- Rulebook
...
- **Influence cube:** Keep it on your farmyard for future use.
- **Plague cube (black):** Return to supply; immediately costs 2 time on your life track.
...
- **Time Payment:** Place a family member (costs time), then produce a good (costs more time).
- **Resource Payment:** Pay influence cubes or grain without a family member.
- Mill produces 2 coins instead of goods.
...
- **Death Timing:** Finish the chosen action before death occurs (exception: market day causes immediate death choice).
- **Lowest Generation Dies First:** When death occurs, the family member with the lowest number always dies first.
- **Chronicle vs. Graves:** The Chronicle has limited slots per profession. If full, the deceased goes to anonymous graves (no scoring).
- **Coin as Joker:** Coins can substitute for any 1 influence cube.
- **Farmyard Limit:** Maximum 5 grain bags on your farmyard.
- **Goods Are Permanent:** Goods used for harvest bonuses (horse, ox, plow) are not consumed.
- **Family Selection:** Always take the lowest-numbered available family member from supply.
- **Missing Players:** Use unused colors' family members to block Chronicle/grave spaces in 2-3 player games.
- **Market Timing:** Complete the entire market day before checking for game-end triggers.
- **Church Mass:** Draw 4 pieces from the black bag. Players pay 1 coin each to secure their family from the bag. Place secured family members on the rightmost church window.
