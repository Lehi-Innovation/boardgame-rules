---
title: "Alien Contact: Extraterrestrial Empires in Conflict"
bgg_id: 2756
player_count: "2-6"
play_time: "180-360 min"
designer: "Unknown"
source_pdf: "alien-contact-extraterrestrial-empires-in-conflict-rules.pdf"
...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Alien%20Contact%3A%20Extraterrestrial%20Empires%20in%20Conflict&game=alien-contact-extraterrestrial-empires-in-conflict)
<!-- verification:end -->
...
1. Place the galactic sector board in the center.
2. Each player selects one of six alien races, each with unique environmental requirements.
3. Place starting units at designated home star systems.
4. Set initial resource levels based on home system values.
...
1. **Resource collection:** Gather resource points from controlled star systems (values modified by racial environmental requirements).
2. **Construction:** Build space stations, spaceships, and space marine units using resource points.
3. **Technology development:** Invest resources in technological advancement.
4. **Movement:** Move fleets between star systems.
5. **Combat:** Resolve battles when fleets meet enemy forces.
6. **Colonization:** Establish control over newly reached star systems.
...
| Phase | Action |
|-------|--------|
| Resources | Collect from controlled systems (race-modified) |
| Build | Construct ships, stations, marines |
| Tech | Invest in technology upgrades |
| Move | Deploy fleets to new systems |
| Combat | Resolve battles at contested systems |
| Colonize | Claim new star systems |
