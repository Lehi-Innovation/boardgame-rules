...
---
<!-- verification:begin -->
> ❗ **Known errors** — an audit found inaccuracies in this summary that could mislead players: Invented Brigade Combat Effectiveness system throughout, melee misstated as odds-based CRT (source uses Melee Differential), sequence of play wrong, turn length 30 vs 20 min, unsupported components. Until it is re-written, prefer the full rulebook text linked below.
>
