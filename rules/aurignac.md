...
player_count: "2-3"
play_time: "60-90 min"
designer: "uncredited (Oka Luda Editions)"
source_pdf: ""
...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Aurignac&game=aurignac)
<!-- verification:end -->
...
2. Each player selects a role: Neanderthal, Homo Sapiens, or Mother Nature.
3. Take the role-specific components.
4. Set up the shared game board elements.
...
| Role | Mechanic | Objective |
|------|----------|-----------|
| Neanderthal | Worker Placement | Found tribes, control territory |
| Homo Sapiens | Deck Building | Create art, develop culture |
| Mother Nature | Hand Management | Shape environment, maintain balance |
