...
source_pdf: "animal-upon-animal-rules.pdf"
...
>
> 📄 [Full rulebook text](https://jonnyallred.github.io/boardgame-rules/extracted/animal-upon-animal-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Animal%20Upon%20Animal&game=animal-upon-animal)
<!-- verification:end -->
...
1. Play on an even, flat surface.
2. Place the crocodile in the center of the table as the base of the pyramid.
3. Each player selects 7 different animals and places them in front of themselves as their supply.
4. If there are 2 or 3 players, the remaining animals are kept in the box.
...
| Die Face | Action |
|----------|--------|
| **1 dot** | Take 1 animal from your supply and carefully place it (with one hand) anywhere on the pyramid. |
| **2 dots** | Take 2 animals from your supply and place them one after the other (with one hand) onto the pyramid. |
| **Crocodile** | Take 1 animal from your supply and place it next to the mouth or tail of the crocodile (touching it), thereby expanding the base. On future crocodile rolls, you may place an animal adjacent to any base-level animal. |
| **Hand** | Choose any animal from your supply and give it to another player, who must then carefully place it on the pyramid. |
| **Question mark** | The other players choose which of your animals you must place on the pyramid. |
...
|-----------|-------------|
| 1-2 animals fall | Take fallen animals into supply |
| 3+ animals fall | Take 2 animals; rest go to box |
| Full collapse | Take 2 animals; reset crocodile; rest to box |
| Spontaneous fall (no one touching) | All fallen animals go to box |
| Place last animal successfully | You win! |
