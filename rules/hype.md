...
player_count: "2-6"
play_time: "60 min"
designer: "Steve Fairnie, Willie Williams"
...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Hype&game=hype)
<!-- verification:end -->
...
1. Place the circular board in the center.
2. Each player selects a band token and places it at the starting position.
3. Shuffle the various card decks and place them on the board.
...
On your turn:
1. **Roll dice** and move your band token around the board.
2. **Take the action** corresponding to the space you land on.
3. **Resolve any events** or encounters.
...
|-------------|-------------|
| Local gigs | Starting stage |
| Recording demos | Spend money |
| Record deal | Demos + reputation |
| National tours | Record deal |
| Number 1 hit | Win condition |
