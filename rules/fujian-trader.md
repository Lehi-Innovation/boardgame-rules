...
designer: "Patrick Rosendaal"
source_pdf: "fujian-trader-rules.pdf"
...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Fujian%20Trader&game=fujian-trader)
<!-- verification:end -->
...
- 1 game board (6 colored regions with ports)
- Colored die (6 sides matching the 6 regions)
- Port tokens
- Goods tokens (rice, iron, silk)
- Silver tokens
- Influence tokens
- Victory point track
- Event deck (including Manchu Move cards)
- Player boards
...
- **Trade goods:** Sell rice, iron, and silk for silver. Trade ratios depend on the region.
- **Buy ports:** Spend money to acquire new ports in any region.
- **Raid:** Attack opponents' trade routes or ports.
- **Incite rebellion:** Attempt to take over an opponent's port.
...
- Silver accumulated through trading
- Influence gained through trade and events
- Ports controlled at game end
...
| Item | Value |
|------|-------|
| Regions | 6 (color-coded) |
| Goods types | 3 (rice, iron, silk) |
| Manchu Move cards | 3 (triggers endgame) |
| Players | 2-4 |
