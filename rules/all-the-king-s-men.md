...
play_time: "15-30 min"
designer: "Unknown"
source_pdf: "all-the-king-s-men-rules.pdf"
...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20All%20The%20King%27s%20Men&game=all-the-king-s-men)
<!-- verification:end -->
...
- Game board with arrow markings on each space
- 2 Kings (one per player)
- 8 Knights (four per player)
- 8 Archers (four per player)

## Setup

1. Each player takes pieces of one color.
2. Place the King in the center space of the back row.
3. Place 2 Knights on each side of the King in the back row (4 Knights total, touching one another).
4. Place all 4 Archers in the second row.
...
- Moving their King to a safe space
...
- Arrows on each space are fixed and determine all possible movement directions from that space.
- Knights are the most powerful pieces because they can move multiple spaces.
- The board's arrow pattern creates asymmetric movement possibilities, making positional awareness critical.
- Pieces cannot jump over other pieces.
- Originally published as "Smess: The Ninny's Chess" by Parker Brothers in 1970, later rebranded as "All The King's Men."
