---
title: "Rubik's Puzzle Match"
bgg_id: 614
player_count: "2"
play_time: "5-10 min"
designer: "Erno Rubik"
source_pdf: "rubik-s-puzzle-match-rules.pdf"
...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Rubik%27s%20Puzzle%20Match&game=rubik-s-puzzle-match)
<!-- verification:end -->
...
1. Each player places their 24 colored tiles randomly into their 5x5 tray, leaving one space empty.
2. Place the pattern scrambler between the two players.
3. Each player positions their frame next to their tray.

## Turn Structure

Rubik's Puzzle Match is played in real time with no turns. Each round:

1. **Generate Pattern:** One player shakes the pattern scrambler to create a random 3x3 color pattern.
2. **Race:** Both players simultaneously slide their tiles within their 5x5 trays, attempting to arrange the central 3x3 grid to match the displayed pattern.
3. **Claim Victory:** The first player to match the pattern slams down their frame onto the tray and calls out.
4. **Verify:** Check that the center 3x3 matches the pattern exactly (as viewed from the completing player's perspective, not sideways or upside-down). Only the center 3x3 matters; the border tiles are irrelevant.
