...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/conflict-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Conflict&game=conflict)
<!-- verification:end -->
...
1. Open the board on any table. Players sit on different sides of the table.
2. Each player places all of their pieces in their starting area (home circle) in the corner of the board: 10 land pieces, 1 anti-aircraft gun, and 5 battleships.
3. The dice determine who goes first based on the highest total thrown.

## Turn Structure

On each turn, a player:

1. Rolls both dice and moves any pieces along the land route (brown squares) to the land area and water route (blue), or to the water areas (blue squares). Pieces on land may not enter water areas and water pieces may not enter land areas unless going by other routes.
2. To enter a zone, the player places pieces in the home circle and moves the adjacent square to the other area.
...
| Piece | Captures | Captured By |
|-------|----------|-------------|
| Land piece | Other land pieces, air pieces | Other land pieces, planes |
| Anti-aircraft gun (plane) | Any land, water, or air piece | Land pieces, other planes |
| Battleship (water) | Other water pieces only | Other water pieces, planes |
