...
play_time: "30 min"
designer: "Uncredited"
source_pdf: "game-of-the-goose-rules.pdf"
...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Game%20of%20the%20Goose&game=game-of-the-goose)
<!-- verification:end -->
...
- 1 spiral game board with 63 numbered spaces
- 4-6 playing pieces (often goose-shaped)
- 2 six-sided dice

## Setup

1. Place the game board in the center of the table.
2. Each player selects a playing piece and places it on the starting space (off the board or space 0).
3. Each player rolls both dice; the highest roller goes first. Play proceeds clockwise.
...
### Well and Prison
- A player stuck in the Well or Prison cannot move until another player lands on that same space, at which point the two players swap positions. The newly arrived player is now stuck.
- In some versions, players stuck in the Well or Prison are freed after a set number of turns (typically 3) if no one lands on their space.
...
|-------|--------|
| 6 (Bridge) | Jump to 12 |
| 19 (Hotel) | Lose next turn |
| 31 (Well) | Stuck until freed |
| 42 (Maze) | Back to 39 |
| 52 (Prison) | Stuck until freed |
| 58 (Death) | Back to start |
...
| Board spaces | 63 |
| Dice | 2d6 |
| Exact finish required | Yes (bounce back on overshoot) |
| Same space | Players swap positions |
| First roll of 9 | 6+3 -> space 26; 5+4 -> space 53 |
