...
play_time: "60-90 min"
designer: "Uncredited"
source_pdf: "easy-money-rules.pdf"
...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/easy-money-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Easy%20Money&game=easy-money)
<!-- verification:end -->
...
- 1 game board (properties arranged around the perimeter in a loop)
- Money bills in various denominations
- Houses (colored pieces, in 4 colors)
- Property deeds / Title cards
- 2 dice
- 4 player tokens (colored MAN movers)
- Give or Take cards (deck of 24)
- Banker's tray with partitions
...
- Houses are built and Property mortgaged ONLY in a Player's turn, either before or after the throw of the dice.
- There are no denominations of $1 or $5 bills; you might have to round off your payments to a zero figure ending. For example, if the figure your must pay is $1.15, round it off to pay $1.15.
- NOTE: If all Players agree, the rule of owning four properties (one on each side of the board) may be dropped. This allows the Players to buy Property anywhere on the Board and build more Houses on them at any time in their turn.
- A player must own properties on all four sides of the board before buying a second property on any one side.
- The Special Exemption Card can be traded or sold between players.
