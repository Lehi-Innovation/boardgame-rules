...
player_count: "2-5"
play_time: "120 min"
designer: "Adrian Kuhn"
source_pdf: "gangsters-rules.pdf"
...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Gangsters&game=gangsters)
<!-- verification:end -->
...
- Game board (map of Chicago districts with color-coded properties)
- Player pieces (Racketeers, Thugs, Vamps for each gang)
- Property cards
- Money tokens
- Cop pieces
- Event/Action cards
...
- **Racketeers:** Run your criminal operations; essential for controlling properties
- **Thugs:** Provide muscle for hostile takeovers and defense
- **Vamps:** Seduce and manipulate opponents' gang members and cops

### 3. Take Actions
Perform criminal activities:
- Acquire joints (properties) by paying their price
- Extort businesses for protection money
- Bribe cops to look the other way or harass opponents
- Attack opponents' gang members or properties
...
A player wins when their gang has at least one Racketeer, one Vamp, and one Thug, AND meets any one of these three conditions:
...
**Police Commissioner (5th player):**
The Commissioner wins by accumulating $10,000 and having control of at least one loyal Cop.
...
| Member | Role |
|--------|------|
| Racketeer | Runs operations, essential for victory |
| Thug | Muscle for combat and defense |
| Vamp | Seduction and corruption |
...
| Item | Value |
|------|-------|
| Players | 2-5 (including optional Commissioner) |
| Game length | ~120 min |
| Gang member types | 3 (Racketeer, Thug, Vamp) |
