...
designer: "Dirk Henn"
source_pdf: "powerline-rules.pdf"
...
1. Place the center board in the middle (front side with pre-printed scoring tiles for standard game).
2. Round marker starts on space 0.
3. Each player takes a player board, power station tiles, worker/energy tiles, VP marker, kite tile, and 6 colored worker meeples.
...
| Round Step | Action |
|------------|--------|
| 1. Roll | Roll all 6 colored dice |
| 2. Direction | Choose left-to-right or right-to-left |
| 3. Build | Use dice values on powerline tracks |
| 4. Workers | Assign workers, take penalties for skips |
| 5. Score | Check objectives on designated rounds |
