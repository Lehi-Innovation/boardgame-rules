...
player_count: "2-5"
play_time: "60-90 min"
designer: "Flaminia Brasini, Virginio Gigli, Stefano Luperto, Antonio Tinto"
source_pdf: "leonardo-da-vinci-rules.pdf"
...
- Work counters
- Mechanical men
- Component cards (Iron, Wood, Rope, Brick, Glass)
- Invention cards (Bronze, Copper, Silver, Gold tiers)
- Florin cards (denominations 1, 3, 5, 10)
- Leonardo figure (with base)
- Lord of the City figure (with base)
- Turn marker and money marker
- Summary tables
...
- **Academy**: Recruit new apprentices.
- **Shops (5 types)**: Acquire components (Iron, Glass, Wood, Brick, Rope). First ranked = free, subsequent players pay increasing costs.
...
- **Master = 2 apprentices** for ranking purposes.
- **Player count adjustments**: 2 players return 1 apprentice, 3 players return 1 apprentice each.
...
**City Areas (resolution order):**
A. Council -> B. Workshop -> C. Academy -> D-H. Five Shops
...
- Collect inventions of different types for bonus Florins at game end.
