...
source_pdf: "quest-rules.pdf"
extracted_date: "2026-03-22"
summarized_date: "2026-03-22"
rulebook_version: "Indie Boards & Cards"
...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/quest-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Quest&game=quest)
<!-- verification:end -->
...
- Certain quests (at higher player counts) require 2 fail cards to fail.
- Special character roles add powers: seeing other players' allegiances, protecting the Commander, etc.
- The 5-rejection rule prevents indefinite stalling.
- Discussion and persuasion are core mechanics; no restrictions on what players may claim.
