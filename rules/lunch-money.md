...
play_time: "30 min"
designer: "John Yates"
source_pdf: "lunch-money-rules.pdf"
...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/lunch-money-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Lunch%20Money&game=lunch-money)
<!-- verification:end -->
...
1. Each player starts with 15 counters (pennies recommended).
2. Deal 5 cards to each player.
3. Remaining cards form the draw pile, face-down and accessible to all.
4. Create a lost counter pool in the centre.
...
1. **Play a card** — name a target and resolve the attack/effect
2. **Discard and redraw** — discard any number of cards and draw back up to 5
3. **Pass** — do nothing
