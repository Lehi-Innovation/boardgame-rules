...
source_pdf: "cthulhu-500-rules.pdf"
...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/cthulhu-500-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Cthulhu%20500&game=cthulhu-500)
<!-- verification:end -->
...
1. Separate Vehicle cards and sort into 8 pairs by vehicle name. Distribute or let players choose matched pairs.
2. Place pack marker Vehicle cards (undamaged side up) in any order in the center of the table to form the pack. Place schematic Vehicle cards in front of each player, undamaged side up.
3. Find the Checkered Flag card and place it face up as the first card in the discard pile.
4. Shuffle the remaining deck and deal 5 cards to each player.
5. Place the rest of the deck face down as the draw pile.
6. **Determine Pack Order:** Each player secretly selects cards from their hand to discard. All reveal simultaneously. Player who discarded the most becomes pack leader; fewest goes to the back. Ties are broken by die rolls. Discarded cards go to the discard pile.
7. The player at the back of the pack goes first; turns proceed clockwise.

## Turn Structure

On a player's turn, in order:

1. **Take 2 Actions** (from: play an Action card, add pit crew, make a passing attempt, make a pit stop)
2. **Discard** any number of cards from hand
3. **Draw** up to 2 cards (hand maximum normally 5)
...
| Action | Description |
|--------|-------------|
| Play Action Card | Follow card directions, discard |
| Add Pit Crew | Play Crew card to pit crew area |
| Passing Attempt | Roll d6 + Speed + Drive + bonuses vs opponent |
| Pit Stop | Free pass for vehicle behind, then: add Mod/Tires/Driver or Repair |

| Formula | Calculation |
|---------|-------------|
| Passing Test Total | Die + Speed + Driver's Drive + Mods + Tires + Actions + Reactions |
| Repair Test | Die + Pit Crew Fixit totals vs Complexity |
