...
---
<!-- verification:begin -->
> ❗ **Known errors** — an audit found inaccuracies in this summary that could mislead players: Invented "Sail" action; Modernize/Builder/Settle misdescribed; Region Scoring action missing; final scoring claims VP for leftover coins/resources contradicting source; interim-scoring income/penalty omitted. Until it is re-written, prefer the full rulebook text linked below.
>
> 📄 [Full rulebook text](https://jonnyallred.github.io/boardgame-rules/extracted/boonlake-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Boonlake&game=boonlake)
<!-- verification:end -->
...
- Harbors hold unlimited ships; other spaces hold only 1.
- Skip occupied non-harbor spaces (don't count toward movement).
- Ship only moves downstream (never backwards).
- First player to cross a lock triggers interim scoring for all.
...
- VP from played project cards with end-game effects
- VP from remaining resources, coins, and other bonuses
- VP from board position and presence

**Winner:** Most VP. Use 100/200 markers for tracking overflow.

## Special Rules & Edge Cases

- **Lever effects:** Certain actions grant levers that provide one-time bonuses during the game.
- **Tier bonuses:** Removing pieces from player board recesses may unlock inhabitants or other bonuses.
- **Resource availability:** Resources from production sites and boats are always "available" — they're not consumed, just shown.
- **Upstream boat movement:** Costs 2 coins per boat. Downstream is free.
- **VP can go below 0:** Track it with the marker.
- **Wooden pieces are limited:** If depleted, you cannot gain more.
- **Houses removed from game:** Can be reused if you need to place one and have none on your board.
- **Parallel play:** Most actions allow simultaneous resolution. Settle and Cattle-breeding require clockwise order.
- **Starting player:** Last person to travel to a place with <100 inhabitants.
...
| Vase/Production | Take 1 vase or build 1 production site |
| Vase | Take 1 vase |
