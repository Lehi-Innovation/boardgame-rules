...
bgg_id: 242804
player_count: "2-4"
play_time: "50-100 min"
designer: "Claudia Partenheimer, Ralf Partenheimer"
source_pdf: "lowlands-rules.pdf"
...
---
<!-- verification:begin -->
> ❗ **Known errors** — an audit found inaccuracies in this summary that could mislead players: Turn structure wrong: real structure is 3 stages x 6 phases plus Storm Surge; Upkeep phase (breeding+income) entirely absent; Storm Surge dike-breach VP penalties absent; VP tiebreaker missing. Until it is re-written, prefer the full rulebook text linked below.
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/lowlands-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Lowlands&game=lowlands)
<!-- verification:end -->
...
1. Place main board centrally. Shuffle flood cards to form flood deck.
2. Each player places dike point marker on 0. Randomly place progress tokens on first 5 dike track spaces.
3. Place value marker on middle of value track.
4. Shuffle resource cards; draw 4 face-up to the resource display.
5. Set up sheep market board matching player count.
6. Each player takes a farmyard board, farmers, building markers, and starting resources.

## Turn Structure

The game plays over several rounds. Each round:

1. **Place Farmers:** Players take turns placing one farmer at a time on action spaces (main board or own farm).
2. **Resolve Actions:** Resolve the actions where farmers were placed.
3. **Flood Phase:** Reveal flood cards; compare dike strength to flood level.
4. **End of Round:** Advance phase marker, refill displays.
...
| Action | Effect |
|--------|--------|
| Collect resources | Take wood, clay, or stone cards |
| Buy sheep | Purchase sheep from the market |
| Build fences | Enclose pastures on your farm |
| Build farm expansions | Pay resources to add tiles to your farm |
| Contribute to dike | Add dike segments to the communal dike; move your dike marker forward |
| Sell sheep | Sell sheep for coins |
| Use buildings | Activate special building effects |
