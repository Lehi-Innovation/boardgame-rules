...
designer: "Alex Buchel"
source_pdf: "saga-rules.pdf"
...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Saga&game=saga)
<!-- verification:end -->
...
1. **Orders Phase**: Roll your SAGA dice. Assign dice to your faction battle board slots. Each slot requires specific die face symbols and grants specific abilities.
2. **Activation Phase**: Use placed SAGA dice to activate units for movement, shooting, melee, or special abilities. Remove dice as they are used.
3. **End Phase**: Remove expired effects and prepare for the opponent's turn.
...
| Unit Type | Models per Point | Quality |
|-----------|-----------------|---------|
| Hearthguard | 4 | Elite |
| Warriors | 8 | Standard |
| Levies | 12 | Militia |
