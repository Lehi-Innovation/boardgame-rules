...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/age-of-empires-iii-the-age-of-discovery-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Age%20of%20Empires%20III%3A%20The%20Age%20of%20Discovery&game=age-of-empires-iii-the-age-of-discovery)
<!-- verification:end -->
...
- 1 Gameboard (map of the Americas with 9 regions + event boxes)
- 30 Colonists per player color (5 colors)
- Specialists per color: 5 Captains, 5 Merchants, 10 Missionaries, 10 Soldiers
- 10 Merchant ship miniatures (Caravels)
- Capital Building tiles (Age I, II, III)
- Trade Goods tokens (gold, silver, cattle, cocoa, fish, sugar, fur, coffee, tobacco, rice, indigo)
- 16 Discovery counters
- 16 Discovery Deck cards
- Money: silver ($1) and gold ($10) coins
...
- The Caribbean is available from the start (no discovery counter needed).
