...
source_pdf: "last-will-rules.pdf"
...
1. Assemble game boards based on player count.
2. Shuffle card decks separately; place on designated board spaces.
3. Each player takes a player board, 2 errand boys, action counter, planning marker, and starting money.
4. Place round counter on round 1.
...
**Round Summary:**
1. Planning (choose plan card secretly)
2. Errand Boys (deploy to board locations)
3. Actions (play/activate cards based on plan)
4. End of Round (cleanup, advance round)

**Card Types:**

| Type | Effect |
|------|--------|
| Events | One-time spending |
| Expenses & Helpers | Ongoing costs |
| Properties | Buy/depreciate/sell for losses |
| Companions | Boost event spending |
| Special | Unique abilities |
| Last Will | One-time powerful effects |
