...
source_pdf: "power-grid-factory-manager-rules.pdf"
...
1. Each player takes a factory board, workers, seasonal workers, markers, and starting money.
2. Set up starting tiles on factory boards.
3. Prepare the market on the storage board based on player count.
4. Set the energy price to starting level.
5. Determine initial player order.
...
| Round Phase | Action |
|-------------|--------|
| 1. Player Order | Bid workers for turn order |
