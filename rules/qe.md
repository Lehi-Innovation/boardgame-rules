...
source_pdf: "qe-rules.pdf"
extracted_date: "2026-03-02"
summarized_date: "2026-03-02"
rulebook_version: "Boardcade Games Edition (2019)"
...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/qe-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20QE&game=qe)
<!-- verification:end -->
...
- 21 Company Tiles (each showing a nation, industry, and VP value)
- 5 Industry Tokens (Agriculture, Housing, Government, Finance, Manufacturing)
- 5 Bid Tiles (dry erase)
- 5 Player Score Boards (double-sided for different player counts, one per nation)
- 5 Dry Erase Markers
...
- **Must bid a positive, whole number** (the Auctioneer cannot bid zero).
...
- May bid any **positive whole number, or zero**, but may **not** bid the same amount as the Auctioneer.
...
- Play continues with Phase 1 again, unless there are no more Company Tiles to be auctioned, in which case the game is over.
...
- Bids must be **positive whole numbers**, except non-Auctioneer players may also bid **zero**.
- The Auctioneer's bid is always **public** (placed face up).
- Non-Auctioneer bids are **secret** (handed face-down to the Auctioneer).
- Non-Auctioneer players may **not** bid the same amount as the Auctioneer.
- There is **no upper limit** on bids — players can bid any amount they choose.
- The highest bidder wins the Company Tile.
- Winning bid amounts are **secret** (written on the back of the tile), except when the Auctioneer wins their own auction (recorded openly).
...
- All of your Company Tiles and your Industry Token count independently for each individual scoring category.
- Every tile may be used in every category, but only once within each category.
- Use your Player Score Board to help calculate your score.
- It helps to mark the tiles you collect on your Player Score Board during the course of play.
...
| Category | Scoring |
|---|---|
| Elimination | Highest spender is eliminated |
| Least Spent Bonus | 7 VP |
| Companies | Face value VP on tiles |
| Zero Bids | 2 VP per round (max 1/round) |
| Nationalization | 1 / 3 / 6 / 10 VP for 1 / 2 / 3 / 4 matching nation |
| Monopolization | 3 / 6 / 10 VP for 2 / 3 / 4 in same industry |
| Diversification | 4 / 8 VP for 3 / 4 different industries |

### Scoring Summary (5 Players)
| Category | Scoring |
|---|---|
| Elimination | Highest spender is eliminated |
| Least Spent Bonus | 6 VP |
| Companies | Face value VP on tiles |
| Zero Bids | 2 VP per round (max 1/round) |
| Nationalization | 3 / 6 / 10 VP for 1 / 2 / 3 matching nation |
| Monopolization | 6 / 10 / 16 VP for 2 / 3 / 4 in same industry |
| Diversification | 8 / 12 / 17 VP for 3 / 4 / 5 different industries |

### Key Numbers
- 3-4 player game: 16 Company Tiles, 16 turns
- 5 player game: 15 Company Tiles, 15 turns
- Elimination: Highest total spender (ties eliminate all)
- Least spent bonus: 7 VP (3-4 players) / 6 VP (5 players)
- Zero bid VP: 2 VP per round (max 1 per round, not scored in 3-player)
- Industries: Agriculture, Housing, Government, Finance, Manufacturing
- Tied auction: Rebid up to 3 times, then highest non-tied bid wins
