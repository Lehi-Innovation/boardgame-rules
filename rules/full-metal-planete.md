...
designer: "Gérard Delfanti, Gérard Mathieu, Pascal Trigaux"
source_pdf: "full-metal-planete-rules.pdf"
...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Full%20Metal%20Planete&game=full-metal-planete)
<!-- verification:end -->
...
- 1 hexagonal playing field (851 hexes)
- 84 metal pieces: 4 Freighters, 12 turrets, 8 crabs, 4 Weather Hens, 32 tanks, 4 Heaps, 8 motorboats, 4 barges, 8 pontoons
- 15 tide cards (5 normal, 5 low, 5 high)
- 100 ore pieces
- 100 colored markers
- 8 action point cubes
- 1 turn marker
...
**Action Points by Turn:**
| Turns | Action Points |
|-------|--------------|
| 1-2 | Setup (special rules) |
| 3 | 5 |
| 4 | 10 |
| 5-20 | 15 |
| 21-25 | 15 (departure phase) |
...
- **Tanks:** Move on land (plains, swamps in low/normal tide, mountains)
- **Motorboats:** Move on water (sea, swamps in high tide, reefs in normal/high tide)
- **Barges:** Move on water; can carry one unit
- **Crabs:** Amphibious; move on land or water
- **Pontoons:** Placed to create bridges for land units to cross water

### Loading and Unloading (1 action point each)
- Units can pick up ore from adjacent hexes.
- Units can load ore into or unload from transporters (barges, Freighters).
- Enter/exit Freighter: 1 action point.
...
- **Tanks/turrets/motorboats:** Range of 2 hexes
- **Heaps:** Range of 3 hexes
- **Mountain tanks:** Range of 3 hexes
- Destroyers have 2 shots per turn, replenished at the start of each turn.
- A single destroyer alone cannot attack.
...
- **2 points** per ore piece in your Freighter
- **1 point** per unit in your Freighter
...
- **Low tide:** Swamps and reefs become land (passable by tanks)
- **Normal tide:** Swamps are land, reefs are sea
- **High tide:** Swamps and reefs both become sea (passable by boats)
...
- Save 5 points: 1 cube
- Save 10 points: 2 cubes (maximum)
Each cube can be spent as 5 action points in a future turn.
...
|--------|------|
| Move 1 hex | 1 |
| Load/unload ore or unit | 1 |
| Enter/exit Freighter | 1 |
| Create unit (Weather Hen) | 1 |
| Destroy unit or ore | 2 |
| Rebuild turret | 2 |
| Takeoff | 1 + damaged turrets |
| Capture unit | 1 + 1 marker |
...
|------|-------|
| Turns | 21-25 |
| Max action points/turn | 15 (base), 25 (with bonuses) |
| Ore per 3 hexes | 1 |
| Tide types | Low, Normal, High |
| Turrets per Freighter | 3 |
