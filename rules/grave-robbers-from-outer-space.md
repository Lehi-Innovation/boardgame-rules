...
source_pdf: "grave-robbers-from-outer-space-rules.pdf"
...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Grave%20Robbers%20from%20Outer%20Space&game=grave-robbers-from-outer-space)
<!-- verification:end -->
...
1. A dealer shuffles the entire deck and deals 6 cards to each player.
2. Each player checks their hand for Character cards. If a player has no Characters, they discard their entire hand and draw 6 new cards. Repeat until every player has at least one Character.
3. All players reveal their Character cards by placing them face up in front of them.
4. Place the remaining deck face down as the draw pile.
5. The game cannot end until at least two full rounds have been played.

## Turn Structure

On your turn:

1. **Draw cards** to bring your hand back up to a maximum of 6 cards (if below 6).
2. **Play cards** from your hand to your movie (Characters, Props, Locations, Plots, Special Effects) or attack opponents with Creatures.
