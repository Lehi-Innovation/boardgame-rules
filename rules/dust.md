...
designer: "Paolo Parente, Roberto Di Meglio, Marco Maggi, Francesco Nepitello"
source_pdf: "dust-rules.pdf"
...
---
<!-- verification:begin -->
> ❗ **Known errors** — an audit found inaccuracies in this summary that could mislead players: Production formula omits 6 PP per capital; win condition omits required capital-control check. Until it is re-written, prefer the full rulebook text linked below.
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/dust-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Dust&game=dust)
<!-- verification:end -->
...
- 6-piece jigsaw game board (world map with land areas, sea areas, capitals, power sources)
- Victory point track along board edge
- Military units per army (6 colors): 60 tanks, 20 mechs, 20 fighters, 15 bombers, 15 submarines
- 24 production center figures (shared color)
- 45-card deck
- Special six-sided dice (2 hit faces, 4 blank)
- 16 Power Source tokens
- 6 Capital tokens
- 3 Majority tokens (production, sea, land)
- 3 reference sheets
...
- Capitals controlled
- Power sources controlled
- Majority tokens (production, sea, land)

## Special Rules & Edge Cases

- **Power Sources:** Areas marked with a bullseye. Critical for VP scoring and limit production center utility.
- **Production Centers:** Ownership determined by who controls the area (not by color). Can change hands. Cannot be destroyed. Cannot be placed on power sources.
- **Tactical Supremacy:** Air units contribute; side with higher tactical supremacy acts as attacker (chooses casualties order). Submarines have no tactical supremacy value.
- **Cards:** Each conveys 5 pieces of info: initiative/combat value, movement, production, stars, and a special ability. Special abilities include things like extra movement, additional attacks, production bonuses, etc.
- **Tank/Mech Shield and Fighter/Bomber Shield:** Cheaper units must be destroyed before more expensive paired units in the same battle.
- **Strategic Bomber Movement:** Bombers can move through multiple areas, including enemy areas, for long-range attacks.
