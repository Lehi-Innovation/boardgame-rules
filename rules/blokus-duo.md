...
source_pdf: "blokus-duo-rules.pdf"
...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/blokus-duo-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Blokus%20Duo&game=blokus-duo)
<!-- verification:end -->
...
2. In the two-player version, one player controls blue and red, the other controls yellow and green.
3. The playing order is: blue, yellow, red, green.
...
| Scoring | Points |
|---------|--------|
| Each remaining square | -1 |
| All pieces placed | +15 |
| Monomino placed last | +5 bonus |
| Perfect game | +20 |
