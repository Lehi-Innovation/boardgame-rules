...
designer: "Tuomas Pirinen, Alessio Cavatore"
source_pdf: "mordheim-rules.pdf"
...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/mordheim-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Mordheim&game=mordheim)
<!-- verification:end -->
...
1. Set up modular terrain to create a ruined cityscape.
2. Each player assembles a warband within a gold crown budget (500gc for starting warbands).
3. Record warband members on roster sheets with their stats.
4. Place warbands at starting positions according to the scenario.
...
1. **Recovery Phase**: Warriors who are stunned attempt to recover. Rout tests if needed.
2. **Movement Phase**: Move warriors up to their Movement stat in inches.
3. **Shooting Phase**: Warriors with ranged weapons may fire at visible enemies.
4. **Close Combat Phase**: Resolve melee combat between engaged warriors.
...
| Phase | Action |
|-------|--------|
| Recovery | Stunned warriors attempt to stand |
| Movement | Move warriors up to M inches |
| Shooting | Ranged attacks: hit, wound, save |
| Combat | Melee: both sides hit, wound, save |
| Post-Battle | Experience, injuries, recruitment, equipment |
| Rout | Test at 25% casualties; fail = flee |
