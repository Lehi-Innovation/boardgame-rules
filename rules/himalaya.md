...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Himalaya&game=himalaya)
<!-- verification:end -->
...
2. Each player selects a tribe (Dolpo-pa, Bhotia, Sherpa, or Tamang) and takes their caravan pawn, screen, and programming tokens.
3. Distribute goods cubes to the villages as indicated.
4. Place contract cards at designated villages.
5. Set the round marker to round 1.
...
1. **First, compare Religious Influence:** The player with the least religious influence (fewest stupas) is eliminated from contention.
2. **Next, compare Political Influence:** Among remaining players, the one with the least political influence (fewest delegations) is eliminated.
3. **Finally, compare Economic Influence:** Of the remaining players, the one with the greatest economic influence (most yaks) wins the game.
...
| Influence Type | How to Gain | Scoring Role |
|---------------|-------------|-------------|
| Religious (Stupas) | Fulfill contracts, choose stupa reward | Least is eliminated first |
| Political (Delegations) | Fulfill contracts, choose delegation reward | Least is eliminated second |
| Economic (Yaks) | Fulfill contracts, choose livestock reward | Most wins among survivors |

| Phase | What Happens |
|-------|-------------|
| Programming | Secretly plan 6 actions behind screen |
| Execution | Reveal and resolve actions step by step |
