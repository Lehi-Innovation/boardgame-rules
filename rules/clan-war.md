...
designer: "Alderac Entertainment Group"
...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Clan%20War&game=clan-war)
<!-- verification:end -->
...
- Miniature figures (samurai infantry, cavalry, archers, shugenja, etc.)
- Unit stat cards
- Terrain pieces
- Measuring tools/rulers
- Dice
- Army list/point system documentation
- Reference sheets

## Setup

1. Players agree on a point limit for army construction.
2. Each player builds their army from their clan's available units, spending points up to the agreed limit.
3. Set up terrain on the battlefield by mutual agreement.
4. Deploy armies on opposite sides of the battlefield according to the scenario.
...
2. **Movement Phase:** Alternate moving units across the battlefield.
3. **Ranged Attack Phase:** Resolve archery and magical attacks.
4. **Melee Phase:** Resolve close combat between engaged units.
5. **Morale Phase:** Check unit morale for those that suffered casualties.
6. **Rally Phase:** Attempt to rally broken units.
...
| Unit Types | Infantry, Cavalry, Archers, Shugenja |
|-----------|--------------------------------------|
| Combat | Dice + unit quality + modifiers |
| Morale | Check after casualties; fail = break |
| Magic | Shugenja cast spells with limited uses |
| Win Conditions | Destroy enemy forces or complete scenario objectives |
