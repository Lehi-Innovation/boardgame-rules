...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/coup-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Coup&game=coup)
<!-- verification:end -->
...
1. Shuffle all 15 character cards and deal 2 face-down to each player. Players may look at their own cards but keep them face-down.
2. Place remaining cards as the Court deck in the center.
3. Give each player 2 coins, kept visible.
4. Place remaining coins as the Treasury.
5. The winner of the last game starts; otherwise choose randomly.
...
2. Other players may challenge or counteract
3. Challenges resolve first
4. Then the action (or counteraction) resolves
...
| Foreign Aid | Take 2 coins from Treasury (blockable by Duke) |
| Coup | Pay 7 coins to Treasury; target loses 1 influence (cannot be blocked) |
...
|-----------|--------|--------|
| Duke | Tax | Take 3 coins from Treasury |
| Assassin | Assassinate | Pay 3 coins; target loses 1 influence (blockable by Contessa) |
| Captain | Steal | Take 2 coins from another player (blockable by Ambassador or Captain) |
| Ambassador | Exchange | Draw 2 from Court deck, choose which to keep, return 2 |
...
| Ambassador | Exchange (2 cards from Court) | Stealing |
| Contessa | -- | Assassination |
