...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/dungeon-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Dungeon%21&game=dungeon)
<!-- verification:end -->
...
1. Each player chooses a Hero class and places their standee in the Great Hall.
2. Sort Monster and Treasure cards into piles by Level (face down).
3. Wizards start with a set number of Spell cards.

## Turn Structure

On your turn, follow these steps in order:
1. **Move** — Move up to 5 spaces
2. **Encounter** — Check for monsters in the room/chamber
3. **Combat** — Fight the monster if present
4. **Loot** — Collect treasure if victorious
...
| Roll | Result |
|---|---|
| 12+ | **Killed!** Drop all Treasure. Choose a new Hero; place in Great Hall. |
| 11 | **Seriously Wounded:** Drop half your Treasure (round up, random). Return to Great Hall. |
| 8-10 | **Wounded:** Drop 1 random Treasure. Move back 1 space. Take 1 Lose a Turn token. |
| 6-7 | **Stunned:** Drop 1 random Treasure. |
| 5 or lower | **Miss!** No effect. |
...
**Treasure Goals:** Cleric/Rogue: 10,000 gp | Fighter: 20,000 gp | Wizard: 30,000 gp

**Secret Doors:** Roll 1d6: 5-6 (Rogue: 3-6)

**Clearing:** Rooms: 1 token | Chambers: 3 tokens
