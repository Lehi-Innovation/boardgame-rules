...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Pentominoes&game=pentominoes)
<!-- verification:end -->
...
- 12 pentomino pieces (each made of 5 unit squares in unique shapes, often named with letters: F, I, L, N, P, T, U, V, W, X, Y, Z)
- 1 game board (8x8 grid for competitive play, or various rectangular grids for puzzle play)
...
- Each pentomino piece is unique; no two pieces have the same shape (when accounting for rotation and reflection).
- In competitive play, pieces cannot be moved once placed.
- Pieces must align with the grid squares; partial placement is not allowed.
- The total area of all 12 pieces is 60 squares (12 x 5), which exactly fills a 6x10, 5x12, 4x15, or 3x20 rectangle.
- Parker Brothers published a multi-player version called "Universe" in 1966.
