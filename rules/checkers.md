...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/checkers-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Checkers&game=checkers)
<!-- verification:end -->
...
- 1 draughtboard: 64 squares (8x8), alternately light and dark
- 12 dark-colored pieces (Red)
- 12 light-colored pieces (White)
- Official board colors: green and white/cream squares; red and white pieces
...
- Specific endgame piece configurations that are proven draws.

## Special Rules & Edge Cases

- **Touch rule:** If you touch a piece on your turn, you must move it (unless announcing an adjustment first). If any part of a piece crosses a corner of its square, you must move in that direction.
- **Illegal moves:** First offense results in a caution and the move is recalled. Subsequent illegal moves in the same game result in forfeiture.
- An illegal move is pardoned if the opponent makes their next move without objecting.
- If pieces are accidentally displaced, replace them without penalty.
- A man cannot jump backward.
- A man cannot continue capturing through the king-row without being crowned (the crowning ends the turn).
- Each piece may only be jumped once during a single multiple-jump sequence.
...
- Reaching king-row = promotion (turn ends)
- King moves/captures in all 4 diagonal directions
- Cannot jump same piece twice in one sequence
