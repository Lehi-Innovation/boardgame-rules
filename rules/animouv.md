...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Animouv&game=animouv)
<!-- verification:end -->
...
2. Place animal counters at random on the squares indicated on the board.
3. Shuffle the objective cards and place them face-down as a draw pile.
4. Each player draws one objective card showing 3 animals they must align.
...
1. **Move one animal counter** on the board (any animal, not just those on your card).
2. **Check for completed objectives:** If your 3 target animals are now in a line, claim the card.
3. **Draw a new card** if you completed your objective.
...
| Action | Description |
|--------|-------------|
| Slide | Move one animal to an adjacent free square |
| Jump | Leap over adjacent pieces in a line (pieces stay) |
| Claim card | When your 3 animals form a line (any direction) |
| Draw card | Take a new objective after claiming one |
| Win condition | Most cards collected when draw pile is empty |
