---
title: "Elasund: The First City"
bgg_id: 21953
player_count: "2-4"
play_time: "60-90 min"
designer: "Klaus Teuber"
source_pdf: "elasund-the-first-city-rules.pdf"
...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/elasund-the-first-city-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Elasund%3A%20The%20First%20City&game=elasund-the-first-city)
<!-- verification:end -->
...
1. Place the game board. Set the available city space based on player count (marked by City Gates).
2. Each player takes their colored buildings, Building Permits, and 10 Victory Point Cubes.
3. Each player places their two starter buildings (Workers' Huts) on the board.
4. Place the Trade Ship on a starting sea space.
5. Shuffle Gold and Influence Card decks.
6. Place Church tiles in a stack. Place City Wall tiles for each player.
7. Place a player disc on the Trade Point track at the starting position.
