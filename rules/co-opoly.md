...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Co-opoly&game=co-opoly)
<!-- verification:end -->
...
3. At the start, all players collectively decide what kind of cooperative they want to run (can be realistic like a coffee shop or whimsical like a dragon art school).
4. Place the co-op marker on the board.
5. Shuffle Challenge and World card decks.
6. Set initial individual and co-op pool points.

## Turn Structure

On each turn:
1. **Roll and move** the co-op marker around the board.
2. **Resolve the space** — draw Challenge cards, World cards, or receive bonuses.
3. **Complete challenges** cooperatively using mini-games.
4. **Manage points** between individual pools and the co-op pool.
...
| Challenge Types | Charades, Drawing, Unspoken (word-guessing) |
|----------------|---------------------------------------------|
| Point Pools | Individual (per player) + Co-op fund (shared) |
| Win Condition | Open a second cooperative location |
| Loss Condition | Co-op fund or all individual points depleted |
| World Cards | Random external events (positive or negative) |
