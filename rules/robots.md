...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Robots%21&game=robots)
<!-- verification:end -->
...
- Small hex map of a planetary surface
- Robot assembly cards/tokens with modular parts
- Factory ship counters (2 per player)
- Q-ship counter (1 per player)
- Resource area markers
- Combat resolution chart
- Dice
- Rules sheet (microgame format)
...
- Robot assembly is random, creating unique robots each game with different strengths and weaknesses.
- Factory ships are vulnerable but essential for building new robots.
- Q-ships provide military capability but cannot produce robots.
- Terrain on the hex map affects movement and may provide defensive bonuses.
- The microgame format means rules are streamlined; games are relatively quick.
