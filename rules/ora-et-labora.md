...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/ora-et-labora-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Ora%20et%20Labora&game=ora-et-labora)
<!-- verification:end -->
...
- Game board with production wheel
- Estate boards (land strips for building)
- Building cards (numerous, different for France/Ireland variants)
- Settlement cards
- Resource tokens (wood, clay, peat, grain, coins, livestock, etc.)
- Production wheel with resource markers
- Clergy figures (Prior, Lay Brother, monks)
- Landscape tiles
...
**Scoring:**
- Each building has a printed VP value
- Settlements score based on surrounding buildings
- Dwelling value depends on economic development
- Resources may convert to VP through specific buildings
- Coins count as VP
...
- **Production wheel:** Resources accumulate on the wheel over time. When you take a resource, you take ALL accumulated units.
- **Clergy:** Each player has limited Clergy. They must be managed carefully as they are tied up when using buildings.
- **Settlements:** Special buildings that score based on the economic value of buildings in their settlement group.
- **Two variants:** France includes wine and bread production chains; Ireland includes whiskey and peat production chains. Different building cards for each.
- **Landscape expansion:** Players can buy coastal, hillside, and mountain tiles to extend their estate.
- **Prior vs. Lay Brother:** The Prior is more flexible; the Lay Brother has restrictions on which buildings he can use.
- Solo rules included.
