...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/chromino-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Chromino&game=chromino)
<!-- verification:end -->
...
- 5 Chameleon Chromino tiles (2 colored squares + 1 wild center square marked with a special symbol)
- 1 cloth bag for drawing tiles
- Game instructions with Conundrum puzzle on reverse
...
- If the bag runs out of tiles and a player cannot place any tile from their hand, they simply pass.
- The minimum placement requirement is always 2 matching color contacts.
- Tiles cannot be rotated or flipped once placed.
...
**Key rules:**
- 2+ color contacts required per placement
- Chameleon center = wild color
- Cannot play a Chameleon as your last tile
- Last tile must be revealed face-up
- Joint winners possible if multiple players go out in the same turn
