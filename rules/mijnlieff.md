...
source_pdf: "mijnlieff-rules.pdf"
...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/mijnlieff-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Mijnlieff&game=mijnlieff)
<!-- verification:end -->
...
- 1 four-by-four game board (16 squares)
- 8 light pieces (2 each of 4 types)
- 8 dark pieces (2 each of 4 types)
...
- Line of 3 = 1 point
- Line of 4 = 3 points (in some variants)
...
- Dark always considers the piece Light played to determine where Dark must play, and vice versa.
- Alternating pieces do not block each other's path.
- After a player places all 8 pieces, the opponent gets exactly one more turn.
- If both players pass in sequence, the next player gets a free play (any empty square).
- The game is purely abstract with no randomness.
- In an Advanced Game, longer scoring lines (line of 4) are achievable for bonus points.
