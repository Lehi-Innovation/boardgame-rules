...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Go%20Nuts%21&game=go-nuts)
<!-- verification:end -->
...
1. Each player receives one dog die.
2. Place the five squirrel dice in the center of the table.
3. One player is designated as scorekeeper with the score pad.
...
1. **Roll all five squirrel dice** simultaneously.
2. **Set aside cars** -- any dice showing cars are removed from play for this turn.
3. **Count acorns** -- each die showing an acorn scores 1 point.
4. **Decide:** Either stop and bank your accumulated points, or re-roll all remaining dice showing squirrels (and acorns, which stay in play but are re-rolled).
5. Repeat steps 2-4 until you choose to stop or are forced to stop.
