...
source_pdf: "eile-mit-weile-rules.pdf"
...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/eile-mit-weile-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Eile%20mit%20Weile&game=eile-mit-weile)
<!-- verification:end -->
...
- 1 game board (cross-shaped track with colored home areas and starting bases)
- 16 playing pieces (4 per player in 4 colors)
- 1 six-sided die
...
### Rolling a 6
When you roll a 6:
- You must enter a new piece onto the board if any remain in your starting base.
- If all pieces are already on the board, move any one piece forward 6 spaces.
- You get an additional roll after rolling a 6.
- **Three consecutive 6s:** If you roll 6 three times in a row, your turn ends immediately and the last piece moved returns to the starting base as a penalty.
...
- You cannot skip entering a piece when you roll a 6 and have pieces in the starting base -- entering takes priority.
- Pieces in the home column are safe from capture.
- You must roll the exact number to enter each home space -- excess movement means you cannot move that piece.
- Landing on your own piece is not allowed; you must move a different piece or forfeit the move.
- The three-consecutive-6s penalty prevents abuse of the bonus turn mechanic.
- If you cannot make any legal move with your roll, your turn is skipped.
- The game is purely luck-based at its core, but deciding which piece to move offers some tactical choice.
