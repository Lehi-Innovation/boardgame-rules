...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/elysium-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Elysium&game=elysium)
<!-- verification:end -->
...
1. Choose 5 of the 8 Families. Shuffle their 105 cards; deal cards to the Agora (1 + 3x players).
2. Place Pediment (random side up), Quests in ascending order below it, Steps board below Quests.
3. Each player takes a board, 4 Columns (one each of 4 colors), 4 Gold, and VP equal to their Disc number.
4. Disc #1 = first player (random). Discs assigned clockwise in order.
5. Place Epoch Marker on space 1. Set up Family-specific components (Oracle for Apollo, PP for Ares).
...
1. Reallocate Discs based on Quest numbers taken this Epoch.
2. Receive VP and Gold shown on your Quest.
3. In new Disc order, each player may transfer cards from Domain to Elysium. Transfers limited by Quest's Lyre number. Each transfer costs Gold equal to the card's Level (1/2/3).
