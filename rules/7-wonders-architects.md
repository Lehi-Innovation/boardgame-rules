...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/7-wonders-architects-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%207%20Wonders%3A%20Architects&game=7-wonders-architects)
<!-- verification:end -->
...
**Per player:**
1. Choose a Wonder tray (or take one randomly).
2. Remove the 5 Wonder pieces and assemble with Under Construction side face-up.
3. Shuffle your personal cards and place face-up in the holder between you and the player to your left.
...
1. **Choose a card** from one of 3 available sources:
   - Top card of the deck to your left
   - Top card of the deck to your right
   - Top card of the central deck
2. **Place it** face-up in front of you near your Wonder.
3. **Resolve actions** based on your cards and tokens (in any order):
...
4. Your turn ends when no more actions can be taken.
...
| Wonder stages | 5 per player |
| Card types | Grey (resources), Yellow (coins), Blue (VP), Red (military), Green (science) |
| End trigger | Any player completes their Wonder |
| Scoring | Wonder stages + Cat + Blue cards + Military tokens + Progress tokens |