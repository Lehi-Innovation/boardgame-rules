...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/mycelia-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Mycelia&game=mycelia)
<!-- verification:end -->
...
- Terrain tiles (hexagonal, various types)
- Mushroom pawns (in player colors)
- Spore tokens
- Fruit tokens
- Discovery cards
- Decay tokens
...
- Territory control (connected areas)
- Discovery card bonuses
...
- Spores must grow into mushrooms before they can fruit.
- Terrain types affect which mushrooms can grow and fruit there.
- Discovery cards provide unique strategic options each game.
- Solo mode includes an automated opponent.
