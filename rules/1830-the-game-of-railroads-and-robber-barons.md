...
---
<!-- verification:begin -->
> ❗ **Known errors** — an audit found inaccuracies in this summary that could mislead players: Invented rules: corporation "closes" on failed train purchase (source: receivership), invented 7-train "Phase D" with wrong grey-tile timing, private-company sale price contradicted (half to double face value). Until it is re-written, prefer the full rulebook text linked below.
>
