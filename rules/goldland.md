...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Goldland&game=goldland)
<!-- verification:end -->
...
1. Place the starting tile at one corner of the play area.
2. Each player takes a backpack board and an explorer meeple.
3. Players place their explorers on the starting tile.
4. Shuffle the terrain tiles and stack them face down.
5. Set aside the temple tile (it will be placed when the opposite corner is reached).
6. Prepare resource tokens, tent markers, and scoring components.
