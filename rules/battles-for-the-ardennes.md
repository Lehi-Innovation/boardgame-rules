...
source_pdf: "battles-for-the-ardennes-rules.pdf"
...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/battles-for-the-ardennes-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Battles%20for%20the%20Ardennes&game=battles-for-the-ardennes)
<!-- verification:end -->
...
1. **Game-Turn Interphase**: Determine weather, check supply, adjust markers.
2. **First Player-Turn**
...
3. **Second Player-Turn**: Same Movement and Combat Phases.
4. **End of Game-Turn**: Advance the turn marker.
...
| Scenario | Battle | Focus |
|---|---|---|
| St. Vith | Dec 16-23 | Defense of crossroads |
| Clervaux | Dec 16-18 | German breakthrough |
| Celles | Dec 23-26 | Deepest penetration |
| Sedan | May 1940 | Meuse River crossing |

| Movement Mode | Speed | Combat Restriction |
|---|---|---|
| Normal | Standard MA | Full combat |
| March Mode | Enhanced | Cannot attack, reduced defense |
