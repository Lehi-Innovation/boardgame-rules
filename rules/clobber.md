...
player_count: "2"
play_time: "15 min"
designer: "Michael H. Albert, J.P. Grossman, Richard Nowakowski"
...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Clobber&game=clobber)
<!-- verification:end -->
...
- Rectangular grid board (typically 5x6 or 10x10 for tournament play)
- White stones and black stones (enough to fill every square)
...
- Diagonal movement is not allowed; only horizontal and vertical.
- You must clobber an opponent's stone; you cannot move to an empty square.
- As the game progresses, the number of possible moves decreases as stones are removed.
- The game is a pure combinatorial game with no hidden information or randomness.
- Tournament play typically uses a 10x10 board; casual play uses smaller boards.
- Clobber has been studied extensively in combinatorial game theory.
