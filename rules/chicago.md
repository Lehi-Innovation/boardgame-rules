...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Chicago&game=chicago)
<!-- verification:end -->
...
**Additional Points:**
- Winning the final (5th) trick in Phase 3: 5 points
- Successful "Chicago" declaration: 15 bonus points
- Failed "Chicago" declaration: -15 points

**Winning:** The first player to reach 52 points wins the game.

## Special Rules & Edge Cases

- Only the single highest poker hand each phase scores; other players receive nothing.
- The "Chicago" declaration requires a minimum of 15 accumulated points. If declared, the player must win all 5 tricks or lose 15 points.
- Players with 46 or more points cannot discard in subsequent rounds (they play with their dealt hand).
- If breaking a winning poker hand to use those cards in trick-taking, the hand must be shown to all players.
- Ties in poker hands follow standard poker tiebreaker rules (highest kicker, etc.).
