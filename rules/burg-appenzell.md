---
title: "Burg Appenzell"
bgg_id: 28089
player_count: "2-4"
play_time: "30 min"
designer: "Jens-Peter Schliemann, Bernhard Weber"
source_pdf: "burg-appenzell-rules.pdf"
...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/burg-appenzell-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Burg%20Appenzell&game=burg-appenzell)
<!-- verification:end -->
...
6. Each player takes all 4 mice of one color. Each player places one of their mice in an unoccupied corner tower. The remaining mice are placed in front of the player.
...
- A space is "neighboring" to the space your mouse is on.
...
- A player may move their mouse from one space to a neighboring space in any cardinal direction. Running diagonally is not allowed.
- The mice may not run on or over roofs.
- Only one mouse may stand in a space. A mouse may not enter an occupied space.
...
- If **two of your mice** are standing on **spaces with the same kind of cheese**, you take the collecting tile with that kind of cheese from the supply.
- You may collect each kind of cheese only once.

**Winning:**
- The game ends as soon as a player has collected **4 different kinds of cheese**. This player has won the game.
- The game also ends when a player's third mouse plops into the cellar dungeon.
...
- **Cheese to win:** 4 different kinds
