...
---
<!-- verification:begin -->
> ❗ **Known errors** — an audit found inaccuracies in this summary that could mislead players: Invented rules (tower entry ban, safe elevated spaces, end-game tiebreak procedure, 5/6-cheese variant, roof counts); omits start placement of a mouse in a corner tower. Until it is re-written, prefer the full rulebook text linked below.
>
