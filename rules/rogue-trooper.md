...
source_pdf: "rogue-trooper-rules.pdf"
...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Rogue%20Trooper&game=rogue-trooper)
<!-- verification:end -->
...
- 1 map board depicting Nu-Earth
- 6 plastic GI playing pieces
- 6 character sheets
- 1 Traitor playing piece and base
- 1 counter sheet (70 counters)
- 283 playing cards (encounters, items, weapons, clues)
- GI's Battle Manual (rules booklet)
...
- The Traitor's identity is determined randomly at the start and kept hidden. Clue cards provide elimination information.
- Nu-Earth is a hostile environment; random encounters can wound or kill GIs even without direct combat.
- Character sheets track wounds, ammunition, and equipment. Running out of ammunition limits combat options.
- GIs have biochips (from fallen comrades) that can provide special abilities.
- The Traitor piece may move on the board according to specific rules, making the hunt dynamic.
- Multiple GIs can cooperate in encounters but ultimately compete to find the Traitor first.
