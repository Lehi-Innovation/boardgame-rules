...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/downfall-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Downfall&game=downfall)
<!-- verification:end -->
...
1. Place the 4 rubber feet into the sockets on the bottom of the base.
2. Place the base right-side-up on the table.
3. Attach the upright frame by positioning the latches into the holes in the base, then push the frame down until the latches click into place.
4. Place the game so that neither player can see the opponent's side.
5. Set all dials to the starting position with slots lined up.
6. Fill the chute with your 5 disks in 1-2-3-4-5 order, starting with "1."

## Turn Structure

Players alternate turns. On your turn:
1. Turn **any one** of the 5 dials **slowly** in either direction, as far as you like.
2. You may continue turning the dial even after a disk has fallen through or out of it.
3. A disk may fall into one of the two slots next to it (e.g., from dial 2 to dial 1 or dial 3, from dial 3 to dial 2 or dial 4).
