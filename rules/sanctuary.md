...
source_pdf: "sanctuary-rules.pdf"
...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Sanctuary&game=sanctuary)
<!-- verification:end -->
...
1. **Draw Rumor/Event**: Draw a card that indicates a potential robbery opportunity or an event that affects the city.
2. **Move**: Move your thief pawn through the streets of Sanctuary toward the rumor location or your cache.
3. **Encounter**: If you encounter guards or Hell Hounds, attempt to evade or deal with them.
4. **Rob**: If at a rumor location, attempt the robbery to gain silver pieces.
5. **Cache**: If at your secret cache location, deposit silver pieces for safekeeping.
...
| Action | Effect |
|--------|--------|
| Move | Navigate city streets |
| Rob | Attempt robbery at rumor location |
| Cache | Deposit silver at secret cache |
| Evade | Attempt to avoid guards |
