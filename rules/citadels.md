...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/citadels-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Citadels&game=citadels)
<!-- verification:end -->


## Overview

Citadels is a card-drafting and city-building game where players secretly select character roles each round to gain special powers. Players build district cards in their city by paying gold, racing to be the first to build eight districts. The game combines bluffing, deduction, and strategic planning as players try to predict which characters their opponents have chosen.

## Components

- 18 character cards (8 basic + 10 bonus, marked with white star)
- 80 district cards (14 bonus purple cards marked with white star)
- 30 gold counters
...
1. Remove bonus character and district cards (white star) for the first game.
2. Shuffle the 8 basic character cards into the Character Deck.
3. Shuffle district cards into the District Deck.
4. Deal 4 district cards to each player.
5. Each player receives 2 gold from the bank.
6. The oldest player receives the Crown marker.
...
- Draw 2 district cards from the District Deck, keep 1, place the other at the bottom of the deck.
...
- Exchange your entire hand with another player's hand (even if you have no cards), OR
- Discard any number of cards face-down to the bottom of the District Deck and draw an equal number from the top.
...
### Bonus Cards
- Bonus characters replace original characters of the same rank number (agreed before the game).
- Bonus purple districts can be added (2-3 recommended; remove existing purples if adding more).

### Special District Cards
- **Quarry:** May build duplicate districts (max 2 identical). Effect persists even after Quarry is destroyed.
- **Graveyard:** Pay 1 gold to take a district destroyed by the Warlord into your hand. Cannot save itself.
- **Observatory:** Draw 3 district cards, keep 1.
- **Library:** Keep both drawn district cards.
- **Bell Tower:** Game ends at 7 districts instead of 8 (affects all bonuses).
