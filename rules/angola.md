...
designer: "Nick Smith, Peter Wingrove, Jeremy Sherlock"
...
---
<!-- verification:begin -->
> ❗ **Known errors** — an audit found inaccuracies in this summary that could mislead players: Summary is fabricated: invented 6-phase turn structure and supply/attrition system (actual: 3 phases driven by Operations Cards), omits FAPLA faction and alliance victory, invents components and victory conditions, wrong designer. Until it is re-written, prefer the full rulebook text linked below.
>
> 📄 [Full rulebook text](https://jonnyallred.github.io/boardgame-rules/extracted/angola-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Angola&game=angola)
<!-- verification:end -->
...
- Unit counters for each faction (infantry, armor, artillery, etc.)
- Political markers
- Supply and logistics markers
- Turn track
...
- Foreign intervention (Cuba, South Africa) is triggered by game events and can dramatically shift the balance.
- Supply lines are critical -- unsupplied units suffer attrition.
- Some regions have strategic value for political reasons.
- Diplomatic events can change alliances and force negotiations.
- The game includes asymmetric faction abilities reflecting historical capabilities.
