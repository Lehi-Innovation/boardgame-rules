...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Belratti&game=belratti)
<!-- verification:end -->
...
1. Distribute character cards: some players become museum manager Cat, others become painter Owl. Roles rotate clockwise each round.
2. Deal picture cards based on player count:
   - **3 players:** 18 cards each
   - **4-5 players:** 9 cards each
   - **6-7 players:** 6 cards each
3. Set aside the draw pile.
...
| Scoring | Points |
|---------|--------|
| Correct painting placement | +1 team |
| Fake accepted into museum | +1 Belratti |
| Team win threshold | 15 points |
| Belratti game-end trigger | 6 points |
| Belratti fakes per round | 4 cards |
