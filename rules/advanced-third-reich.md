...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Advanced%20Third%20Reich&game=advanced-third-reich)
<!-- verification:end -->
...
1. **Strategic Warfare Phase**: Conduct strategic bombing, submarine warfare, and other strategic operations.
2. **Diplomacy Phase**: Attempt to influence neutral nations and manage alliances.
3. **Economic Phase**: Calculate income from controlled territories, pay for units, manage BRPs (Basic Resource Points).
4. **Unit Construction Phase**: Build new units and replacements using BRPs.
5. **Movement Phase**: Move land, air, and naval units.
6. **Combat Phase**: Resolve ground, air, and naval battles.
7. **Exploitation Phase**: Armored and mechanized units may move and attack again.
8. **Redeployment Phase**: Strategic redeployment of units.
