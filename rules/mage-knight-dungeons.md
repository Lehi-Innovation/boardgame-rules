---
title: "Mage Knight Dungeons"
bgg_id: 2876
player_count: "2-5"
play_time: "60-120 min"
designer: "Jordan Weisman, Kevin Barrett"
source_pdf: "mage-knight-dungeons-rules.pdf"
...
1. Select a dungeon scenario or build a dungeon using map tiles.
2. Each player builds a Hero warband of an agreed-upon point value (typically 200-300 points).
3. Place monsters and treasure chests as indicated by the scenario.
4. Place Hero teams at the dungeon entrance.
...
1. **Move** -- Move figures up to their speed value.
2. **Attack** -- Make close combat or ranged attacks against adjacent or visible enemies.
3. **Interact** -- Open treasure chests, use special abilities, or interact with dungeon features.
...
| Action | Description |
|--------|-------------|
| Move | Move up to speed value in squares |
| Close Combat | Roll 2d6 + attack vs. defense; if hit, deal damage |
| Ranged Combat | Same as close, but at range |
| Open Chest | Adjacent to chest; collect gold |
| Special Ability | Use figure's unique power |
