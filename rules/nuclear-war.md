...
source_pdf: "nuclear-war-rules.pdf"
...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/nuclear-war-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Nuclear%20War&game=nuclear-war)
<!-- verification:end -->
...
- 20 Population cards (denominations: 1 million, 2 million, 5 million, 10 million, 25 million)
- 100 Nuclear War cards (warheads, delivery systems, propaganda, anti-missile, secret, top secret)
- 2 Ten-sided dice
- Player placemats (with spaces for face up card, two face down cards, two deterrent cards, and population)
...
3. Place remaining population cards in a central bank.
4. Shuffle the Nuclear War deck. Deal 9 cards to each player. Place the rest face down as the draw pile.
...
- A player is eliminated when their population reaches 0.
- **The last player with at least 1 million population wins.**
- It is possible for no one to win (mutual annihilation via chain reaction of final retaliations).

## Special Rules & Edge Cases

- **State of Peace / State of War:** Once a warhead target is selected, war begins. Propaganda cards are ineffective during war. Peace is restored only after at least one player is eliminated. Upon restoration of peace, players may replace one or two face-down cards.
- **Final Retaliation:** An eliminated player (by weapons, not propaganda) may immediately launch all remaining weapon combinations. Targets are announced before rolling. If final retaliation eliminates another player, that player also retaliates, creating potential chain reactions.
- **Self-destruction:** If you draw a secret/top secret that eliminates your own population, you still get final retaliation.
- **Delivery system compatibility:** Each delivery system lists a maximum warhead size; any warhead at or below that number can be carried.
- **Anti-missile bluffing:** Even players without anti-missile cards must indicate they are not intercepting, to prevent revealing hand information.
