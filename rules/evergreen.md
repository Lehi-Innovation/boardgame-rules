...
source_pdf: "evergreen-rules.pdf"
...
---
<!-- verification:begin -->
> ❗ **Known errors** — an audit found inaccuracies in this summary that could mislead players: Fertility scoring counts "planted spaces" but source says Big Trees only; Lake end-game scoring is invented with no source support; tiebreaker wrong (Big Trees vs turn order position). Until it is re-written, prefer the full rulebook text linked below.
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/evergreen-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Evergreen&game=evergreen)
<!-- verification:end -->
...
1. Each player takes a Planet board with cylinder markers on: each Power Track start, Score Track start, 50+ Points Track start, and Season Track topmost space.
2. Place Sun marker at top of Planet board.
3. Shuffle Biome cards into a face-down deck. Reveal cards until at least 5 Fertility icons appear. Cards with Fertility icons go to the Fertility Zone; others are shuffled back.
4. Random first player gets First Player token. Starting points by turn order: 1st=0, 2nd=1, 3rd=2, 4th=3.
...
### Season Scoring
1. **Light Scoring:** The Sun shines from its current position. Each visible Tree scores points based on its size (Small Tree = 1, Big Tree = 2). Trees in shadow (behind taller or equal Trees from the Sun's perspective) score nothing.
2. **Largest Forest:** Score points equal to the number of connected planted spaces in your largest group of adjacent planted spaces.
3. Rotate the Sun clockwise to the next position.
