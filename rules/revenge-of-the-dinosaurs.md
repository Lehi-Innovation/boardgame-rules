---
title: "Revenge of the Dinosaurs"
bgg_id: 14982
player_count: "2-5"
play_time: "20-30 min"
designer: "Unknown"
source_pdf: "revenge-of-the-dinosaurs-rules.pdf"
...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Revenge%20of%20the%20Dinosaurs&game=revenge-of-the-dinosaurs)
<!-- verification:end -->
...
2. Each player selects a plastic dinosaur figure and places it on the starting space.
3. Place the Tyrannosaurus Rex figure in its designated position (center or special space).
4. Determine who goes first (youngest player).

## Turn Structure

On each turn:

1. **Roll the Die:** Roll the standard die.
2. **Move Your Dinosaur:** Move your dinosaur forward along the track the number of spaces shown.
3. **Resolve Space:** Follow any instructions on the space you land on:
...
4. **Check for T. Rex:** If the T. Rex catches your dinosaur (by landing on the same space or via special rules), your dinosaur is sent back to the start or a penalty position.
...
| Space Type | Effect |
|---|---|
| Regular | Move forward normally |
| T. Rex Encounter | Risk being sent back |
| Bonus | Extra move or advantage |
| Hazard | Lost turn or move backward |
