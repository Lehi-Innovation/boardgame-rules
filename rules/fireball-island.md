...
source_pdf: "fireball-island-rules.pdf"
...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/fireball-island-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Fireball%20Island&game=fireball-island)
<!-- verification:end -->
...
- 1 Gameboard (3D molded island with trails, bridges, caves)
- 4 Plastic playing pieces (explorers)
- 1 Three-piece Idol (Vul-Kar)
- 2 Two-piece bridges
- 1 Deck of 48 cards
- 4 Plastic tokens
- 5 Red fireball marbles
- 1 Red jewel
- 1 Die
- 1 Rulebook
...
- Count each space as you move. Count every space whether it's occupied or not.
- If you land on a space occupied by an opponent's playing piece, move to the next open space.
- Move your playing piece the full count. You may have to stop short of your full count if you move onto a Special Space (see below).
- If you roll a "1" on the die, don't move your playing piece along the trail. Instead, you are ROLLING A FIREBALL on page 9. (You may still play a card.)
- Move along the trails in any direction, as long as you don't move along the same space twice during one move.
...
- **Rolling a 1**: Always triggers a fireball roll instead of normal movement.
- **Card Limit**: Maximum 4 cards in hand. If at 4, must use at least one before drawing.
- **Jewel Capture Bonus**: 3 full turns in a row, fill hand to 4 cards, roll a fireball.
- **Stealing the Jewel**: Only by passing the owner on a trail or bridge (not in caves or penalty areas).
- **Safe from Fireballs**: Some trails and spaces are not affected by rolls (dark gray trails and spaces).
- **Bridge Contact**: You cannot avoid landing on a bridge; it always counts as a space.
- **Cave Dead End**: Cave 4 is a dead end; you must roll to move to another cave.
- **Fireball Cannot Be Canceled**: The FIREBALL! card is the only card that cannot be canceled.
...
### Key Rules
- Steal the jewel by passing the owner on a trail/bridge
- Getting fireballed: move to penalty area, skip next turn
- Caves: roll die to determine which cave you exit from
- Dock: no exact landing required to win
- Maximum 4 cards in hand
