...
designer: "Uncredited"
source_pdf: "by-the-sword-rules.pdf"
...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20By%20the%20Sword%21&game=by-the-sword)
<!-- verification:end -->
...
1. Select armies for each player from the available counter sheets.
2. Arrange terrain on the playing surface according to the scenario or mutual agreement.
3. Each player deploys their army within their designated deployment zone.
...
2. **Movement Phase:** Move units according to their movement rates (measured in centimeters).
3. **Ranged Combat Phase:** Resolve missile fire (archery, spells, etc.).
4. **Melee Combat Phase:** Resolve close combat between engaged units.
5. **Morale Phase:** Check morale for units that took casualties or are in unfavorable positions.
...
| Movement | Move units (cm-based measurement) |
| Ranged Combat | Missile fire and spells at range |
| Melee Combat | Close combat resolution |
| Morale | Check unit morale |
