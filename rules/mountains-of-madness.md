...
play_time: "60-90 min"
designer: "Rob Daviau"
source_pdf: "mountains-of-madness-rules.pdf"
...
- 1 game board (mountain path with encounters)
- 30 Equipment cards (5 types)
- Encounter tiles (for each mountain stage)
- Madness cards (various behavioral restrictions)
- Injury tokens
- Relic tokens
- Leader token
...
- **Success**: Gain rewards (relics, healing, equipment).
- **Partial Success**: Some benefit but also some penalty.
- **Failure**: Gain Madness cards, Injuries, or other penalties.
...
- Speak only in one-word sentences
- Keep one hand on your head
- Cannot say numbers
- Must disagree with everything suggested
...
- Madness restrictions are behavioral and must be followed during the 30-second discussion only, not during card play.
- Players may not show their cards during discussion.
- Overplaying cards (more than needed) may trigger negative effects.
- Relics are needed for the final escape; too few = loss.
- Some encounters have special conditions beyond card requirements.
