...
play_time: "30 min"
designer: "Bill Payne"
source_pdf: "villa-paletti-rules.pdf"
...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Villa%20Paletti&game=villa-paletti)
<!-- verification:end -->
...
1. Place the base plate centrally on the table.
2. All players place their columns on the base plate in any arrangement.
3. Place the blue floor (largest) on top of the columns, not extending beyond the base plate.
4. The youngest player rolls the Master Builder Seal and selects a color. Other players choose colors in turn order. The last player to choose becomes the starting player.
...
| Floor | Order | Size |
|---|---|---|
| Blue | 1st (placed at setup) | Largest |
| Yellow | 2nd | Large |
| Orange | 3rd | Medium |
| Red | 4th (final) | Smallest |
