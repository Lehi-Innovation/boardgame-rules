---
title: "Give Me the Brain!"
bgg_id: 176
player_count: "3-8"
play_time: "30 min"
designer: "James Ernest"
source_pdf: "give-me-the-brain-rules.pdf"
...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Give%20Me%20the%20Brain%21&game=give-me-the-brain)
<!-- verification:end -->
...
- Job cards (various types: brainless jobs, brain jobs, special cards)
- 1 six-sided die
- Brain token (or the die itself serves as the brain indicator)
- Rules card
...
- **Brainless jobs:** Can be played regardless of whether you have the brain. Place them on the discard pile.
- **Brain jobs:** Can only be played if you currently hold the brain. After playing, roll the die to see if you keep the brain or fumble it.
- **Special cards:** Have unique effects (steal the brain, force others to draw cards, etc.).
...
Roll the die:
- **Even result (2, 4, 6):** You keep the brain.
- **Odd result (1, 3, 5):** You fumble the brain. It goes to the center of the table (no one has it). On future turns, a player can attempt to pick up the brain by rolling even.
...
- Steal the brain from another player
- Force opponents to draw additional cards
- Play multiple jobs at once
...
| Roll | Effect |
|------|--------|
| Even (2, 4, 6) | Keep/gain the brain |
| Odd (1, 3, 5) | Fumble/fail to pick up brain |

**Key Rules:**
| Rule | Detail |
|------|--------|
| Players | 3-8 |
| Win condition | Empty your hand |
| Brainless jobs | Play anytime |
| Brain jobs | Need the brain; roll after |
| Fumbled brain | Goes to center; costs a turn to attempt pickup |
