...
play_time: "5 min"
designer: "Unknown"
source_pdf: "crocodile-dentist-rules.pdf"
...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/crocodile-dentist-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Crocodile%20Dentist&game=crocodile-dentist)
<!-- verification:end -->
...
1. Open the crocodile's mouth wide and press all teeth back into the upright position.
2. The crocodile randomly sets one tooth as the trigger.
...
|------|--------|
| Players | 2-4 |
| Turn action | Press 1 tooth |
| Sore tooth | Random each game |
| Elimination | Jaw snaps = out |
