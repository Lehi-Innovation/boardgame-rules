...
player_count: "2-6"
play_time: "60 min"
designer: "Stephen B. Ramp"
source_pdf: "klondike-rules.pdf"
...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/klondike-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Klondike&game=klondike)
<!-- verification:end -->
