...
player_count: "2-5"
play_time: "30 min"
source_pdf: "go-for-broke-rules.pdf"
...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/go-for-broke-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Go%20for%20Broke%21&game=go-for-broke)
<!-- verification:end -->
...
1. Each player receives $1,000,000 in play money, distributed in specific denominations.
2. Each player places their pawn on the starting space.
3. Choose a banker to manage the central money supply.

## Turn Structure

1. Roll two dice.
2. Move your pawn clockwise the number of spaces indicated.
3. Follow the instructions on the space you land on (usually spending money).
4. If you cannot fully pay, pay what you can.
