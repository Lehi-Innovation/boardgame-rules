---
title: "Chopstick Dexterity MegaChallenge 3000"
bgg_id: 25695
player_count: "2-3"
play_time: "15-30 min"
designer: "Seth Hiatt"
...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Chopstick%20Dexterity%20MegaChallenge%203000&game=chopstick-dexterity-megachallenge-3000)
<!-- verification:end -->
...
- 25 colored wooden shapes (various colors and shapes)
- 40 Disk tokens (Standard, Wild Shape, Wild Color, Number, All)
- 1 large central Bowl
- 3 small target Dishes
- 1 Final Round play board
- Rules
...
- Shapes knocked out of the bowl are returned and play continues.
- Chopstick-to-chopstick contact is permitted.
- Body contact (hands, face, etc.) is prohibited.
- Players may intentionally move the bowl.
- Shapes accidentally knocked into a Dish do not count but are not penalized.
- Non-targeted shapes placed in your Dish are ignored.
...
- Only chopsticks may touch the shapes in the bowl.
- Shapes must be fully in your Dish to count.
- If multiple players claim to have won simultaneously, replay the round.

## Player Reference

**Quick reference:**
- Standard Disk: match color + shape
- Wild Shape: most of a shape type
- Wild Color: most of a color
- Number: exact count first
- All: grab everything
