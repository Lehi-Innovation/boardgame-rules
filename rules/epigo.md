...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/epigo-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Epigo&game=epigo)
<!-- verification:end -->
...
- 1 game board (grid)
- 4 sets of numbered tiles in different colors (each set = 16 tiles: 8 Epigons numbered 1-7 plus 1 blank X Epigon, and 8 Orders numbered 1-7 plus 1 blank)
- Variant Book (for advanced play)
...
- If both Orders show the same number, they cancel each other out and neither Epigon moves.
- If the Order corresponds to an Epigon not on the board (already captured), no move is made. You may still need to use the Order to cancel one of your opponent's moves.
- You can accidentally slide or push your own Epigon off the board -- this gives your opponent a capture.
- As soon as any player captures three Epigons, the game ends immediately. You never get the chance to push your opponent's Epigon off the board if they captured your third first.
- Super Slide only triggers when no opponent Epigon sides are touched (corners do not count).
