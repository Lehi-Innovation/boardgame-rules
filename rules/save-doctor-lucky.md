---
title: "Save Doctor Lucky"
bgg_id: 1157
player_count: "3-7"
play_time: "20-40 min"
designer: "James Ernest"
source_pdf: "save-doctor-lucky-rules.pdf"
...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Save%20Doctor%20Lucky&game=save-doctor-lucky)
<!-- verification:end -->
...
1. **Move**: Move your pawn one room in any direction (or stay put).
2. **Draw a Card**: Draw one card from the deck.
3. **Doctor Lucky Moves**: Doctor Lucky moves along his preset path through the ship.
4. **Save Attempt** (optional): If you are in the same room as Doctor Lucky AND another player can see you, attempt to save him.
...
| Requirement | For a Save Attempt |
|-------------|-------------------|
| Same room as Doctor Lucky | Yes |
| Being observed by another player | Yes |
| Play a save card | Yes |
| Opponents play failure cards | They can try to block you |
