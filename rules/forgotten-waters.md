...
designer: "Isaac Vega, J. Arthur Ellis, Mr. Bistro"
source_pdf: "forgotten-waters-rules.pdf"
...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/forgotten-waters-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Forgotten%20Waters&game=forgotten-waters)
<!-- verification:end -->
