...
designer: "Bjorn Rabenstein"
source_pdf: "rolling-stock-rules.pdf"
...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Rolling%20Stock&game=rolling-stock)
<!-- verification:end -->
...
- Company cards (private companies and corporations)
- Stock certificates / share tokens
- Money in various denominations
- Market price track or card
- Foreign Investor card/token
- Turn order markers
- Reference cards
...
- Value of remaining private companies

The player with the highest total net worth wins.

## Special Rules & Edge Cases

- The Foreign Investor automates a non-player agent that buys and sells companies, creating market dynamics.
- Majority shareholder status determines corporate control; if another player buys enough shares, control can shift.
- Corporations that withhold dividends see their stock price decrease, potentially benefiting buyers.
- Share price tracks have upper and lower limits.
- Players may become temporarily cash-poor if over-invested, limiting their auction and share-buying ability.
- Corporate actions are decided solely by the majority shareholder, even if it disadvantages minority shareholders.
