---
title: "Deckscape: Escape from Alcatraz"
bgg_id: 295565
player_count: "1-6"
play_time: "60 min"
...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Deckscape%3A%20Escape%20from%20Alcatraz&game=deckscape-escape-from-alcatraz)
<!-- verification:end -->
...
1. Remove the deck from the box.
2. Do not shuffle the cards -- they must remain in order.
3. Prepare paper, pencil, and a timer.
4. Start the timer and begin reading card #1.

## Turn Structure

There are no individual turns. Players work cooperatively as a group:
1. Read the current card aloud.
2. Discuss and solve the puzzle or riddle.
3. When the group agrees on an answer, flip the card to check.
