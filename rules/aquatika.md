...
player_count: "2"
play_time: "15-20 min"
designer: "Alexandre Droit"
source_pdf: "aquatika-rules.pdf"
...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Aquatika&game=aquatika)
<!-- verification:end -->
...
2. Each player places their 9 pieces on their starting row: 3 Sharks, 3 Octopuses, and 3 Flying Fish.
...
1. **Move one piece** according to that piece type's movement rules.
2. **Apply any special abilities** triggered by the move (eating, covering, jumping).
3. **Check for victory:** If one of your pieces occupies the opponent's goal box, you win.
...
|-------|-------|----------------|
| Shark | 3 | Eats any piece it moves onto (friend or foe) |
| Octopus | 3 | Covers a piece; they move together; can release anytime |
| Flying Fish | 3 | Jumps over pieces in a straight line |
