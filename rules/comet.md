...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Comet&game=comet)
<!-- verification:end -->
...
2. Shuffle silver and golden animal card decks separately.
3. Deal starting hands of silver cards to each player.
4. Each player selects or is dealt an asymmetric hero card with unique abilities.
5. Place animal tokens on the starting areas of the island.
6. Set the comet track to its initial position.
7. Determine a starting player.

## Turn Structure

On your turn:
1. **Play cards** from your hand to perform actions (hatch animals, move animals, use abilities).
2. **Draw cards** to refill your hand.
3. **Check the comet track** — if triggered, advance the comet marker.
...
| Action | Requirement |
|--------|------------|
| Hatch Animal | Play matching animal card |
| Move Animal | Play card(s) for movement |
| Save Animal | Move animal to cavern |
| Use Hero Ability | Per hero card rules |
| Use Saved Ability | After animal is in cavern |

| Scoring | Source |
|---------|--------|
| Saved Animals | Rescue points on card |
| Set Bonuses | Collecting specific combinations |
| Hero Bonuses | Per hero card |
| Unsaved Animals | 0 points |
