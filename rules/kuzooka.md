...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20KuZOOkA&game=kuzooka)
<!-- verification:end -->
...
1. Place the game board (choose standard or high security side).
2. Each player takes one animal card with a unique power.
3. Shuffle the item card deck.
4. Set the round tracker to Round 1.
5. Place animal tokens at the start of the escape path.
