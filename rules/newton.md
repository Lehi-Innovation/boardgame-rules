...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/newton-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Newton&game=newton)
<!-- verification:end -->
...
- 1 Map board, 1 Tracks board, 4 Study boards
- 48 Bookshelf tiles, 24 Starting Action cards (6/player), 45 Action cards (3 levels), 20 Master cards
- 10 Objective tiles, 10 Invention tiles, 10 Specialization tiles, 20 Development tiles, 12 Income tiles
- 4 Medicine Income tiles, 7 City tiles, 6 University tiles, 3 Ancient Land tiles
- 18 Bonus tokens, 32 Coins, 20 Potion tokens
- 4 Scientists, 16 Students, 48 Travel cubes, 8 Player markers, 1 First Player token
...
- Spend a Potion to perform an additional basic action at value 1.
- Spend coins as needed for various effects.
...
- **Master cards:** Score based on conditions.
- **Objective tiles:** VP for each reached.
- **Travel cubes placed:** 9th/10th/11th/12th cube placed scores 1/2/4/8 VP.
- **Remaining resources** may contribute minor points.

**Highest VP total wins.**

## Special Rules & Edge Cases

- **Tucking cards:** The card tucked under the desk is permanent. Its symbol boosts all future actions of that type but the card cannot be played again.
- **Track endings:** Special requirements must be met to enter Objective spaces at track ends.
- **Travel cube order:** Must be removed from Study board top-to-bottom, right-to-left, uncovering bonuses.
- **Bookshelf tiles:** Placed on Study board to claim bonuses and score points.
- **Solo variant:** Included with modified setup and automated opponent.
