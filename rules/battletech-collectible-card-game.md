...
source_pdf: "battletech-collectible-card-game-rules.pdf"
...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20BattleTech%20Collectible%20Card%20Game&game=battletech-collectible-card-game)
<!-- verification:end -->
...
2. **Resource Phase**: Play resource cards and collect stockpile points.
3. **Deploy Phase**: Pay costs to deploy 'Mechs, vehicles, infantry, and other units from hand to the battlefield.
4. **Attack Phase**: Declare attacks with your deployed units against the opponent.
5. **Defense Phase**: The defending player assigns blockers and resolves combat.
6. **End Phase**: Discard down to hand limit if necessary, resolve end-of-turn effects.
...
| Card Type | Role |
|---|---|
| 'Mech | Primary combat unit, high power |
| Vehicle | Support combat unit |
| Infantry | Low-cost unit |
| Command | Tactical effects |
| Resource | Generate income |
| Mission | Alternate victory path |

| Win Condition | Requirement |
|---|---|
| Achieve 20 Influence | Accumulate through missions/cards |
| Reduce opponent to 0 Influence | Deal enough unblocked damage |
