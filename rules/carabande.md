...
designer: Bill Payne
source_pdf: carabande-rules.pdf
...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/carabande-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Carabande&game=carabande)
<!-- verification:end -->
...
- 6 straight track segments
- 10 curve track segments
- 6 short edge rails
- 10 long edge rails
- 8 discs in four different colors (2 per color)
- 1 black obstacle/spacing disc
- 1 sheet of stickers
...
- **Disc flies off track:** Your turn ends. Return your disc to its position before the shot. If you knock another player's disc off the track, return all displaced discs (including yours) to their positions before the shot. Your turn ends.
- **Disc lands upside down (sticker side down):** You miss your next turn. On that missed turn, your only action is to flip the disc back over. Other players may knock an upside-down disc; if knocked off the track, it returns upside-down to its pre-shot position.
- **Bank shots:** Bouncing off rails is a legitimate and useful technique for navigating difficult positions.
