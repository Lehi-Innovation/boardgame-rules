...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Sky%20Team&game=sky-team)
<!-- verification:end -->
...
1. No airplane tokens remain on the approach track.
2. All landing gear switches show green.
3. All flap switches show green.
4. The axis is pointing straight up (level).
5. Final engine speed is less than the brake marker position.
...
| Space | Player | Mandatory? | Effect |
|-------|--------|-----------|--------|
| Axis | Both (1 each) | Yes | Controls plane tilt |
| Engines | Both (1 each) | Yes | Controls approach speed |
| Radio | Either | No | Removes airplane tokens |
| Landing Gear | Pilot | No | Activates gear switches |
| Flaps | Co-pilot | No | Activates flap switches |
| Concentration | Either | No | Gains coffee tokens |
| Brakes | Pilot | No | Increases braking power |
