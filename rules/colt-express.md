...
---
<!-- verification:begin -->
> ❗ **Known errors** — an audit found inaccuracies in this summary that could mislead players: Swapped card counts, wrong loot total (36 vs 26), invented cactus token/first-player rule, reversed Move distances, inverted tiebreaker, Expert Variant conflated into base rules, Events omitted. Until it is re-written, prefer the full rulebook text linked below.
>
