...
---
<!-- verification:begin -->
> ❗ **Known errors** — an audit found inaccuracies in this summary that could mislead players: Invented "culture points" victory currency, fabricated 6-phase turn order (source has 4), invented Government cards/barbarians/terrain-resource rules, wrong end conditions. Until it is re-written, prefer the full rulebook text linked below.
>
