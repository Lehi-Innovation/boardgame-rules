...
source_pdf: "royal-game-of-ur-rules.pdf"
...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Royal%20Game%20of%20Ur&game=royal-game-of-ur)
<!-- verification:end -->
...
- 1 game board (distinctive H-shaped or 20-square layout with rosette-marked squares)
- 5 or 7 pieces per player (2 colors)
- 3 or 4 tetrahedral dice (binary dice, each die has 2 marked corners and 2 unmarked corners)
...
- **Rosettes are safe:** Pieces on rosette squares cannot be captured by opponents. Additionally, you may not land on a rosette that is already occupied by either player's piece.
- **Exact bearing off:** You must roll the exact number needed to move a piece off the final space. If you cannot, you must make a different move or pass.
- **No stacking:** Only one piece may occupy a space at a time.
- **Shared middle track:** The central row of the board is shared by both players, creating conflict and capture opportunities.
- **Roll of 0:** If all dice show unmarked sides, the player's turn is skipped.
- **Historical variants:** Different reconstructions and historical periods had varying rules; the Finkel ruleset is the most commonly played modern version.
