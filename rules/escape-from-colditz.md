...
designer: "Bob Brechin, Brian Degas, Major P.R. Reid"
source_pdf: "escape-from-colditz-rules.pdf"
...
>
> 📄 [Full rulebook text](https://jonnyallred.github.io/boardgame-rules/extracted/escape-from-colditz-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Escape%20from%20Colditz&game=escape-from-colditz)
<!-- verification:end -->
