...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/bonkers-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Bonkers%21&game=bonkers)
<!-- verification:end -->
...
- 1 Gameboard
- 4 Plastic tokens
- 4 Plastic scoring pegs
- 1 Scoring pegboard
- 2 Dice
- 40 Track Cards (including 2 Exchange Cards)
- 4 Large Lose Cards
- Instructions
...
- An unoccupied track space with no Track Card next to it
- An unoccupied Score space
- The Lose space
...
**Scoring:**
- Landing on a Score space: +1 point
- Rolling double 6s: +1 point
- Entrapment: +1 point
- Landing on the Lose space: -1 point
- Opponent uses Large Lose Card on you: -1 point (moved to Lose space)

Scores cannot drop below 0.

## Special Rules & Edge Cases

- **Track Card depletion:** If all Track Cards are placed on the board, continue playing with whatever cards you still hold.
- **One card per turn:** You may never place more than 1 Track Card per turn.
- **Occupied Score spaces:** Still earn the point but must roll again (turn continues).
- **Lose space always stops:** Your turn ends on the Lose space regardless of whether it is occupied.
- **Board state changes:** As Track Cards are placed throughout the game, the board configuration continuously changes, making each game unique.
