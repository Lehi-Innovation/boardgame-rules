---
title: "Sankore: The Pride of Mansa Musa"
bgg_id: 382518
player_count: "1-4"
play_time: "150-180 min"
designer: "Fabio Lopiano, Mandela Fernandez-Grandon"
source_pdf: "sankore-rules.pdf"
...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Sankore%3A%20The%20Pride%20of%20Mansa%20Musa&game=sankor-the-pride-of-mansa-musa)
<!-- verification:end -->
...
1. **Worker Placement Phase**: In turn order, each player places one scholar on an available action space and resolves the action.
2. **Continue** until all players have placed all their scholars.
3. **End of Round**: Perform end-of-round scoring and cleanup.
...
| Action | Effect |
|--------|--------|
| Enroll Pupils | Add pupils to a discipline |
| Teach Classes | Advance pupil knowledge, earn prestige |
| Graduate Pupils | Score prestige, gain ongoing benefits |
| Add to Curriculum | Improve teaching effectiveness |
| Fill Library | Place books, advance knowledge tracks |
| Gather Resources | Acquire gold, salt, manuscripts |
| Build | Construct buildings for bonuses |
