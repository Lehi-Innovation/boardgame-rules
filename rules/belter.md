...
designer: "Frank Chadwick, Marc Miller"
source_pdf: "belter-rules.pdf"
...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Belter&game=belter)
<!-- verification:end -->
...
1. **Movement Phase**: Players move their mining ships between asteroid locations and stations.
2. **Mining Phase**: Ships at asteroid locations conduct mining operations, extracting ore, gas, or CT.
3. **Trading Phase**: Ships at stations sell mined resources. Prices fluctuate based on supply and demand.
4. **Event Phase**: Draw and resolve event cards affecting the belt.
5. **Political Phase**: Conduct elections and political maneuvering at stations.
6. **Maintenance Phase**: Pay upkeep costs, repair ships, hire crew.
...
| Ore | Low-Medium | Safe |
| Gas | Medium | Low |
| CT (Antimatter) | Very High | Extreme |

| Action | Location Required |
|---|---|
| Mine | Asteroid location |
| Trade | Planetoid station |
| Buy Equipment | Planetoid station |
| Political Action | Planetoid station |
