...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Emergo&game=emergo)
<!-- verification:end -->
...
- 1 checkered board (9x9, with black corner squares)
- 24 stackable checkers (12 per player, in two colors -- typically white and black)
...
- The maximum capture rule means you must always choose the path that captures the most pieces.
- During the entering phase, capturing takes priority over entering a new piece.
- Stack ownership can change rapidly as pieces are captured and recaptured.
- A stack with your piece on top may contain opponent pieces beneath -- these are "prisoners" that cannot move independently but may be freed if the stack is captured by the opponent.
- The four-connectivity of dark squares on a 9x9 board (with black corners) provides a unique geometric basis for the game.
- There are no kings or promotion -- all pieces move identically.
- The entering phase adds a strategic dimension not found in standard checkers.
