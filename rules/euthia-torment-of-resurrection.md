...
source_pdf: "euthia-torment-of-resurrection-rules.pdf"
...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Euthia%3A%20Torment%20of%20Resurrection&game=euthia-torment-of-resurrection)
<!-- verification:end -->
...
- Modular hex map tiles
- Hero boards (up to 8 unique heroes with different playstyles)
- Hero miniatures
- Monster cards and tokens
- Quest cards
- Equipment cards (weapons, armor, items)
- Ability cards (branching skill paths)
- Merchant boards (3 different merchants)
- Dice (combat dice with mitigation mechanics)
- Gaar stones (magical tokens for dice manipulation)
- Elemental essence tokens (4 types)
- Potion tokens
- Resource tokens (for mining)
- Gold coins
- Scenario sheets
...
- Spend earned points to increase your combat roll.
- Earn Gaar tokens during combat for future dice manipulation.
- Increase your damage output.
- Use elemental essences to invoke special abilities.
- Apply equipment bonuses and hero abilities.
...
- Heroes can equip weapons, armor, and accessories that modify their stats and combat capabilities.
- Ability paths branch, allowing different builds for the same hero.
- Potions provide temporary boosts to various stats.
...
- There is no player elimination. Defeated heroes resurrect at the Church, losing some resources but continuing play.
- The modular map means every game has a different layout, even when playing the same scenario.
- Heroes have significantly different playstyles -- some focus on combat, others on magic or trading.
- Equipment and abilities synergize in complex ways, rewarding experimentation.
- Monster difficulty scales with map position -- areas farther from the Church tend to be more dangerous.
- Gold management is important -- merchants offer powerful items but at high prices.
- Gaar stones are a limited resource that can turn the tide of difficult combats.
- The game supports both competitive and cooperative play within the same scenario framework.
