...
source_pdf: "dimension-rules.pdf"
...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/dimension-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Dimension&game=dimension)
<!-- verification:end -->
...
- 60 Task cards
- 90 Point tokens (30x "1", 20x "5", 10x "10", 6x "20", 24x "50")
- Bonus tokens
- 4 Overview tiles
- 1 Hourglass
...
### 5. Scoring
- **+1 point per sphere** on your tray.
- **-2 points per failed task** (task card that your arrangement does not satisfy). One of the players reads the task cards aloud one by one. Each player checks their tray and answers "yes" or "no." For each failed task, discard 2 one-point tokens (worth a total of 2 points).
- **Bonus token** for using all 5 colors and completing all 6 tasks. You must have placed at least one sphere of each of the five colors on your tray.
