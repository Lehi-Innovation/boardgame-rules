...
play_time: "120 min"
designer: "Unknown"
source_pdf: "kampen-om-rai-rules.pdf"
...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Kampen%20om%20Rai&game=kampen-om-rai)
<!-- verification:end -->
...
1. Place the game board with Rai (the capital) in the center.
2. Each player receives their army tokens and 2 treasure markers.
3. Players secretly distribute their treasures among their starting armies.
4. Place armies at starting positions around the board edges.
5. The hidden nature of army composition and treasure placement is central to setup.

## Turn Structure

On your turn:
1. Move your armies across the map.
2. Resolve any combats with opposing armies.
3. Check if any treasures have reached or remain in Rai.
...
| Key Concept | Detail |
|-------------|--------|
| Goal | Get both treasures to Rai and hold 3 turns |
| Armies | Hidden composition |
| Treasures per player | 2 |
| Capital | Rai (center of board) |
| Hold requirement | 3 consecutive turns |

| Key Numbers | Value |
|-------------|-------|
| Players | 2-4 |
| Play time | ~120 min |
| Treasures to deliver | 2 per player |
| Turns to hold in Rai | 3 |
