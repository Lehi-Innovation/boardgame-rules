...
source_pdf: "escape-from-new-york-rules.pdf"
...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Escape%20from%20New%20York&game=escape-from-new-york)
<!-- verification:end -->
...
- 1 game board (map of Manhattan island)
- Character cards/tokens
- Clue cards (with location information)
- Weapon and equipment cards
- Ally and enemy encounter cards
- 1 die
- Turn/time track
- Rules booklet
...
- Locate a glider, OR
- Find a map to the mine fields surrounding Manhattan.
Then make your way to an exit point and escape before time runs out.
...
- The game is based directly on the 1981 film, so thematic events mirror the movie's plot.
- Players can cooperate or compete -- alliances are temporary and backstabbing is possible.
- Weapons and allies can be lost in failed combat encounters.
- The time pressure creates urgency as the game progresses.
- Some landmark spaces provide special benefits or encounters.
- The game can be played solo with one player controlling a single character.
