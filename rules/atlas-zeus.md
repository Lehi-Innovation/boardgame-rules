...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Atlas%20%26%20Zeus&game=atlas-zeus)
<!-- verification:end -->
...
- Action cards (various types for claiming territory, attacking, defending)
- Island cards or tiles (representing Atlantis locations)
...
- **Claim an island:** Play appropriate cards to establish control over an island.
- **Attack opponent:** Play attack cards to contest an opponent's island control.
- **Defend:** Play defense cards to protect your islands from the opponent's attacks.
- **Move between islands:** Relocate your clan members to different islands.
- **Draw cards:** Replenish your hand from the deck.
...
- **Sinking islands:** Islands progressively sink throughout the game, forcing both players into ever-shrinking territory.
- **Hand management:** Balancing offensive and defensive card play is crucial.
