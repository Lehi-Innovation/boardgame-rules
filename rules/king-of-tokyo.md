...
source_pdf: "king-of-tokyo-rules.pdf"
...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/king-of-tokyo-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20King%20of%20Tokyo&game=king-of-tokyo)
<!-- verification:end -->
...
1. Each player chooses a Monster, takes the figure and Monster board.
2. Set Life Points to 10 and Victory Points to 0.
3. Place the Tokyo board centrally.
4. Shuffle Power cards, deal 3 face-up next to the board.
5. Place black dice centrally; set green dice aside.
6. Form an Energy cube pool.
7. With 2-4 players: use only Tokyo City. With 5-6 players: use both Tokyo City and Tokyo Bay.
8. Roll all 6 black dice to determine first player (most claw results; reroll ties).
