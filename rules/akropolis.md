...
source_pdf: "akropolis-rules.pdf"
...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/akropolis-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Akropolis&game=akropolis)
<!-- verification:end -->
...
- 61 City tiles (3 hexes each; backs indicate player counts: 2+, 3+, 4)
- 4 Starting tiles
- 40 Stone cubes
...
- Pay 1 Stone per tile that precedes it in the line (the first tile is free, the second costs 1, the third costs 2, etc.).
- Return spent Stones to the reserve.
- The last tile in the Construction Site is never played.
- If you have no Stones, you must take the first tile.
...
- Plazas do NOT need to be adjacent to matching districts to provide their multiplier.
- A starting tile includes 1 Housing Plaza.
- Covered hexes no longer count toward the city.
- If you have 0 matching Plazas for a district type, that type scores 0 regardless of districts placed.
