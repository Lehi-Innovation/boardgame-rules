...
player_count: "2-4"
play_time: "60-90 min"
designer: "Rob Daviau, Noah Cohen, Brian Neff"
source_pdf: "thunder-road-vendetta-rules.pdf"
...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Thunder%20Road%3A%20Vendetta&game=thunder-road-vendetta)
<!-- verification:end -->
...
1. Arrange 3 road tiles end-to-end to form the starting road.
2. Each player takes 3 cars in their color and a dashboard.
3. Place cars on designated starting positions.
4. Shuffle and deal starting command cards.
5. Place hazard tokens, nitro tokens, and other components in supply.
...
| Die | Effect |
|---|---|
| Movement die | Move car forward X spaces |
| Attack die | Damage/push on hit |
| Hazard die | Resolve hazard effects |
