...
player_count: "2-4"
play_time: "15-20 min"
designer: "Michael Kallauch"
source_pdf: "brandon-the-brave-rules.pdf"
...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Brandon%20the%20Brave&game=brandon-the-brave)
<!-- verification:end -->
...
1. Shuffle the triangular field tiles face down and create a draw pile.
2. Deal a set number of task cards to each player.
3. Each player places their starting piece or tile as indicated.

## Turn Structure

On each turn, a player:
1. Draws a triangular field tile from the pile.
2. Examines the tile — it shows part of a landscape and either a colored cross (indicating a task location) or part of a jousting arena.
3. Places the tile following the placement rules.
4. If the placement completes a task, the player discards the corresponding task card.
...
| Tile Type | Placement Rule |
|---|---|
| Cross tile | Must be placed next to matching color crosses only |
| Arena tile | Must be placed next to other arena parts; no open edges |
