...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Maestro&game=maestro)
<!-- verification:end -->
...
- Musician cards (various instruments)
- Composition cards (requiring specific instrument combinations)
...
- Musicians may have special abilities that affect gameplay.
- Some compositions are more difficult (requiring rare instruments) but score more points.
- Hand management is crucial -- holding too many musicians without completing compositions is wasteful.
- Timing is key: completing compositions before opponents claim the same ones provides an advantage.
