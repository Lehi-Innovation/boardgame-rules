...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Mixtour&game=mixtour)
<!-- verification:end -->
...
1. **Place** a new piece of your color on any empty space.
2. **Move** one or more pieces from a stack.
