...
source_pdf: "funny-friends-rules.pdf"
...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Funny%20Friends&game=funny-friends)
<!-- verification:end -->
...
- Player boards (tracking attributes and life history)
- Life cards (representing life events and experiences)
- Time tokens (currency for auctions)
- Life goal cards (5 per player)
- Attribute markers
- Phase/round tracker
...
- Starting with the first player, each player either bids (increasing the current bid) or passes.
- Once you pass, you are out of all remaining auctions for this round.
- The earlier you pass, the more time tokens you receive as compensation (used in future rounds).
- The highest bidder wins the life card and pays their bid.
...
| Rule | Detail |
|------|--------|
| Win condition | Complete 5 life goals |
| Currency | Time tokens |
| Pass benefit | Earlier pass = more time next round |
| Players | 2-6 |
