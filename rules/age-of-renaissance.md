...
<!-- verification:begin -->
> ❗ **Known errors** — an audit found inaccuracies in this summary that could mislead players: Turn structure/trading/calamities invented from Civilization, not the source; scoring omits misery; 3 vs 6 advance categories; core systems (misery, bids, fleets) missing. Until it is re-written, prefer the full rulebook text linked below.
>
> 📄 [Full rulebook text](https://jonnyallred.github.io/boardgame-rules/extracted/age-of-renaissance-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Age%20of%20Renaissance&game=age-of-renaissance)
<!-- verification:end -->
...
1. **Revenue Collection**: Earn income from controlled provinces and cities.
2. **Expansion**: Grow population and expand into new territories.
3. **Trade Card Collection**: Draw commodity cards based on cities.
4. **Trade Session**: Exchange commodity cards with other players.
5. **Calamity Resolution**: Resolve any calamity cards.
6. **Purchase Advances**: Spend commodity sets and cash for advance cards.
7. **End of Turn**: Check victory conditions and advance the epoch marker.
...
2. Expansion
3. Trade Card Collection
4. Trade Session
5. Calamity Resolution
6. Purchase Advances
7. End of Turn
