...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/metro-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Metro&game=metro)
<!-- verification:end -->
...
3. Each player takes the Metro Line card in their color to see which stations they own.
4. Place a subway car on the outgoing track (side without roof) of each station you own.
5. Place scoring pawns on "0" of the score track.
6. Shuffle track tiles face up ("Metro" side up) to form the tile pool.
7. Each player draws one tile.
