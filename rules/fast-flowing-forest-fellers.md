---
title: "Fast Flowing Forest Fellers"
bgg_id: 38548
player_count: "2-5"
play_time: "30 min"
designer: "Friedemann Friese"
source_pdf: "fast-flowing-forest-fellers-rules.pdf"
...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/fast-flowing-forest-fellers-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Fast%20Flowing%20Forest%20Fellers&game=fast-flowing-forest-fellers)
<!-- verification:end -->
...
1. Assemble 2 game boards with rapids between them. (For first game, use recommended layout.)
2. Place 1 log on each marked log space.
3. Each player takes a player card and the corresponding figures plus 1 Joker:
...
4. Place all lumberjacks in front of the 3 starting spaces.
5. Each player shuffles their deck, places it face-down, and draws 3 cards.
...
|------|---------|
| Players | 2-5 |
| Figures per player | 3 (2-3p) or 2 (4-5p) |
| Hand size | 3 cards |
| Shove limit | Up to 2 figures in a straight line |
| Rapids | One-way only (toward goal) |
| Current | Figures float in arrow direction at end of turn |
| Win condition | All your lumberjacks past the finish |
