...
source_pdf: "crokinole-rules.pdf"
...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/crokinole-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Crokinole&game=crokinole)
<!-- verification:end -->
...
1. Place the board on a table with equal access for all players.
2. With 2 players: each receives 12 discs of a distinct color.
3. With 4 players: partnerships of 2; each partnership gets 12 discs (6 per player). Partners sit opposite each other.
4. Choose the start player randomly. Play proceeds clockwise.
...
|------|--------|
| 20 Hole | 20 per disc |
| 15 Zone (inside pegs) | 15 per disc |
| 10 Zone | 10 per disc |
| 5 Zone | 5 per disc |
