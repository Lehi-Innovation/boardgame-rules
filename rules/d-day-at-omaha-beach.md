...
1. **US Amphibious Operations** -- Landing Checks, landing US units, placing them in Beach Landing Boxes.
2. **German Fire** -- Draw event cards to determine German fire against US units on the beach.
3. **US Actions** -- US units perform actions (move, climb bluffs/cliffs, attack).
4. **US Combat Actions** -- Resolve US attacks and barrages against German positions.
5. **Engineer Beach Obstacle Demolition** -- Engineers clear obstacles.
...
| Turn Phase (First Waves) | Description |
|--------------------------|-------------|
| US Amphibious Ops | Land units on the beach |
| German Fire | Draw cards for German attacks |
| US Actions | Move, climb, reform |
| US Combat | Attack adjacent WNs, barrage |
| Engineer Demolition | Clear beach obstacles |

| Time Scale | Turns |
|-----------|-------|
| 15 min/turn | 1-16 (First Waves) |
| 30 min/turn | 17-32 (Extended Game) |
