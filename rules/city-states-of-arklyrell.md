---
title: "City States of Arklyrell"
bgg_id: 4248
player_count: "2-6"
play_time: "90-120 min"
designer: "Lance Gutteridge"
...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20City%20States%20of%20Arklyrell&game=city-states-of-arklyrell)
<!-- verification:end -->
...
2. Each player selects a city-state faction and takes their starting units and resources.
3. Place starting armies and buildings on each player's home territory.
4. Shuffle diplomacy and event card decks.
5. Determine a starting player.

## Turn Structure

Each round consists of player turns in order:
1. **Income Phase:** Collect resources from controlled territories.
2. **Build Phase:** Recruit units, construct buildings, and develop your city.
3. **Diplomacy Phase:** Negotiate with other players, form or break alliances.
4. **Movement Phase:** Move armies across the map.
5. **Combat Phase:** Resolve battles in contested territories.
...
| Phase | Action |
|-------|--------|
| Income | Collect resources from territories |
| Build | Recruit units, construct buildings |
| Diplomacy | Negotiate alliances and agreements |
| Movement | Move armies across the map |
| Combat | Resolve battles with dice + modifiers |

| Win Conditions | Territory domination, most VP, or last standing |
