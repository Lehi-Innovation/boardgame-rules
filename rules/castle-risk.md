...
source_pdf: castle-risk-rules.pdf
...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/castle-risk-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Castle%20Risk&game=castle-risk)
<!-- verification:end -->
...
- 1 game board (map of Europe divided into territories)
- Armies in 6 colors
- Castle pieces (1 per player)
- Territory cards
...
- **Deploy armies:** Place reinforcements at the start of your turn.
- **Attack:** Roll dice against adjacent enemy territories.
- **Capture territories:** Move armies into a conquered territory.
- **Trade cards:** Turn in sets of territory cards for bonus armies.
- **Fortify:** Move armies between connected territories at end of turn.
...
- Your castle territory is your most important position. If an opponent captures it, you are eliminated.
- When a player is eliminated, the conquering player takes all of that player's territory cards.
- Standard Risk rules apply for combat resolution (dice comparison).
- The European map is smaller than standard Risk, leading to faster and more intense games.
- Some versions include special action cards or events.
...
**Win condition:** Last player with an uncaptured castle
**Combat:** Attacker up to 3 dice vs. defender up to 2 dice; highest wins, ties to defender
