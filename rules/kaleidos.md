...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/kaleidos-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Kaleidos&game=kaleidos)
<!-- verification:end -->
...
1. Assemble the cardboard easels and give one to each player (or group if more than 4 players -- split into groups of 2-3 per easel).
2. Split the 20 picture boards into four groups of 5 boards (pictures numbered 1-10). Put one group on each easel.
3. Shuffle the letter cards and place face-down in the middle of the table next to the hourglass.
4. Give each player a pencil and a sheet of paper.

## Turn Structure

Each turn follows these steps:

1. **Choose a picture:** All players as a group choose one picture to use and place their copy on their easels.
2. **Reveal letter and start timer:** Flip the top letter card and the hourglass simultaneously.
3. **Find and write:** Players secretly write down words for items found in the picture that begin with the revealed letter. Do not look at other players' notes.
4. **Time runs out:** The turn ends when the hourglass empties.
5. **Score:** Each player reads aloud all their words and compares with other players.
...
| Scoring | Points |
|---------|--------|
| Unique word (only you found it) | 3 points |
| Shared word (you and at least one other) | 1 point |

| Game Structure | Detail |
|----------------|--------|
| Total turns | 10 |
| Players supported | 2-12 (solo or teams at easels) |
| Pictures available | 40 (20 boards, double-sided) |
| Letter cards | 26 |
