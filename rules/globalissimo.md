...
source_pdf: "globalissimo-rules.pdf"
...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Globalissimo&game=globalissimo)
<!-- verification:end -->
...
- Country cards (each showing a national flag)
- Category cards (10 different categories such as population, GDP, area, etc.)
- Player markers
...
1. Shuffle the country cards and place them as a draw deck.
2. Shuffle the category cards and place them separately.
3. Each player takes a set of player markers.
4. Set all players' scores to 0 on the score track.
...
- **Off by 1:** Fewer points
- **Off by 2+:** Minimal or no points
...
- Claim countries you are most confident about first.
- Later players have fewer choices but more information from others' guesses.
- Turn order matters -- early players get first pick of countries and positions.
...
- Life expectancy
- Population density
- And others (depending on edition)
...
**Round Structure:**
1. Reveal up to 6 country cards
2. Reveal 1 category card
3. Players claim countries and ranking positions
4. Reveal actual ranking
5. Score points for accuracy
...
|------|-------|
| Players | 2-6 |
| Countries per round | Up to 6 |
| Categories | 10 |
| Scoring | Based on guess accuracy |
