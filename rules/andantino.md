...
source_pdf: "andantino-rules.pdf"
...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/andantino-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Andantino&game=andantino)
<!-- verification:end -->
...
- 25 White hexagonal tiles
- 25 Red hexagonal tiles
- 1 Carrying case
...
- **Line of 5:** Complete a straight line of 5 consecutive pieces of your color.
- **Enclosure:** Fully enclose (trap) one or more opponent pieces inside a loop of 6 or more of your own pieces. Traps may include empty gaps as long as they are fully enclosed by the surrounding pieces.
...
- Traps can include gaps (empty areas) provided they are fully enclosed.
- A loop of your own pieces must consist of at least 6 pieces to count as an enclosure.
- **Extended Variant:** If all 50 tiles have been played without a winner, players may continue by picking up already-played pieces of their color and legally placing them elsewhere until a victory condition is reached.
