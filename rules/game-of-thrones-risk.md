...
designer: "Rob Daviau"
source_pdf: "game-of-thrones-risk-rules.pdf"
...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/game-of-thrones-risk-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Game%20of%20Thrones%20Risk&game=game-of-thrones-risk)
<!-- verification:end -->
...
- 2 game boards (Westeros map, Essos map)
- 7 army sets (sculpted pieces for each noble house)
- Territory cards
- Objective/Victory Point cards
- Maester cards (special ability cards)
- Gold Dragon tokens (currency)
- Character cards (one per house with unique abilities)
- Ports and castles
- Valar Morghulis card (game-ending trigger)
- Dice (attack and defense)
- Over 650 total pieces
...
- Number of territories controlled / 3 (minimum 3)
- Region bonuses for controlling entire regions
- Port bonuses
- Card set turn-ins

### 2. Attack (optional)
Attack adjacent territories controlled by other players:
- Declare the attacking and defending territories.
- Choose number of attack dice (up to 3, one fewer than armies in attacking territory).
- Defender rolls defense dice (up to 2).
- Compare highest dice: attacker's highest vs. defender's highest, then second highest. Defender wins ties.
- Losing side removes armies for each lost comparison.
- Repeat until attacker stops or one side is eliminated from the territory.
...
- Controlling your Seat of Power (ongoing)
- Completing objective cards
- Controlling entire regions
- Castle bonuses
...
### Three Game Modes
- **Skirmish:** Simplified rules for 2 players on Essos. Faster game.
- **Dominion:** Full rules for 3-5 players on Westeros. Includes Maester cards and advanced mechanics.
- **World at War:** Both maps connected. 6-7 players. Armies can move between Westeros and Essos via ports.
...
| Max attack dice | 3 |
| Max defense dice | 2 |
| Min reinforcements | 3 |
| Game modes | 3 (Skirmish, Dominion, World at War) |
| Player counts | 2 (Skirmish), 3-5 (Dominion), 6-7 (World at War) |
