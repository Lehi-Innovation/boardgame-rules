...
- 1 large action board (with 2 extension tiles for 4 players)
- 4 home boards (two-sided: 7-round/6-round)
- 1 oval supply board (special tiles), 1 ship supply board
- 4 two-sided exploration boards (Shetland/Bear Island, Faroe/Baffin, Iceland/Labrador, Greenland/Newfoundland)
- 346 goods tiles (orange food, green craft, blue luxury, red animal/equipment)
- 15 special tiles (unique blue tiles)
- 32 ship tiles (10 whaling boats, 12 knarrs, 10 longships)
- Building tiles: 3 sheds, 3 stone houses, 5 long houses
- 8 mountain strips
- Wooden goods: 32 wood, 24 stone, 40 ore
- 125 silver coins (80x1, 22x2, 18x4, 5x10)
- 48 Vikings (12 per player)
- 190 Occupation cards (decks A, B, C), 47 Weapon cards
- Dice: 1 orange d8, 1 blue d12
- Start player moose, round tracking cube
