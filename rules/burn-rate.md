...
source_pdf: "burn-rate-rules.pdf"
...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Burn%20Rate&game=burn-rate)
<!-- verification:end -->
...
1. Each player drafts a starting team of 4 employees from the employee card pool.
2. Distribute starting cash equally (e.g., $80 each in a 4-player game).
3. Shuffle the action card deck and deal 6 action cards to each player.
4. Determine a starting player.

## Turn Structure

On each turn, a player:
1. Draws action cards to refill their hand to 6.
2. Plays up to 4 action cards (if they have employees with the required skills).
3. Pays payroll for all current employees.
4. Resolves any ongoing Bad Ideas or other obligations.
...
|---|---|---|
| Play action card | Employee with matching skill | Various (funding, attacks, etc.) |
| Funding | Finance employee | Gain cash |
| Force Hire | Varies | Opponent must hire more employees |
| Bad Idea | Varies | Opponent must spend resources |
| Layoff | None | Remove employee, reduce payroll |
