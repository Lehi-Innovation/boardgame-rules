...
source_pdf: "piou-piou-rules.pdf"
...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/piou-piou-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Piou%20Piou&game=piou-piou)
<!-- verification:end -->
...
- 47 cards:
  ...
  - 15 Hen cards
  - 11 Nest cards
- 18 Egg/Chick tokens (double-sided: egg on one side, chick on the other)

## Setup

1. Place the pile of egg/chick tokens in the center of the table, egg side up.
2. Shuffle all 47 cards.
3. Deal 4 cards to each player.
4. Place remaining cards face-down as the draw pile, next to the egg pile.
5. The youngest player goes first. Play proceeds clockwise.

## Turn Structure

On your turn, you must choose one of the following:
- Perform one game action (lay an egg, hatch a chick, or steal an egg)
- OR discard one card to the discard pile
...
- All played and discarded cards go to the discard pile and are replaced by drawing from the draw pile.
- When the draw pile is exhausted, shuffle the discard pile to form a new draw pile.
- Players cannot lay an egg or hatch a chick immediately after drawing cards (you must wait until your next turn).
- You can only steal eggs, never chicks.
- A defending player who plays 2 Roosters discards them and immediately draws 2 replacement cards.
