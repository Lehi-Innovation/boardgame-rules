...
1. **Dispatch buyer** (place 1 buyer card face up on an empty space in a market area).
2. **Execute move** (buy a tower section, get money, build a tower, etc., based on where the buyer was placed).
...
| **Bank** | Collect Asari from the bank |
| **Building circle** | Build a tower using collected sections |
...
| Color | All sections same price |
|-------|----------------------|
| Brown | Cheapest |
| Green | Low |
| Red | Medium |
| Black | High |
| White | Most expensive |

| Tower Requirement | Minimum |
|------------------|---------|
| Base | Required (1) |
| Trunk | Optional (0+) |
| Window | Optional (0+) |
| Turret | Required (1, on top) |
