...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Citizen%20X&game=citizen-x)
<!-- verification:end -->
...
1. Shuffle role cards and deal one face-down to each player.
2. Players secretly look at their role without revealing it.
3. Determine a starting player or moderator.
4. Follow any specific night/day phase setup instructions.

## Turn Structure

The game alternates between phases:

1. **Night Phase:** Hidden threats perform their secret actions (converting or eliminating a citizen).
2. **Day Phase:** All players discuss, accuse, and vote to eliminate a suspect.
...
| Citizens | Identify and eliminate threats via voting |
|----------|----------------------------------------|
| Threats | Eliminate/convert citizens secretly at night |
| Day Phase | Discussion + accusation + majority vote |
| Night Phase | Threats choose a target |
| Citizen Victory | All threats eliminated |
| Threat Victory | Threats equal or outnumber citizens |
