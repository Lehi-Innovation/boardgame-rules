...
source_pdf: "fields-of-arle-rules.pdf"
...
---
<!-- verification:begin -->
> ❗ **Known errors** — an audit found inaccuracies in this summary that could mislead players: Summary says feeding happens only "during winter inventorying" but source requires Sustenance (3 Food + 2 Peat in summer, 3 Food in winter) at the end of every half-year; players would miss 5 feeding events and the entire fuel cost. Until it is re-written, prefer the full rulebook text linked below.
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/fields-of-arle-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Fields%20of%20Arle&game=fields-of-arle)
<!-- verification:end -->
...
1. Place the large game board and supply board between players.
2. Populate action spaces and supply areas with appropriate tiles per setup instructions.
3. Each player sets up their home board with starting goods levels and animals.
4. Place workers on home boards.
5. Set the half-year counter to the first half-year.
...
### Each Half-Year:
1. **Worker Placement Phase:** Players alternate placing 1 worker at a time on available action spaces. Summer and winter have different available actions. Each action space can only hold 1 worker.
2. **After all workers placed:** Resolve any end-of-phase activities.
3. **Inventorying:** Season-specific upkeep including feeding workers, breeding animals, and harvesting.
...
| Players | 1-2 |
| Age | 14+ |
| Duration | 9 half-years (alternating summer/winter) |
| Workers per player | 4 |
| Key resources | Grain, Flax, Peat, Clay, Wood, Wool, Hide, Food |
| Processed goods | Linen, Leather, Brick, Timber, Clothing |
| Animals | Sheep, Cattle, Horses |
| Win condition | Most victory points at end of game |
