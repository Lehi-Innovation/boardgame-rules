...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/cities-skylines-the-board-game-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Cities%3A%20Skylines%20%E2%80%93%20The%20Board%20Game&game=cities-skylines-the-board-game)
<!-- verification:end -->
...
1. Assemble game board pieces in the center of the table (varies by scenario).
2. Place the administration board face up next to game boards; place 8 markers on "0" spaces.
3. Deposit starting capital of 12 money tokens in the city treasury.
4. Sort all zone and building tiles by color and type.
5. Shuffle Stage I construction cards and deal based on player count: 4 players = 3 cards each, 3 players = 4 each, 2 players = 5 each, 1 player = 7 cards. Remaining cards form draw piles by stage.
6. Place the happiness display (Skyline) next to the administration board with indicators on "0."
7. Youngest player gets the starting player token.
...
1. **Play a Construction Card** - Build a zone or building tile on the game board
2. **Exchange a Construction Card** - Swap a card
...
| Player Count | Cards Dealt (Stage I) |
|-------------|----------------------|
...
| Administration Track | Effect |
|---------------------|--------|
| Power/Water/Garbage below 0 | -1 Happiness per step at milestone end |
| Employment away from 0 | Pay 1 money per step at milestone end |
| Pollution/Traffic/Crime above 0 | -1 overall Happiness per step at game end |
