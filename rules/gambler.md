...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/gambler-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Gambler&game=gambler)
<!-- verification:end -->
...
- 1 game board
- Dice Shaker device (holds 6 dice in a line)
- 2 standard dice (for movement)
- In-game money ($100 starting per player)
- Player tokens
...
- Award money
- Cost money
- Trigger betting events
- Draw cards with special effects

### 3. Check for Doubles
If you rolled doubles, you have a choice:
- **Call a Sweepstakes:** Trigger a Sweepstakes event (see below)
- **Roll again:** Attempt another roll of doubles for bonus rewards (risk of losing if you fail)
