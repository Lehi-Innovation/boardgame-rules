...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Claim%20It%21&game=claim-it)
<!-- verification:end -->
...
2. Each player takes their set of markers in their chosen color.
3. Shuffle and arrange territory cards/tiles as required.
4. Set up the score track.
5. Determine a starting player.

## Turn Structure

On your turn:
1. **Select a plot** — choose which territory to claim based on the available options.
2. **Place a marker** — put one of your markers on the selected plot.
3. **Check scoring conditions** — if any territories are fully claimed, score them.
...
| Place Marker | Claim a plot on the board |
|-------------|--------------------------|
| Majority | Most markers in a territory scores it |
| Strategy | Balance claiming valuable territories vs. blocking opponents |
| Win Condition | Highest total score when all plots claimed |
