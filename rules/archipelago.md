...
---
<!-- verification:begin -->
> ❗ **Known errors** — an audit found inaccuracies in this summary that could mislead players: Invented 5-phase turn structure (source has 6), core action-disc/wheel system missing, scoring mechanism inverted, invented crisis requirements, wrong components and end triggers. Until it is re-written, prefer the full rulebook text linked below.
>
> 📄 [Full rulebook text](https://jonnyallred.github.io/boardgame-rules/extracted/archipelago-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Archipelago&game=archipelago)
<!-- verification:end -->
...
1. Place the starting hex tiles as indicated. Set up the market board.
2. Each player takes a player board, starting resources, and ships.
3. Shuffle and deal secret objective cards (one per player).
4. Prepare the evolution, trend, and character card decks.
5. Set the rebellion track to its starting position.
...
1. **Balance of Power:** Determine turn order.
2. **Action Phase:** Players take turns performing actions (exploring, building, harvesting, trading, etc.).
3. **Crisis Phase:** Reveal and resolve a crisis card. All players must collectively meet the crisis requirements or the rebellion track increases.
4. **Market Phase:** Adjust market prices based on supply and demand.
5. **Check End Conditions:** If an end-game trigger occurs, proceed to scoring.
...
|-------|--------|
| 1. Balance of Power | Determine turn order |
| 2. Actions | Explore, build, harvest, trade, etc. |
| 3. Crisis | Collectively resolve crisis card |
| 4. Market | Adjust resource prices |
| 5. End Check | Check for game-end triggers |

| Key Risk | Consequence |
|----------|------------|
| Rebellion maxed | Sympathizer wins, all others lose |
| Crisis unresolved | Rebellion increases |
| Native mistreatment | Rebellion increases |
