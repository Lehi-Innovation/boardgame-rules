...
player_count: "2-4"
play_time: "120 min"
source_pdf: "doom-the-boardgame-rules.pdf"
...
---
<!-- verification:begin -->
> ❗ **Known errors** — an audit found inaccuracies in this summary that could mislead players: Invented defense-dice combat (source: static armor rating); Sprint/Unload/Advance/Ready action system and range-to-hit dice missing; door cost free vs source 2 MP; invader wins by frag count, not killing all marines. Until it is re-written, prefer the full rulebook text linked below.
>
> 📄 [Full rulebook text](https://jonnyallred.github.io/boardgame-rules/extracted/doom-the-boardgame-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Doom%3A%20The%20Boardgame&game=doom-the-boardgame)
<!-- verification:end -->
...
1. Choose a scenario from the scenario booklet.
2. One player becomes the Invader; remaining players choose Marines.
3. Assemble the map according to the scenario layout.
4. Marines take starting equipment as specified.
5. Invader takes their hand of Invader cards.
6. Place starting figures as directed by the scenario.
...
| Marine Action | Cost | Effect |
|--------------|------|--------|
| Move 1 space | 1 MP | Enter adjacent space |
| Attack | Varies | Roll weapon dice vs. target |
| Open Door | Free | Remove door token |
| Pick Up Item | Free | Take item from current space |

| Key Stats | Marine | Invader |
|-----------|--------|---------|
| Health | Varies by character | Varies by demon type |
| Weapons | Collected during play | Built into demon profile |
| Defense | Armor-based | Built-in |
