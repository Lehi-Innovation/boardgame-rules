...
source_pdf: "mice-and-mystics-rules.pdf"
...
<!-- verification:begin -->
> ❗ **Known errors** — an audit found inaccuracies in this summary that could mislead players: Initiative order is determined by random shuffle, not sorted by speed (invented mechanic); hero and minion turns are interleaved on initiative track, not in separate hero/minion phases. Until it is re-written, prefer the full rulebook text linked below.
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/mice-and-mystics-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Mice%20and%20Mystics&game=mice-and-mystics)
<!-- verification:end -->
...
1. Read the chapter from the storybook. Set up the starting room tile as described.
2. Each player chooses a mouse hero and takes their hero card, starting equipment, and figure.
3. Place the story control board nearby. Set the chapter track marker.
4. Shuffle encounter and search card decks.
5. Place minions as instructed by the chapter setup.
6. Determine initiative order using initiative cards.

## Turn Structure

Rounds alternate between hero and minion phases:

1. **Initiative Phase:** Sort initiative cards (mice and minions) by speed.
2. **Hero Turns:** Each mouse acts in initiative order: Move, then take actions (attack, search, explore, use abilities).
3. **Minion Turns:** Each minion group acts: Move toward nearest mouse and attack.
4. **End of Round:** Advance the chapter track if required.
...
**Win:** Complete chapter objective | **Lose:** Hourglass runs out or all mice captured
