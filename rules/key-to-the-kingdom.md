...
player_count: "2-6"
play_time: "60 min"
designer: "The Restoration Team"
source_pdf: "key-to-the-kingdom-rules.pdf"
...
>
> 📄 [Full rulebook text](https://jonnyallred.github.io/boardgame-rules/extracted/key-to-the-kingdom-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Key%20to%20the%20Kingdom&game=key-to-the-kingdom)
<!-- verification:end -->
...
On your turn:
1. Roll dice to determine movement.
2. Move your hero.
3. Draw and resolve encounters/events at your location.
4. Use items and companions as needed.
...
| Companion | Ability |
|-----------|---------|
| Gnarled Gnome | Refresh 2 items on certain spaces |
| Blurring Seer | Choose from 2 events; Echo Canyon bonus |
| Novice Knight | +1 item for roll modification |
| Demonic Dwarf | Override 0 on Demon die; Ice Caves bonus |
| Menacing Mercenary | Teleport to boring spaces |
| Putrid Poltergeist | Teleport or refresh item |
| Ritiless Pixie | +3 to event rolls |
