---
title: "Escape from the Hidden Castle"
bgg_id: 444
player_count: "2-8"
play_time: "30 min"
designer: "Wolfgang Kramer"
source_pdf: "escape-from-the-hidden-castle-rules.pdf"
...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/escape-from-the-hidden-castle-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Escape%20from%20the%20Hidden%20Castle&game=escape-from-the-hidden-castle)
<!-- verification:end -->
...
1. Place board Hugo-side up. Put Hugo on the cellar door space in front of "+10."
2. Players choose colors and take figures based on player count: 2P=6 each, 3P=5, 4P=4, 5P=3, 6-8P=2 each.
3. Place matching color counters on the "10" starting space of the spooky trail.
4. Place Hugo counter on "23:45" of the game turn track.
5. Youngest player places one guest on any gallery space, then clockwise each player places one, repeating until all guests are placed. One guest per space initially.

## Turn Structure

Starting with youngest player and going clockwise:
1. Roll the die.
2. **Number result (1-5):** Move one of your guests forward (clockwise) that many spaces on the gallery.
3. **Hugo symbol:** Move Hugo forward 3 spaces (or more, see Hugo's movement). You do NOT move any guest this turn.
