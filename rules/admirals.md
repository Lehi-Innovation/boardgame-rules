...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/admirals-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Admirals&game=admirals)
<!-- verification:end -->
...
- Game board (ocean map with hex grid)
- Ship counters/miniatures for each player
- Combat resolution components (dice/cards)
...
- Different ship types have varying combat capabilities and movement speeds.
- Wind and weather may affect gameplay.
- Port cities provide strategic advantages.
- Fleet composition and coordination are key to victory.
