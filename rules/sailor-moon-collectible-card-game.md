...
source_pdf: "sailor-moon-ccg-rules.pdf"
...
>
> 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Sailor%20Moon%20Collectible%20Card%20Game&game=sailor-moon-collectible-card-game)
<!-- verification:end -->
...
2. **Main Phase**: Play cards from hand -- deploy new scouts, play events/items, upgrade existing scouts.
3. **Combat Phase**: Initiate attacks against opponent's monsters/villains or scouts.
4. **End Phase**: Discard down to hand limit if needed, resolve end-of-turn effects.
...
1. **Eliminating all of the opponent's scouts** -- if a player has no scouts in play, they lose.
2. **Defeating enough monsters and villains** to reach the required victory point total (VP total varies by game format).
...
| Card Type | Persistence | Effect |
|-----------|-------------|--------|
| Scout | Permanent (until defeated) | Attacks and defends |
| Monster/Villain | Permanent (until defeated) | Target for scouts, awards VP |
| Event/Item | One-time use | Temporary effect |
| People | Permanent | Ongoing ability each turn |
