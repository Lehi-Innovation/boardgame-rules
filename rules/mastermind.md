...
---
<!-- verification:begin -->
> ❗ **Known errors** — an audit found inaccuracies in this summary that could mislead players: Key peg colors reversed: source uses red peg for correct position, white for wrong position; summary invents black pegs; 11-point bonus for unbroken code omitted; rows listed as "10 or 12" but source specifies only 10. Until it is re-written, prefer the full rulebook text linked below.
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/mastermind-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Mastermind&game=mastermind)
<!-- verification:end -->
