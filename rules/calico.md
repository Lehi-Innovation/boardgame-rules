...
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/calico-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Calico&game=calico)
<!-- verification:end -->


## Overview

Calico is a competitive tile-laying puzzle game where players draft and place colorful patch tiles onto their personal quilt board. Each board has 3 design goal tiles that award points for meeting specific pattern or color requirements. Players also try to create groups of matching patterns to attract cats and place groups of matching colors to sew buttons. The player with the most points from design goals, cats, and buttons wins.

## Components

- 4 dual-layer Quilt Boards
- 108 Patch Tiles (6 sets of 18, in 6 colors with 6 patterns)
- 6 Black & White Patch Tiles
- 24 Design Goal Tiles (4 sets of 6 in 4 player colors)
...
### Beginner Game
1. Place **Millie, Tibbit, and Coconut** Cat Scoring Tiles with matching Cat Tokens in the center. Return others to box.
2. Randomly assign 2 Black & White Patch Tiles to each Cat Scoring Tile.
3. Shuffle all Patch Tiles into face-down stacks (or use the bag).
4. Place Button Scoring Tile and Button Tokens centrally.
5. Each player gets a Quilt Board and 6 Design Goal Tiles in their color.
6. Place the **not-equal, AA-BB-CC, and AAA-BBB** Design Goal Tiles on your board (return others to box).
7. Each player draws 2 Patch Tiles into their hand.
8. Reveal 3 Patch Tiles as the market.
...
On your turn:
1. **Place a Patch Tile:** Take 1 tile from your hand and place it on any empty space on your quilt board.
2. **Draft a Patch Tile:** Take 1 tile from the market into your hand.
3. **Refill the Market:** Draw a new tile from the stacks/bag to refill the market to 3.

The game ends when all players have filled their quilt boards.
...
**Turn Summary:** Place 1 tile → Draft 1 tile from market → Refill market

**Scoring Summary:**

| Category | Points |
|----------|--------|
| Design Goals | Varies (per goal tile) |
