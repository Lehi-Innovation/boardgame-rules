...
---
<!-- verification:begin -->
> ❗ **Known errors** — an audit found inaccuracies in this summary that could mislead players: Technology bonus thresholds wrong: summary says 2/3/4/5+ tiles for 1/2/3/5 VP; source says 4/5/6/7 tiles. Until it is re-written, prefer the full rulebook text linked below.
>
> 📄 [Full rulebook text](https://lehi-innovation.github.io/boardgame-rules/extracted/eclipse-rules.txt) · 🚩 [Report a rules error](https://github.com/Lehi-Innovation/boardgame-rules/issues/new?template=rule-error.yml&labels=rule-error&title=%5BRule%20error%5D%20Eclipse&game=eclipse)
<!-- verification:end -->
...
- 6 sets of player materials (Ships: 8 Interceptors, 4 Cruisers, 2 Dreadnoughts; 4 Starbase tiles; 33 Population Cubes; 16 Influence Discs; 3 Ambassador tiles)
- 37 Sector hexes (8 Inner, 11 Middle, 18 Outer, 1 Galactic Center, 6 Starting)
- 6 Player Boards (two-sided: Terran/Alien)
- 1 Supply Board
- 96 Technology Tiles, 154 Ship Part Tiles, 21 Discovery Tiles
- 22 Colony Ship Tiles, 21 Ancient Ship Tiles, 1 GCDS Tile
- 32 Reputation Tiles, 22 Orbital/Monolith Tiles
- 18 dice (8 yellow, 6 orange, 4 red), 12 Damage Cubes
- 18 Storage Marker octagons, 1 Starting Player Marker, 1 Round Marker
...
- **Controlled hexes:** VP value printed on each hex
- **Discovery Tiles:** 2 VP each (if kept as VP rather than used for their benefit)
- **Reputation Tiles:** VP values from combat victories
- **Ambassador Tiles:** 1 VP each on your Reputation Track
- **Monoliths:** 3 VP each
- **Technology category bonus:** 1/2/3/5 VP for having 2/3/4/5+ technologies in a single category
- **Traitor Card:** -2 VP penalty

Highest VP total wins. Tiebreaker: most Resources remaining.

## Special Rules & Edge Cases

- **Trade:** At any time, convert 2 units of one Resource to 1 unit of another.
- **Diplomacy (4+ players only):** Form diplomatic relations with connected players by exchanging Ambassador Tiles. Breaking diplomacy (attacking) gives you the Traitor Card (-2 VP).
- **Galactic Center Defense System:** Must be destroyed before controlling the center hex; engages all ships in the center.
- **Gray Population Squares:** Can receive cubes from any Population Track.
- **Advanced Squares (star symbol):** Require corresponding Advanced Technology to colonize.
- **Bankruptcy:** If you cannot pay Upkeep, you must remove Influence Discs (losing hexes) until you can afford it.
- **Component limits:** Ships, Population Cubes, Influence Discs, and Technology Tiles are limited. Ship Parts, Orbitals, Monoliths, and Damage Cubes are unlimited.
- **Pinning:** Ships in a hex with enemy ships must leave at least one ship per opposing ship present.
